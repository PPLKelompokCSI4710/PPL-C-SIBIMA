    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <span class="inline-flex items-center px-4 py-1.5 rounded-full text-sm font-semibold bg-blue-100 text-blue-800 ring-1 ring-blue-400">
        ...
        <div class="py-12 min-h-screen bg-slate-50 relative overflow-hidden">
            ...
            <div class="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 rounded-full bg-blue-400/20 blur-3xl mix-blend-multiply"></div>
            <div class="absolute bottom-0 left-0 -ml-20 -mb-20 w-80 h-80 rounded-full bg-indigo-400/20 blur-3xl mix-blend-multiply"></div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3">
                        ...
                        <div class="bg-gradient-to-br from-blue-600 to-indigo-700 p-8 text-white flex flex-col justify-between relative overflow-hidden">
                            ...
                            <div class="relative z-10">
                                ...
                                <p class="text-blue-100 text-lg font-medium">Bimbingan Selanjutnya</p>
                            </div>

                            <div class="relative z-10 mt-10 md:mt-0">
                                <div class="flex items-center space-x-4">
                                    <div class="w-14 h-14 rounded-full bg-white text-blue-600 flex items-center justify-center font-bold text-xl shadow-inner">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-bold text-lg">{{ props.upcomingBimbingan.dosen }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-8 md:col-span-2">
                            <h4 class="text-2xl font-bold text-gray-800 mb-6 drop-shadow-sm">{{ props.upcomingBimbingan.topic }}</h4>
                            
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                                <div class="flex items-start">
                                    <div class="w-10 h-10 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center mr-4 flex-shrink-0 shadow-sm border border-blue-100">
                                    ...
                                    <div>
                                        <p class="text-sm font-semibold text-gray-500 uppercase tracking-wider">Tanggal & Waktu</p>
                                        <p class="font-bold text-gray-900 mt-1">{{ props.upcomingBimbingan.dateFormatted }}</p>
                                        <p class="text-gray-600">{{ props.upcomingBimbingan.timeFormatted }}</p>
                                    </div>
                                </div>
                                <div class="flex items-start">
                                    <div class="w-10 h-10 rounded-xl bg-indigo-50 text-indigo-600 flex items-center justify-center mr-4 flex-shrink-0 shadow-sm border border-indigo-100">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-bold text-gray-900 mt-1">{{ props.upcomingBimbingan.location }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-amber-50/50 rounded-2xl p-6 border border-amber-100">
                                ...
                                <ul class="space-y-3">
                                    <li v-for="(note, index) in props.upcomingBimbingan.preparationNotes" :key="index" class="flex items-start">
                                        <div class="mt-1 w-5 h-5 rounded-full bg-amber-200 text-amber-700 flex items-center justify-center flex-shrink-0 mr-3 text-xs font-bold">
                                            {{ index + 1 }}
                                        </div>
                            ...
                            <div class="mt-8 flex flex-col sm:flex-row items-center gap-4">
                                <button class="w-full sm:w-auto px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl font-bold shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 transform transition-all duration-300 hover:-translate-y-1 focus:ring-4 focus:ring-blue-300">
                                    Siap Hadir
                                </button>
                                <button class="w-full sm:w-auto px-6 py-3 bg-white hover:bg-gray-50 text-gray-700 rounded-xl font-bold font-medium shadow-sm border border-gray-200 transition-all duration-300 hover:text-blue-600 focus:ring-4 focus:ring-gray-100 flex items-center justify-center">
                ...
                <div class="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                        ...
                        <p class="text-gray-600 leading-relaxed mb-4">
                            Selalu catat poin-poin revisi yang diberikan oleh dosen pembimbing. Konsistensi dalam memperbaiki draft akan mempercepat proses penyelesaian tugas akhir.
                        </p>
                    </div>

                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-indigo-100 hover:shadow-md transition-shadow flex items-center justify-between">
                        <div>
                            <h4 class="font-bold text-lg text-gray-800 mb-1">Butuh Dokumen Pendukung?</h4>
                            <p class="text-gray-600 text-sm">Unduh template logbook & form bimbingan.</p>
                        </div>
                        <button class="px-4 py-2 bg-indigo-50 text-indigo-600 hover:bg-indigo-100 rounded-lg font-bold transition-colors">
                            Unduh Form
                        </button>
                    </div>
                </div>
