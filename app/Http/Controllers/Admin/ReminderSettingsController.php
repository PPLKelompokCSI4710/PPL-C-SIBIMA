...
class ReminderSettingsController extends Controller
{
    public function edit()
    {
        ...
        return Inertia::render('Admin/ReminderSettings', [
            'settings' => [
                ...
                'escalation_delay_days' => $escalationDelayDays,
            ],
        ]);
    }
    ...
    public function update(Request $request)
    {
        $data = $request->validate([
            ...
            'escalation_delay_days' => ['required', 'integer', 'min:0', 'max:90'],
        ]);
        ...
        AppSetting::set('escalation_delay_days', $data['escalation_delay_days']);
