...
function ic(t, e, n, r) {
    ...
    if (o == e.index(r) && r < t.depth - n.openStart) {
        ...
        if (!n.openStart && !n.openEnd && t.depth == r && e.depth == r) {
            let s = t.parent,
                l = s.content;
            return jt(s, l.cut(0, t.parentOffset).append(n.content).append(l.cut(e.parentOffset)));
        } else {
...
function Jn(t, e, n, r) {
    ...
    t && ((i = t.index(n)), t.depth > n ? i++ : t.textOffset && (Wt(t.nodeAfter, r), i++));
...
var is = class {
        constructor(e, n, r) {
            ((this.hasDefault = Object.prototype.hasOwnProperty.call(r, 'default')),
                ...
                (this.validate =
                    typeof r.validate == 'string' ? Xp(e, n, r.validate) : r.validate));
        }
        get isRequired() {
    ...
    gn = class t {
        ...
        create(e = null) {
            return !e && this.instance ? this.instance : new G(this, fc(this.attrs, e));
        }
        static compile(e, n) {
            let r = Object.create(null),
                o = 0;
    ...
    Ut = class {
        constructor(e) {
            ...
            for (let o in this.marks) {
                let i = this.marks[o],
                    s = i.spec.excludes;
                i.excluded = s == null ? [i] : s == '' ? [] : Ga(this, s.split(' '));
            }
...
var Ae = class t {
        ...
        static schemaRules(e) {
            ...
            for (let o in e.marks) {
                ...
                i &&
                    i.forEach((s) => {
                        (r((s = Ya(s))), s.mark || s.ignore || s.clearMark || (s.mark = o));
                    });
            }
            for (let o in e.nodes) {
                ...
                i &&
                    i.forEach((s) => {
                        (r((s = Ya(s))), s.node || s.ignore || s.mark || (s.node = o));
                    });
            }
            return n;
        }
    ...
    Zp = { head: !0, noscript: !0, object: !0, script: !0, style: !0, title: !0 },
    gc = { ol: !0, ul: !0 },
    Qn = 1,
    ss = 2,
    Gn = 4;
        ...
        inlineContext(e) {
            return this.type
                ...
                : this.content.length
                  ...
                  : e.parentNode && !mc.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
        }
    },
    Zr = class {
        constructor(e, n, r) {
            ...
            (o
                ? (i = new mn(o.type, o.attrs, G.none, !0, n.topMatch || o.type.contentMatch, s))
                : r
                  ? (i = new mn(null, null, G.none, !0, null, s))
                  : (i = new mn(e.schema.topNodeType, null, G.none, !0, null, s)),
                (this.nodes = [i]),
        ...
        addTextNode(e, n) {
            let r = e.nodeValue,
                o = this.top,
                i = o.options & ss ? 'full' : this.localPreserveWS || (o.options & Qn) > 0,
        ...
        insertNode(e, n, r) {
            ...
            if (o) {
                ...
                for (let l of o.concat(e.marks))
                    (i.type ? i.type.allowsMarkType(l.type) : Qa(l.type, e.type)) &&
                        (s = l.addToSet(s));
...
var et = class t {
    ...
    serializeNodeInner(e, n) {
        let { dom: r, contentDOM: o } = Xr(Zi(n), this.nodes[e.type.name](e), null, e.attrs);
        if (o) {
            ...
            for (let l = 0; l < this.ranges.length; l += 3) {
                ...
                if (e <= u) {
                    ...
                    let p = e == (n < 0 ? a : u) ? null : om(l / 3, e - a),
                        m = e == a ? Sc : e == u ? kc : eo;
                    return ((n < 0 ? e != a : e != u) && (m |= Cc), new tr(h, m, p));
                }
                o += d - c;
            }
...
var ht = class t extends de {
    ...
    apply(e) {
        let n = e.slice(this.from, this.to),
            r = new N(
                fs(n.content, (o) => o.mark(this.mark.removeFromSet(o.marks)), e),
                n.openStart,
                n.openEnd,
            );
...
function hm(t, e, n, r, o) {
    ...
    t.doc.nodesBetween(e, n, (s, l) => {
        ...
        if (s.isTextblock && !s.hasMarkup(r, a) && pm(t.doc, t.mapping.slice(i).map(l), r)) {
            let c = null;
...
function bm(t, e, n) {
    ...
    s.inlineContent && hs(t, e + n - 1, s, i.node().contentMatchAt(i.index()), r == null);
...
var us = class {
        ...
        for (let n = 1; n <= 2; n++)
            for (let r = n == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
                let o,
                    i = null;
                r
                    ? ((i = as(this.unplaced.content, r - 1).firstChild), (o = i.content))
    ...
    placeNodes({ sliceDepth: e, frontierDepth: n, parent: r, inject: o, wrap: i }) {
        ...
        this.unplaced = p
            ? e == 0
                ? N.empty
                : new N(Zn(s.content, e - 1, 1), e - 1, h < 0 ? s.openEnd : e - 1)
...
function Zn(t, e, n) {
    return e == 0
        ...
        : t.replaceChild(0, t.firstChild.copy(Zn(t.firstChild.content, e - 1, n)));
}
function er(t, e, n) {
    return e == 0
        ? t.append(n)
        : t.replaceChild(t.childCount - 1, t.lastChild.copy(er(t.lastChild.content, e - 1, n)));
}
function as(t, e) {
...
function Ec(t, e, n) {
    ...
    let r = t.content;
    return (
        e > 1 && (r = r.replaceChild(0, Ec(r.firstChild, e - 1, r.childCount == 1 ? n - 1 : 0))),
        e > 0 &&
    ...
    removeNodeMark(e, n) {
        ...
        if (n instanceof G) n.isInSet(r.marks) && this.step(new yn(e, n));
            ...
            let o = r.marks,
                i,
                s = [];
            for (; (i = n.isInSet(o)); ) (s.push(new yn(e, i)), (o = i.removeFromSet(o)));
    ...
    L = class {
        ...
        replace(e, n = N.empty) {
            ...
            for (let l = 0; l < s.length; l++) {
                ...
                (e.replaceRange(d.map(a.pos), d.map(c.pos), l ? N.empty : n),
                    l == 0 && Ic(e, i, (r ? r.isInline : o && o.isTextblock) ? -1 : 1));
            }
        }
        replaceWith(e, n) {
            ...
            for (let i = 0; i < o.length; i++) {
                ...
                i
                    ? e.deleteRange(c, d)
                    : (e.replaceRangeWith(c, d, n), Ic(e, r, n.isInline ? -1 : 1));
            }
        }
        static findFrom(e, n, r = !1) {
            ...
            for (let i = e.depth - 1; i >= 0; i--) {
                let s =
                    n < 0
                        ? xn(e.node(0), e.node(i), e.before(i + 1), e.index(i), n, r)
                        : xn(e.node(0), e.node(i), e.after(i + 1), e.index(i) + 1, n, r);
                if (s) return s;
            }
            return null;
        }
        ...
        static jsonID(e, n) {
            if (e in ps) throw new RangeError('Duplicate use of selection JSON ID ' + e);
    ...
    static between(e, n, r) {
        ...
        return (
            e.parent.inlineContent ||
                (o == 0
                    ? (e = n)
                    : ((e = (L.findFrom(e, -r, !0) || L.findFrom(e, r, !0)).$anchor),
                      e.pos < n.pos != o < 0 && (e = n))),
            new t(e, n)
        );
    }
...
function xn(t, e, n, r, o, i = !1) {
    ...
    for (let s = r - (o > 0 ? 0 : 1); o > 0 ? s < e.childCount : s >= 0; s += o) {
        let l = e.child(s);
        if (l.isAtom) {
            if (!i && I.isSelectable(l)) return I.create(t, n - (o < 0 ? l.nodeSize : 0));
        } else {
                ...
                n &&
                    n.forEach((r) => {
                        ...
                        (this.plugins.push(r),
                            ...
                            r.spec.state && this.fields.push(new qt(r.key, r.spec.state, r)));
                    }));
        }
    },
    lr = class t {
        ...
        static fromJSON(e, n, r) {
            ...
            return (
                o.fields.forEach((s) => {
                    ...
                    else if (s.name == 'selection') i.selection = L.fromJSON(i.doc, n.selection);
...
function zc(t, e, n) {
    for (let r in t) {
        let o = t[r];
        (o instanceof Function ? (o = o.bind(e)) : r == 'handleDOMEvents' && (o = zc(o, e, {})),
            (n[r] = o));
    }
    return n;
}
...
var lo = (t, e) => (t.selection.empty ? !1 : (e && e(t.tr.deleteSelection().scrollIntoView()), !0));
function Fc(t, e) {
            ...
            for (let s = r.depth; ; s--) {
                ...
                if (l && l.slice.size < l.to - l.from) {
                    if (e) {
                        ...
                        (a.setSelection(
                            kn(i, 'end')
                                ? L.findFrom(a.doc.resolve(a.mapping.map(o.pos, -1)), -1)
...
var ws = (t, e, n) => {
    ...
    return !s || !I.isSelectable(s)
        ? !1
        : (e && e(t.tr.setSelection(I.create(t.doc, i.pos - s.nodeSize)).scrollIntoView()), !0);
};
function xs(t) {
...
var ks = (t, e, n) => {
        ...
        let i = o.nodeAfter;
        if (Gc(t, o, e, 1)) return !0;
        if (r.parent.content.size == 0 && (kn(i, 'start') || I.isSelectable(i))) {
    ...
    Ss = (t, e, n) => {
        ...
        return !s || !I.isSelectable(s)
            ? !1
            : (e && e(t.tr.setSelection(I.create(t.doc, i.pos)).scrollIntoView()), !0);
    };
function Cs(t) {
    if (!t.parent.type.spec.isolating)
        for (let e = t.depth - 1; e >= 0; e--) {
...
var Uc = (t, e) => {
        ...
        if (e) {
            let i = t.tr.join(o);
            (r && i.setSelection(I.create(i.doc, o - t.doc.resolve(o).nodeBefore.nodeSize)),
                e(i.scrollIntoView()));
        }
        return !0;
    },
...
function Am(t) {
    return (e, n) => {
        ...
        let d = e.tr;
        (e.selection instanceof D || e.selection instanceof be) && d.deleteSelection();
...
function Gc(t, e, n, r) {
    ...
    if (c && kn(i, 'start', !0) && kn(o, 'end')) {
        ...
        if (h.canReplace(h.childCount, h.childCount, m.content)) {
            if (n) {
                let y = v.empty;
                for (let w = p.length - 1; w >= 0; w--) y = v.from(p[w].copy(y));
                let b = t.tr.step(
                    new le(
                        e.pos - p.length,
                        e.pos + i.nodeSize,
...
function Zc(t) {
    return function (e, n) {
        ...
        return i ? (n ? (r.node(i.depth - 1).type == t ? Pm(e, n, t, i) : Lm(e, n, i)) : !0) : !1;
    };
}
function Pm(t, e, n, r) {
    let o = t.tr,
...
function $m(t, e) {
    for (;;) {
        ...
        } else if (t.parentNode && !mr(t)) ((e = he(t) + 1), (t = t.parentNode));
        else return null;
    }
}
function Fm(t, e, n) {
...
var wo = function (t) {
    return t.focusNode && tn(t.focusNode, t.focusOffset, t.anchorNode, t.anchorOffset);
};
function Gt(t, e) {
...
var _s = !Ee && /Chrome\/(\d+)/.exec(zt),
    ...
    Wm = gr ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function jm(t) {
    ...
    for (let s = n || t.dom; s; ) {
        ...
        if (
            ...
            e.left < c.left + mt(r, 'left')
                ...
                : e.right > c.right - mt(r, 'right') && (d = e.right - c.right + mt(o, 'right')),
            d || u)
        )
...
function Vd(t, e, n) {
    let { node: r, offset: o, atom: i } = t.docView.domFromPos(e, n < 0 ? -1 : 1),
        s = gr || He;
    if (r.nodeType == 3)
        if (s && (eg.test(r.nodeValue) || (n < 0 ? !o : o == r.nodeValue.length))) {
            let a = Dt(gt(r, o, o), n);
...
function tg(t, e, n) {
    ...
    return _d(t, e, () => {
        ...
        for (let l = i.firstChild; l; l = l.nextSibling) {
            ...
            else if (l.nodeType == 3) a = gt(l, 0, l.nodeValue.length).getClientRects();
            else continue;
...
function og(t, e, n) {
    return id == e && sd == n
        ? ld
        : ((id = e), (sd = n), (ld = n == 'up' || n == 'down' ? tg(t, e, n) : rg(t, e, n)));
}
var $e = 0,
    ad = 1,
    Xt = 2,
    ...
    nn = class {
        ...
        domFromPos(e, n) {
            ...
            for (
                let i;
                r && !(i = this.children[r - 1]).size && i instanceof co && i.side >= 0;
                r--
            );
            if (n <= 0) {
                let i,
...
`
    ...
    En = class t extends nn {
        ...
        static create(e, n, r, o) {
            ...
            return (
                (!s || !s.dom) &&
                    (s = et.renderSpec(document, n.type.spec.toDOM(n, r), null, n.attrs)),
    ...
    Bt = class t extends nn {
        ...
        matchesNode(e, n, r) {
            return (
                this.dirty == $e && e.eq(this.node) && ho(n, this.outerDeco) && r.eq(this.innerDeco)
            );
        }
        get size() {
...
function Wd(t, e, n) {
    ...
    for (let i = 0; i < e.length; i++) {
        ...
        if (s instanceof En) {
            ...
            (Wd(s.contentDOM, s.children, n), (r = a ? a.nextSibling : t.firstChild));
        }
    }
    for (; r; ) ((r = dd(r)), (o = !0));
...
var Ks = class {
            ...
            if (a instanceof Bt) {
                ...
                if (!f && (u = this.recreateWrapper(a, e, n, r, o, s)))
                    return (
                        ...
                        u.contentDOM &&
                            ((u.dirty = Xt), u.updateChildren(o, s + 1), (u.dirty = $e)),
                        (this.changed = !0),
                        this.index++,
                        !0
                    );
    ...
    addTextblockHacks() {
        let e = this.top.children[this.index - 1],
            n = this.top;
        for (; e instanceof En; ) ((n = e), (e = n.children[n.children.length - 1]));
        (!e ||
            !(e instanceof uo) ||
            /\n$/.test(e.node.text) ||
            (this.view.requiresGeckoHackNode && /\s$/.test(e.node.text))) &&
            ((xe || ue) && e && e.dom.contentEditable == 'false' && this.addHackNode('IMG', n),
...
function Kd(t) {
    return t.editable
        ? t.hasFocus()
        : Jd(t) && document.activeElement && document.activeElement.contains(t.dom);
}
function bt(t, e = !1) {
        ...
        if (n.indexOf('s') > -1) {
            ...
            if (t.endOfTextblock(e > 0 ? 'forward' : 'backward')) {
                ...
                return i.isAtom || ((s = t.docView.descAt(l)) && !s.contentDOM)
                    ? I.isSelectable(i)
                        ? It(t, new I(e < 0 ? t.state.doc.resolve(o.pos - i.nodeSize) : o))
                        : gr
                          ? It(t, new D(t.state.doc.resolve(e < 0 ? l : l + i.nodeSize)))
                          : !1
                    : !1;
            }
        } else return !1;
    else {
        if (r instanceof I && r.node.isInline) return It(t, new D(e > 0 ? r.$to : r.$from));
        {
            let o = Js(t.state, e);
            return o ? It(t, o) : !1;
        }
...
function pg(t) {
    ...
    let o,
        i,
        s = !1;
    for (He && n.nodeType == 1 && r < po(n) && dr(n.childNodes[r], -1) && (s = !0); ; )
        if (r > 0) {
            ...
            if (Gd(n)) break;
            {
                ...
                for (; l && dr(l, -1); ) ((o = n.parentNode), (i = he(l)), (l = l.previousSibling));
                if (l) ((n = l), (r = po(n)));
                else {
...
function mg(t) {
    ...
    for (;;)
        if (r < o) {
            ...
            {
                let l = n.nextSibling;
                for (; l && dr(l, 1); ) ((i = l.parentNode), (s = he(l) + 1), (l = l.nextSibling));
                if (l) ((n = l), (r = 0), (o = po(n)));
                else {
                    if (((n = n.parentNode), n == t.dom)) break;
                    r = o = 0;
...
function gg(t, e) {
    for (; t && e == t.childNodes.length && !mr(t); ) ((e = he(t) + 1), (t = t.parentNode));
...
function Gs(t, e, n) {
    if (e.nodeType != 3) {
        let i, s;
        (s = gg(e, n)) ? ((e = s), (n = 0)) : (i = yg(e, n)) && ((e = i), (n = i.nodeValue.length));
    }
...
function xg(t, e) {
    ...
    if ((n == 46 && !e.shiftKey) || (Be && n == 68 && r == 'c')) return wd(t, 1) || Cn(t, 1);
    if (n == 13 || n == 27) return !0;
    if (n == 37 || (Be && n == 66 && r == 'c')) {
        let o = n == 37 ? (yd(t, t.state.selection.from) == 'ltr' ? -1 : 1) : -1;
        return gd(t, o, r) || Cn(t, o);
    } else if (n == 39 || (Be && n == 70 && r == 'c')) {
        let o = n == 39 ? (yd(t, t.state.selection.from) == 'ltr' ? 1 : -1) : 1;
        return gd(t, o, r) || Cn(t, o);
    } else {
        if (n == 38 || (Be && n == 80 && r == 'c')) return bd(t, -1, r) || Cn(t, -1);
        if (n == 40 || (Be && n == 78 && r == 'c')) return bg(t) || bd(t, 1, r) || Cn(t, 1);
...
`,
    ...
    else if (((l = N.maxOpen(Sg(l.content, o), !0)), l.openStart || l.openEnd)) {
        let u = 0,
            f = 0;
        for (
        ...
        if (
            (t.forEach((l) => {
                ...
                if ((c = s.length && i.length && Yd(a, i, l, s[s.length - 1], 0)))
                    ...
                    s.length && (s[s.length - 1] = Qd(s[s.length - 1], i.length));
                    let d = Xd(l, a);
...
function kd(t, e, n) {
    return (
        e < t.openStart &&
            (t = new N(Xs(t.content, -1, e, t.openStart, 0, t.openEnd), e, t.openEnd)),
        n < t.openEnd && (t = new N(Xs(t.content, 1, n, t.openEnd, 0, 0), t.openStart, n)),
        t
    );
}
var Zd = {
    ...
    for (let e in Ce) {
        ...
        t.dom.addEventListener(
            ...
            (t.input.eventHandlers[e] = (r) => {
                Og(t, r) && !al(t, r) && (t.editable || !(r.type in ve)) && n(t, r);
            }),
    ...
    t.someProp('handleDOMEvents', (e) => {
        for (let n in e)
            t.input.eventHandlers[n] ||
                t.dom.addEventListener(n, (t.input.eventHandlers[n] = (r) => al(t, r)));
    });
}
function al(t, e) {
...
function Rg(t, e) {
    !al(t, e) && Ce[e.type] && (t.editable || !(e.type in ve)) && Ce[e.type](t, e);
}
ve.keydown = (t, e) => {
    let n = e;
    if (
        ...
        if (
            ...
            ((t.input.lastIOSEnter = r),
                (t.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
                    t.input.lastIOSEnter == r &&
                        (t.someProp('handleKeyDown', (o) => o(t, Gt(13, 'Enter'))),
...
ve.keypress = (t, e) => {
    let n = e;
    if (nu(t, n) || !n.charCode || (n.ctrlKey && !n.altKey) || (Be && n.metaKey)) return;
...
function Ig(t, e) {
    ...
    let n = t.state.doc.resolve(e),
        r = n.nodeAfter;
    return r && r.isAtom && I.isSelectable(r) ? (Mn(t, new I(n), 'pointer'), !0) : !1;
}
function Pg(t, e) {
    if (e == -1) return !1;
    let n = t.state.selection,
...
function Bg(t, e, n, r) {
    return (
        cl(t, 'handleDoubleClickOn', e, n, r) || t.someProp('handleDoubleClick', (o) => o(t, e, r))
    );
}
function zg(t, e, n, r) {
    return (
...
function Hg(t, e, n) {
    ...
    let r = t.state.doc;
    if (e == -1)
        return r.inlineContent ? (Mn(t, D.create(r, 0, r.content.size), 'pointer'), !0) : !1;
    let o = r.resolve(e);
    for (let i = o.depth + 1; i > 0; i--) {
        let s = i > o.depth ? o.nodeAfter : o.node(i),
            l = o.before(i);
        if (s.inlineContent) Mn(t, D.create(r, l + 1, l + 1 + s.content.size), 'pointer');
...
var Zs = class {
    ...
    up(e) {
        ...
        let n = this.pos;
        (this.view.state.doc != this.startDoc && (n = this.view.posAtCoords(xo(e))),
            ...
            this.allowDefault || !n
                ...
                : Lg(this.view, n.pos, n.inside, e, this.selectNode)
                  ...
                  : e.button == 0 &&
                    ...
                    ? (Mn(this.view, L.near(this.view.state.doc.resolve(n.pos)), 'pointer'),
                      e.preventDefault())
                    : Pt(this.view, 'pointer'));
    }
    move(e) {
...
ve.compositionstart = ve.compositionupdate = (t) => {
    if (!t.composing) {
        ...
        if (
            ...
            ((t.markCursor = t.state.storedMarks || n.marks()), ur(t, !0), (t.markCursor = null));
        else if (
...
function ou(t) {
    for (
        t.composing && ((t.input.composing = !1), (t.input.compositionEndedAt = _g()));
...
function ur(t, e = !1) {
    if (!(yt && t.domObserver.flushingSoon >= 0)) {
        if ((t.domObserver.forceFlush(), ou(t), e || (t.docView && t.docView.dirty))) {
            let n = ol(t),
                r = t.state.selection;
            return (
                n && !n.eq(r)
...
function Ug(t, e) {
    ...
    setTimeout(() => {
        (t.focus(),
            ...
            n ? hr(t, r.value, null, o, e) : hr(t, r.textContent, r.innerHTML, o, e));
    }, 50);
}
...
ve.paste = (t, e) => {
    ...
    r && hr(t, iu(r), r.getData('text/html'), o, n) ? n.preventDefault() : Ug(t, n);
};
var mo = class {
        constructor(e, n, r) {
...
Ce.dragstart = (t, e) => {
    ...
    ((!n.dataTransfer.files.length || !ue || Ld > 120) && n.dataTransfer.clearData(),
...
function qg(t, e, n) {
    ...
    i
        ...
        : (i = ll(t, iu(e.dataTransfer), fr ? null : e.dataTransfer.getData('text/html'), !1, o));
    let s = !!(n && su(t, e));
...
var go = class t {
    ...
    Qt = class t {
        ...
        eq(e) {
            return (
                this == e || (e instanceof t && pr(this.attrs, e.attrs) && pr(this.spec, e.spec))
            );
        }
        static is(e) {
    ...
    Q = class t {
        ...
        map(e, n, r) {
            return this == we || e.maps.length == 0 ? this : this.mapInner(e, n, 0, 0, r || Zt);
        }
        mapInner(e, n, r, o, i) {
            let s;
            ...
            e.forEach((l, a) => {
                ...
                if ((d = au(n, l, c))) {
                    ...
                    (o[i] == a
                        ...
                        : o.splice(i, 0, a, a + l.nodeSize, bo(d, l, c + 1, Zt)),
                        (i += 3));
                }
            });
            let s = lu(i ? cu(n) : n, -r);
            for (let l = 0; l < s.length; l++) s[l].type.valid(e, s[l]) || s.splice(l--, 1);
            return new t(s.length ? this.local.concat(s).sort(en) : this.local, o || this.children);
        }
        remove(e) {
...
var Xg = {
    ...
    nl = class {
        ...
        start() {
            (this.observer &&
                (this.observer.takeRecords(), this.observer.observe(this.view.dom, Xg)),
                this.onCharData &&
        ...
        flush() {
            ...
            if (He && a.length) {
                ...
                if (d.length == 2) {
                    ...
                    for (let f of d) {
                        let h = f.parentNode;
                        h && h.nodeName == 'LI' && (!u || ey(e, u) != h) && f.remove();
                    }
                }
            } else if (
                (ue || xe) &&
...
function oy(t, e, n, r, o) {
    ...
    let w = p.start,
        C = p.endA,
        x = (k) => {
            let E = k || t.state.tr.replace(w, C, c.doc.slice(p.start - c.from, p.endB - c.from));
            if (c.sel) {
    ...
    if (b)
        if (m.pos == g.pos) {
            Ee &&
                Lt <= 11 &&
                m.parentOffset == 0 &&
                (t.domObserver.suppressSelectionUpdates(), setTimeout(() => bt(t), 20));
            ...
            let k = x(t.state.tr);
            (S.type == 'add' ? k.addMark(w, C, S.mark) : k.removeMark(w, C, S.mark), t.dispatch(k));
        } else if (
            ...
            t.someProp('handleTextInput', (M) => M(t, w, C, k, E)) || t.dispatch(E());
        } else t.dispatch(x());
    else t.dispatch(x());
}
function Ad(t, e, n) {
...
function ly(t, e, n, r, o) {
    ...
    if (s < i && t.size < e.size) {
        let a = r <= i && r >= s ? i - r : 0;
        ((i -= a),
            i && i < e.size && Ed(e.textBetween(i - 1, i + 1)) && (i += a ? 1 : -1),
            (l = i + (l - s)),
            (s = i));
    } else if (l < i) {
        let a = r <= i && r >= l ? i - r : 0;
        ((i -= a),
            i && i < t.size && Ed(t.textBetween(i - 1, i + 1)) && (i += a ? 1 : -1),
            (s = i + (s - l)),
            (l = i));
    }
    ...
    Nn = class {
        constructor(e, n) {
            ((this._root = null),
                ...
                (this.docView = cd(this.state.doc, Nd(this), zs(this), this.dom, this)),
                (this.domObserver = new nl(this, (r, o, i, s) => oy(this, r, o, i, s))),
        ...
        update(e) {
            ...
            let n = this._props;
            ((this._props = e),
                e.plugins && (e.plugins.forEach(Id), (this.directPlugins = e.plugins)),
        ...
        updateStateInner(e, n) {
            ...
            let o = this.state,
                i = !1,
                s = !1;
            (e.storedMarks && this.composing && (ou(this), (s = !0)), (this.state = e));
            ...
            ((l || n.handleDOMEvents != this._props.handleDOMEvents) && Qs(this),
                (this.editable = Rd(this)),
                Od(this));
            let a = zs(this),
                c = Nd(this),
            ...
            let f = d == 'preserve' && s && this.dom.style.overflowAnchor == null && Km(this);
            if (s) {
                ...
                !(
                    ...
                    ? bt(this, h)
                    : (qd(this, e.selection), this.domObserver.setCurSelection()),
                    this.domObserver.start());
            }
        ...
        scrollToSelection() {
            ...
            if (!(!e || !this.dom.contains(e.nodeType == 1 ? e : e.parentNode))) {
                if (!this.someProp('handleScrollToSelection', (n) => n(this)))
                    ...
                    } else rd(this, this.coordsAtPos(this.state.selection.head, 1), e);
            }
        }
        destroyPluginViews() {
            let e;
        ...
        updateDraggedNode(e, n) {
            ...
            this.dragging = new mo(e.slice, e.move, o < 0 ? void 0 : I.create(this.state.doc, o));
        }
        someProp(e, n) {
...
var ae;
for (ae = 65; ae <= 90; ae++)
    ((wt[ae] = String.fromCharCode(ae + 32)), (So[ae] = String.fromCharCode(ae)));
var ae;
...
function du(t) {
    var e =
            ...
            t.key == 'Unidentified',
        n = (!e && t.key) || (t.shiftKey ? So : wt)[t.keyCode] || t.key || 'Unidentified';
    return (
        n == 'Esc' && (n = 'Escape'),
        n == 'Del' && (n = 'Delete'),
        n == 'Left' && (n = 'ArrowLeft'),
...
var py = typeof navigator < 'u' && /Mac|iP(hone|[oa]d)/.test(navigator.platform),
...
function xr(t, e, n = { strict: !0 }) {
    let r = Object.keys(e);
    return r.length
        ? r.every((o) => (n.strict ? e[o] === t[o] : Eo(e[o]) ? e[o].test(t[o]) : e[o] === t[o]))
        : !0;
}
function gu(t, e, n = {}) {
    return t.find(
        (r) =>
            r.type === e && xr(Object.fromEntries(Object.keys(n).map((o) => [o, r.attrs[o]])), n),
    );
}
function fu(t, e, n = {}) {
    return !!gu(t, e, n);
        ...
        ({ tr: r, dispatch: o, editor: i }) => {
            ...
            if (o) {
                ...
                if (
                    ...
                    try {
                        Dn(e, i.schema, { parseOptions: c, errorOnInvalidContent: !0 });
                    } catch (g) {
                        a(g);
                    }
                try {
                ...
                if (f) {
                    ...
                    let g = r.doc.resolve(d),
                        ...
                        C = y.content.size > 0;
                    (b && w && C && (d = Math.max(0, d - 1)), r.replaceWith(d, u, m));
                }
...
var Qy =
        ...
        ({ tr: n, state: r, dispatch: o }) => {
            ...
            if (!l) return !1;
            (l === 'node' && (i = re(t, r.schema)), l === 'mark' && (s = ot(t, r.schema)));
            let a = !1;
            return (
                n.selection.ranges.forEach((c) => {
                    r.doc.nodesBetween(c.$from.pos, c.$to.pos, (d, u) => {
                        (i &&
                            i === d.type &&
                            ((a = !0), o && n.setNodeMarkup(u, void 0, gl(d.attrs, e))),
                            s &&
                                d.marks.length &&
                                d.marks.forEach((f) => {
                                    s === f.type &&
                                        ((a = !0),
                                        o &&
                                            n.addMark(u, u + d.nodeSize, s.create(gl(f.attrs, e))));
                                }));
                    });
                }),
                a
    ...
    ib =
        ...
        ({ state: t, dispatch: e }) =>
            Ns(t, e);
function To(t, e, n = {}, r = {}) {
    return Dn(t, e, { slice: !1, parseOptions: n, errorOnInvalidContent: r.errorOnInvalidContent });
}
var sb =
...
function hu(t) {
    return Object.fromEntries(
        Object.entries(t).filter(([e, n]) => (e === 'attrs' && wu(n) ? !1 : n != null)),
    );
}
function pu(t) {
    var e, n;
    ...
    let r = Al(t),
        ...
        l = Object.fromEntries(
            o.map((c) => {
                ...
                m && (h.toDOM = (y) => m({ node: y, HTMLAttributes: kr(y, d) }));
        ...
        a = Object.fromEntries(
            i.map((c) => {
                ...
                let m = B(c, 'renderHTML', u);
                return (
                    m && (h.toDOM = (g) => m({ mark: g, HTMLAttributes: kr(g, d) })),
                    [c.name, h]
                );
            }),
        );
        ...
        (o.forEach(({ $from: u, $to: f }) => {
            ...
            t.doc.nodesBetween(h, p, (m, g) => {
                ...
                let y = Math.max(h, g),
                    ...
                    w = b - y;
                ((s += w), l.push(...m.marks.map((C) => ({ mark: C, from: y, to: b }))));
            });
        }),
        s === 0)
    )
...
function Nu({ json: t, validMarks: e, validNodes: n, options: r, rewrittenContent: o = [] }) {
    return (
        t.marks &&
...
var xb =
        ...
        ({ tr: e, state: n, dispatch: r, editor: o }) => {
            ...
            let u = a.parentOffset === a.parent.content.size,
                f = l.depth === 0 ? void 0 : Pn(l.node(-1).contentMatchAt(l.indexAfter(-1))),
            ...
            if (
                ...
                (t && mu(n, o.extensionManager.splittableMarks), e.scrollIntoView());
            }
            return p;
        },
    kb =
                    ...
                    let w =
                            a.indexAfter(-1) < a.node(-2).childCount
                                ...
                                : a.indexAfter(-2) < a.node(-3).childCount
                                  ? 2
                                  : 3,
                        C = { ...wr(f, a.node().type.name, a.node().attrs), ...e },
                        x =
    ...
    Sb =
        ...
        ({ editor: o, tr: i, state: s, dispatch: l, chain: a, commands: c, can: d }) => {
            ...
            if (w.depth >= 1 && x && w.depth - x.depth <= 1) {
                ...
                if (wl(x.node.type.name, u) && h.validContent(x.node.content) && l)
                    return a()
    ...
    Cb =
        ...
        ({ state: r, commands: o }) => {
            let { extendEmptyMarkRange: i = !1 } = n,
                s = ot(t, r.schema);
            return Ao(r, s, e) ? o.unsetMark(s, { extendEmptyMarkRange: i }) : o.setMark(s, e);
        },
    vb =
        (t, e, n = {}) =>
        ({ state: r, commands: o }) => {
                                      ...
                                      s &&
                                          ...
                                          g.marks.forEach((b) => {
                                              if (s === b.type && ((a = !0), o)) {
                                                  ...
                                                  n.addMark(w, C, s.create({ ...b.attrs, ...e }));
                                              }
                                          })));
                          }),
                        h &&
    ...
    return (
        s.forEach((f) => {
            ...
            let p = a.state.tr,
                ...
                { commands: y, chain: b, can: w } = new Cr({ editor: n, state: m });
            f.handler({ state: m, range: g, match: h, commands: y, chain: b, can: w }) === null ||
                !p.steps.length ||
        ...
        r = new P({
                ...
                apply(o, i, s) {
                    ...
                    return (
                        !!a &&
                            setTimeout(() => {
                                let { text: d } = a;
                                typeof d == 'string' ? (d = d) : (d = Tr(v.from(d), s.schema));
                                let { from: u } = a,
                                    f = u + d.length;
                                Co({ editor: e, from: u, to: f, text: d, rules: n, plugin: r });
                            }),
            ...
            props: {
                handleTextInput(o, i, s, l) {
                    return Co({ editor: e, from: i, to: s, text: l, rules: n, plugin: r });
                },
                handleDOMEvents: {
                    compositionend: (o) => (
                        setTimeout(() => {
...
var Vo = class {
        ...
        get storage() {
            return {
                ...(J(B(this, 'addStorage', { name: this.name, options: this.options })) || {}),
            };
        }
        configure(t = {}) {
            let e = this.extend({ ...this.config, addOptions: () => Bl(this.options, t) });
...
function zb(t) {
    ...
    return (
        n.doc.nodesBetween(r, o, (h, p) => {
            ...
            let C =
                    (w =
                        (b = (y = h.content) == null ? void 0 : y.size) != null ? b : h.nodeSize) !=
                    null
                        ? w
                        : 0,
                x = Math.max(r, p),
        ...
        (d) =>
            new P({
                ...
                appendTransaction: (u, f, h) => {
                    ...
                    if (b) {
                        let { text: x } = y;
                        typeof x == 'string' ? (x = x) : (x = Tr(v.from(x), h.schema));
                        let { from: S } = y,
                            k = S + x.length,
                            E = Hb(x);
                    ...
                    if (!(!Du(w) || !C || w === C.b))
                        return a({ rule: d, state: h, from: w, to: C, pasteEvt: s });
                },
            }),
    );
}
                ...
                new P({
                    ...
                    appendTransaction: (t, e, n) => {
                        ...
                        let f = n.tr,
                            ...
                            { commands: p } = new Cr({ editor: this.editor, state: h });
...
var Fb = class extends Ib {
    constructor(t = {}) {
        (super(),
            ...
            (this.utils = { getUpdatedPosition: Au, createMappablePosition: Eu }),
            this.setOptions(t),
    ...
    registerPlugin(t, e) {
        let n = Tl(e) ? e(t, [...this.state.plugins]) : [...this.state.plugins, t],
    ...
    createDoc() {
        let t;
        try {
            t = To(this.options.content, this.schema, this.options.parseOptions, {
    ...
    return {
        ...
        markdownTokenizer: {
            ...
            tokenize(d, u, f) {
                ...
                let m = p[1] || '',
                    g = r(m);
                if (!s.find((b) => !(b in g))) return { type: e, raw: p[0], attributes: g };
            },
        },
        renderMarkdown: (d) => {
            let u = c(d.attrs || {}),
                ...
                for (k.lastIndex = 0; ; ) {
                    ...
                    if (!((p = M[2]) != null && p.endsWith(':::'))) {
                        if (z) C += 1;
                                        ...
                                        _ = h.blockTokens(j),
                                            _.forEach((R) => {
                                                R.text &&
                                                    ...
                                                    (R.tokens = h.inlineTokens(R.text));
                                            });
                                        _.length > 0;
                                    ) {
                                        let R = _[_.length - 1];
                            ...
                            return { type: e, raw: V, attributes: w, content: S, tokens: _ };
                        }
                    }
                }
            },
...
`);
            x.trim() &&
                (e.customNestedParser ? (b = e.customNestedParser(x)) : (b = n.blockTokens(x)));
        }
...
function e0(t) {
    for (let e = t.depth; e >= 0; e--) {
        ...
        for (let o = r.child(n - 1); ; o = o.lastChild) {
            if ((o.childCount == 0 && !o.inlineContent) || ef(o.type)) return !0;
...
var nf = (function (t) {
    ...
    return (
        ...
        (e.prototype.leafAppend = function (o) {
            if (this.length + o.length <= Go) return new e(this.values.concat(o.flatten()));
        }),
        (e.prototype.leafPrepend = function (o) {
            if (this.length + o.length <= Go) return new e(o.flatten().concat(this.values));
        }),
...
var l0 = 500,
    ln = class t {
        ...
        addTransform(e, n, r, o) {
            ...
            let c = s - r.depth;
            return (c > c0 && ((l = a0(l, c)), (s -= c)), new t(l.append(i), s));
        }
        remapping(e, n) {
            let r = new nr();
            return (
        ...
        addMaps(e) {
            return this.eventCount == 0
                ? this
                : new t(this.items.append(e.map((n) => new it(n))), this.eventCount);
        }
        rebased(e, n) {
            ...
            let d = this.items.slice(0, o).append(c).append(r),
                u = new t(d, l);
            return (u.emptyItemCount() > l0 && (u = u.compress(this.items.length - r.length)), u);
        }
        emptyItemCount() {
            let e = 0;
            return (
    ...
    if (n.getMeta('addToHistory') !== !1 && !(s && s.getMeta('addToHistory') === !1)) {
        let l = n.getMeta('composition'),
            a =
                ...
                (!s &&
                    t.prevComposition != l &&
                    (t.prevTime < (n.time || 0) - r.newGroupDelay || !u0(n, t.prevRanges))),
            c = s ? Wl(t.prevRanges, n.mapping) : rf(n.mapping.maps);
        return new st(
            t.done.addTransform(n, a ? e.selection.getBookmark() : void 0, r, Xo(e)),
            ln.empty,
            c,
            n.time,
            l ?? t.prevComposition,
...
function f0(t, e, n) {
    ...
    return i.transform.setSelection(s).setMeta(sn, { redo: n, historyState: a });
}
var jl = !1,
    of = null;
function Xo(t) {
        ...
        new P({
            ...
            props: {
                handleDOMEvents: {
                    beforeinput(e, n) {
                        let r = n.inputType,
                            o = r == 'historyUndo' ? Ul : r == 'historyRedo' ? Kl : null;
                        return !o || !e.editable
                            ? !1
...
var Y1 = K.create({
    ...
    cf = K.create({
        ...
        extendNodeSchema(t) {
            ...
            return { allowGapCursor: (e = J(B(t, 'allowGapCursor', n))) != null ? e : null };
        },
    }),
    ql = K.create({
        name: 'placeholder',
...
var g0 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/,
    ...
    x0 = ee.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            return $n('strong', { ...O(this.options.HTMLAttributes, t), children: $n('slot', {}) });
        },
        ...
        addInputRules() {
            return [De({ find: g0, type: this.type }), De({ find: b0, type: this.type })];
        },
        addPasteRules() {
            return [Me({ find: y0, type: this.type }), Me({ find: w0, type: this.type })];
        },
    }),
    ff = x0;
var k0 = /(^|[^`])`([^`]+)`(?!`)$/,
...
`),
                                ...
                                let b = ((a = h[p].match(/^ */)) == null ? void 0 : a[0]) || '',
                                ...
                                return (
                                    l.delete(C, C + w),
                                    c - C <= w && l.setSelection(D.create(l.doc, C)),
                                    !0
                                );
                            })
                          : t.commands.command(({ tr: l }) => {
...
`);
                ...
                ArrowDown: ({ editor: t }) => {
                    ...
                    return l === void 0
                        ...
                        : r.nodeAt(l)
                          ? t.commands.command(
                                ({ tr: c }) => (c.setSelection(L.near(r.resolve(l))), !0),
                            )
                          : t.commands.exitCode();
                },
            };
        ...
        addInputRules() {
            return [
                zn({ find: v0, type: this.type, getAttributes: (t) => ({ language: t[1] }) }),
                zn({ find: M0, type: this.type, getAttributes: (t) => ({ language: t[1] }) }),
            ];
        },
        addProseMirrorPlugins() {
            return [
...
var Qo = (t, e) => e.view.domAtPos(t).node.offsetParent !== null,
        ...
        addNodeView() {
            return ({ editor: t, getPos: e, node: n, HTMLAttributes: r }) => {
                let o = document.createElement('div'),
                    i = O(this.options.HTMLAttributes, r, { 'data-type': this.name });
            ...
            return {
                ...
                unsetDetails:
                    ...
                    ({ state: t, chain: e }) => {
                        ...
                        if (!o) return !1;
                        let i = on(o.node, (y) => y.type === r.nodes.detailsSummary),
                            s = on(o.node, (y) => y.type === r.nodes.detailsContent);
            ...
            return [
                new P({
                    ...
                    appendTransaction: (t, e, n) => {
                        ...
                        if (!d) return;
                        let u = on(d.node, (y) => y.type === n.schema.nodes.detailsSummary);
                        if (!u.length) return;
                        let f = u[0],
                            p =
    ...
    bf = $.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            return ['div', O(this.options.HTMLAttributes, t, { 'data-type': this.name }), 0];
        },
        addNodeView() {
...
var P0 = $.create({
        ...
        addInputRules() {
            return [Nr({ find: /^(?:---|—-|___\s|\*\*\*\s)$/, type: this.type })];
        },
    }),
    Tf = P0;
var L0 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/,
    ...
    $0 = ee.create({
        ...
        addInputRules() {
            return [De({ find: L0, type: this.type }), De({ find: z0, type: this.type })];
        },
        addPasteRules() {
            return [Me({ find: B0, type: this.type }), Me({ find: H0, type: this.type })];
        },
    }),
    Af = $0;
var F0 = /(?:^|\s)(!\[(.+|:?)]\((\S+)(?:(?:\s+)["'](\S+)["'])?\))$/,
...
function X0(t = []) {
    ...
    (ie(l, xt), ie(l, kt, i), ie(l, Rr, l), ie(i, kt, i), ie(i, xt), ie(i, Rr, i));
...
function Z0({ groups: t }) {
    let e = t.domain.concat([
        ...
        r = [yi, bi, wi, xi, ki, Si, Ci, vi, Ve, Pr, Lr, Br, Mi, Ti, Ai, zr, at, Ni, Hr, Ei],
        o = Fe(),
        i = T(o, Hr);
    ...
    let p = T(u, Ve);
    (T(p, Ve, p), U(p, t.domain, u), U(h, t.domain, u), T(h, lt, f), T(h, Ve, p));
    let m = T(h, Vt);
    U(m, t.numeric, Lf);
    let g = T(s, Ve),
        y = T(s, lt);
    ...
    for (let j = 0; j < z.length; j++) {
        ...
        U(R, e, F);
        let W = Fe();
        (U(R, n), U(F, e, F), U(F, n, W), U(W, e, F), U(W, n, W), T(F, _, x), T(W, _, x));
    }
...
function ew(t, e, n) {
    ...
    for (; o < r; ) {
        ...
        if (f < 0) ((o -= d), o < r && (s.push(n[o]), o++));
            ...
            (s.length > 0 && (i.push(ea(Bf, e, s)), (s = [])), (o -= f), (d -= f));
            let h = u.t,
                p = n.slice(o - d, o);
            i.push(ea(h, e, p));
        }
...
function ga(t, e = !1) {
    if (
        (Z.initialized &&
            tw(`linkifyjs: already initialized - will not register custom scheme "${t}" ${nw}`),
...
function Ri(t) {
    return (Z.initialized || rw(), ew(Z.parser.start, t, Wf(Z.scanner.start, t)));
}
Ri.scan = Wf;
                ...
                ($o(l).forEach(({ newRange: c }) => {
                    ...
                    if (u && f) {
                        ...
                        g.filter((y) => y.isLink)
                            ...
                            .forEach((y) => {
                                Ar(y.from, y.to, r.doc).some((b) => b.mark.type === t.type) ||
                    ...
                    getAttrs: (t) => {
                        ...
                        return !e ||
                            !this.options.isAllowedUri(e, {
                                defaultValidate: (n) => !!cn(n, this.options.protocols),
                    ...
                    ({ commands: t, chain: e }) =>
                        this.options.keepAttributes
                            ? e()
                                  ...
                                  .updateAttributes(pw, this.editor.getAttributes(qf))
                                  .run()
                            : t.toggleList(
                                  this.name,
                                  this.options.itemTypeName,
                ...
                Backspace: ({ editor: t }) => {
                    ...
                    return (
                        this.options.listTypes.forEach(({ itemName: n, wrapperNames: r }) => {
                            t.state.schema.nodes[n] !== void 0 && ba(t, n, r) && (e = !0);
                        }),
                        e
                    );
                },
...
`),
                    ...
                    ({ commands: t, chain: e }) =>
                        this.options.keepAttributes
                            ? e()
                                  ...
                                  .updateAttributes(kw, this.editor.getAttributes(Xf))
                                  .run()
                            : t.toggleList(
                                  this.name,
                                  this.options.itemTypeName,
    ...
    vw = $.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            return ['ul', O(this.options.HTMLAttributes, t, { 'data-type': this.name }), 0];
        },
...
`,
    ...
    Hv = K.create({
        ...
        addExtensions() {
            let t = [];
            return (
                this.options.bulletList !== !1 && t.push(xa.configure(this.options.bulletList)),
                this.options.listItem !== !1 && t.push(ka.configure(this.options.listItem)),
                this.options.listKeymap !== !1 && t.push(yw.configure(this.options.listKeymap)),
                this.options.orderedList !== !1 && t.push(Ca.configure(this.options.orderedList)),
                this.options.taskItem !== !1 && t.push(Cw.configure(this.options.taskItem)),
                this.options.taskList !== !1 && t.push(vw.configure(this.options.taskList)),
                t
            );
        },
    });
                            ...
                            r().upload(`componentFileAttachments.${l}.${y}`, m, () => {
                                c(y).then((b) => {
                                    b &&
                                        ...
                                        g === f.length - 1 && Vn(d, 'form-processing-finished'));
                                });
                            });
                        }),
                        !0
                        ...
                        return m
                            ...
                            : (u.preventDefault(),
                              ...
                              f.forEach((g, y) => {
                                  ...
                                  let b = Ma();
                                  r().upload(`componentFileAttachments.${l}.${b}`, g, () => {
                                      c(b).then((w) => {
                                          w &&
                                              (t
                                                  .chain()
                        ...
                        if (y.length) {
                            ...
                            return (
                                ...
                                (async () => {
                                    ...
                                    x.innerHTML = C;
                                    let S = Ae.fromSchema(t.state.schema).parseSlice(x, {
                                        preserveWhitespace: !1,
                                    });
                                    (t.view.dispatch(t.state.tr.replaceRange(b, w, S)),
                                        t.setEditable(!0),
                                        d.dom.dispatchEvent(
                                            new CustomEvent('rich-editor-uploaded-file', {
                                                bubbles: !0,
...
function Tw(t) {
    ...
    return (
        ...
        w < l.pos && C >= l.pos
            ? { range: { from: w, to: C }, query: g[0].slice(n.length), text: g[0] }
            : null
    );
}
        ...
        try {
            let A = t.getState(S.state),
                ...
                j = {
                    ...
                    items: [],
                    command: (V) =>
                        u({ editor: e, range: A?.range || { from: 0, to: 0 }, props: V }),
                    decorationNode: z,
                    clientRect: w(S, z),
                };
            ...
            return {
                update: async (S, k) => {
                    ...
                    let R = (E = this.key) == null ? void 0 : E.getState(k),
                        ...
                        W = R.active && F.active && R.range.from !== F.range.from,
                        X = !R.active && F.active,
                    ...
                    if (!Tt && !q && !Ze) return;
                    let Te = Ze && !Tt ? R : F,
                        Ua = S.dom.querySelector(`[data-decoration-id="${Te.decorationId}"]`);
                    ((g = {
                        editor: e,
                        range: Te.range,
                        query: Te.query,
                        text: Te.text,
                        items: [],
                        command: (Bp) => u({ editor: e, range: Te.range, props: Bp }),
                        decorationNode: Ua,
                        clientRect: w(S, Ua),
                    }),
                        Tt && ((A = y?.onBeforeStart) == null || A.call(y, g)),
                        q && ((z = y?.onBeforeUpdate) == null || z.call(y, g)),
                        (q || Tt) && (g.items = await f({ editor: e, query: Te.query })),
        ...
        state: {
            ...
            apply(S, k, E, M) {
                ...
                if (((R.composing = z), A && (V || e.view.composing))) {
                    (_ < k.range.from || _ > k.range.to) && !z && !k.composing && (R.active = !1);
                    let W = m({
                            char: n,
                            allowSpaces: r,
                            allowToIncludeChar: o,
                    ...
                    W && p({ editor: e, state: M, range: W.range, isActive: k.active })
                        ? ((R.active = !0),
                          (R.decorationId = k.decorationId ? k.decorationId : X),
                          (R.range = W.range),
                          (R.query = W.query),
                          (R.text = W.text))
                        : (R.active = !1);
                ...
                if (k.key === 'Escape' || k.key === 'Esc') {
                    let R = x.getState(S.state),
                        ...
                        W =
                            F ??
                            (R?.decorationId
                                ? S.dom.querySelector(`[data-decoration-id="${R.decorationId}"]`)
                                : null);
                    if (
                        ((M = y?.onKeyDown) == null
                            ? void 0
                            : M.call(y, { view: S, event: k, range: R.range })) ||
                        !1
                    )
                        return !0;
                    let oe = {
                        ...
                        text: R.text,
                        items: [],
                        command: (Se) => u({ editor: e, range: R.range, props: Se }),
                        decorationNode: W,
                        clientRect: W ? () => W.getBoundingClientRect() || null : null,
                    };
                    return ((A = y?.onExit) == null || A.call(y, oe), C(S, t), !0);
                }
                return (
                    ((z = y?.onKeyDown) == null
                        ? void 0
...
var Ii = Ew;
var Nw = function ({ editor: t, overrideSuggestionOptions: e, extensionName: n }) {
        let r = new H();
        return {
            editor: t,
            char: '{{',
    ...
    ih = $.create({
        ...
        renderHTML({ node: t, HTMLAttributes: e }) {
            let n = this.editor?.extensionStorage?.[this.name]?.getSuggestionFromChar('{{'),
                r = { ...this.options };
            r.HTMLAttributes = O({ 'data-type': this.name }, this.options.HTMLAttributes, e);
            let o = this.options.renderHTML({ options: r, node: t, suggestion: n });
            return typeof o == 'string'
                ? ['span', O({ 'data-type': this.name }, this.options.HTMLAttributes, e), o]
                : o;
        },
        renderText({ node: t }) {
            let e = {
        ...
        onBeforeCreate() {
            ((this.storage.suggestions = (
                ...
                Nw({ editor: this.editor, overrideSuggestionOptions: t, extensionName: this.name }),
            )),
...
function dh(t, e, n, r) {
    let o = We(t),
        i = Lw(Ie(t), n === 'start', r);
    return (o && ((i = i.map((s) => s + '-' + o)), e && (i = i.concat(i.map(_r)))), i);
}
function Wr(t) {
...
function zi(t) {
    return typeof t != 'number' ? Bw(t) : { top: t, right: t, bottom: t, left: t };
}
function Ct(t) {
...
var mh = (t) => ({
    ...
    async fn(e) {
        ...
        return {
            [h]: f[h] + W,
            data: { [h]: R, centerOffset: _ - R - W, ...(F && { alignmentOffset: W }) },
            reset: F,
        };
    },
});
            ...
            t === void 0 && (t = {}),
            {
                ...
                async fn(e) {
                    ...
                    let { rects: i, middlewareData: s, placement: l, platform: a, elements: c } = e,
                        ...
                        b = m[y];
                    if (b == null) return {};
                    let w = Na(b, i, await (a.isRTL == null ? void 0 : a.isRTL(c.floating)));
                    ...
                    let k = x
                            .map((A) => {
                                ...
                                return [
                                    A.placement,
                                    z && d
                                        ? A.overflows.slice(0, 2).reduce((j, V) => j + V, 0)
                                        : A.overflows[0],
                                    A.overflows,
                                ];
                            })
        ...
        return (
            t === void 0 && (t = {}),
            {
                ...
                async fn(e) {
                    ...
                    if (((A = [...A, { placement: o, overflows: M }]), !M.every((_) => _ <= 0))) {
                        var z, j;
                        let _ = (((z = i.flip) == null ? void 0 : z.index) || 0) + 1,
                            R = k[_];
                        if (
                            R &&
                            (!(u === 'alignment' ? b !== Xe(R) : !1) ||
                                A.every((X) => (Xe(X.placement) === b ? X.overflows[0] > 0 : !0)))
                        )
                            return { data: { index: _, overflows: A }, reset: { placement: R } };
                        let F =
            ...
            async fn(e) {
                ...
                switch (r) {
                    case 'referenceHidden': {
                        let i = await dn(e, { ...o, elementContext: 'reference' }),
                            s = fh(i, n.reference);
                        return { data: { referenceHiddenOffsets: s, referenceHidden: hh(s) } };
                    }
                    case 'escaped': {
                    ...
                    function p() {
                        ...
                        if (u.length >= 2) {
                            ...
                            let g = Ie(n) === 'left',
                                ...
                                b = _e(...u.map((A) => A.left)),
                                w = u.filter((A) => (g ? A.left === b : A.right === y)),
                                C = w[0].top,
        ...
        t === void 0 && (t = {}),
        {
            ...
            async fn(e) {
                ...
                let b = m - d.top - d.bottom,
                    ...
                    E = x;
                if (
                    ((n = e.middlewareData.shift) != null && n.enabled.x && (E = w),
                    ...
                    h
                        ...
                        : (k = m - 2 * (j !== 0 || V !== 0 ? j + V : me(d.top, d.bottom)));
                }
...
function dt(t) {
    var e;
    return (e = (Mh(t) ? t.ownerDocument : t.document) || window.document) == null
        ? void 0
        : e.documentElement;
}
function Mh(t) {
...
function Ye(t) {
    return $i() ? t instanceof HTMLElement || t instanceof Oe(t).HTMLElement : !1;
}
function vh(t) {
...
function Eh(t) {
    let e = vt(t);
    return fn(e) ? (t.ownerDocument ? t.ownerDocument.body : t.body) : Ye(e) && _n(e) ? e : Eh(e);
}
function Hi(t, e, n) {
    var r;
    ...
    if (i) {
        let l = _i(s);
        return e.concat(s, s.visualViewport || [], _n(o) ? o : [], l && n ? Hi(l) : []);
    }
...
function Xw(t) {
    ...
    let a = { scrollLeft: 0, scrollTop: 0 },
        ...
        d = Ge(0),
        u = Ye(r);
    if ((u || (!u && !i)) && ((un(r) !== 'body' || _n(s)) && (a = Kr(r)), Ye(r))) {
        let h = qr(r);
...
function Bh(t, e) {
    let n = vt(t);
    return n === e || !je(n) || fn(n) ? !1 : Ue(n).position === 'fixed' || Bh(n, e);
}
function nx(t, e) {
    let n = e.get(t);
    if (n) return n;
    ...
    for (; je(s) && !fn(s); ) {
        ...
        (!a && l.position === 'fixed' && (o = null),
            (
                i
                    ? !a && !o
                    : (!a && l.position === 'static' && !!o && ex.has(o.position)) ||
                      (_n(s) && !a && Bh(t, s))
            )
                ? (r = r.filter((d) => d !== s))
                : (o = l),
...
function rx(t) {
    let { element: e, boundary: n, rootBoundary: r, strategy: o } = t,
        s = [...(n === 'clippingAncestors' ? (Ur(e) ? [] : nx(e, this._c)) : [].concat(n)), r],
        l = s[0],
        a = s.reduce(
            (c, d) => {
                let u = Oh(e, d, o);
...
var jh = (t, e) => {
        Kn(
            ...
            e,
            { placement: 'bottom-start', strategy: 'absolute', middleware: [jn(), Un()] },
        ...
        return {
            ...
            render: () => {
                ...
                let u = () => {
                        ...
                        return (
                            (w.className = 'fi-dropdown-panel fi-dropdown-list fi-scrollable'),
                    ...
                    g = () => {
                        if (!c) return;
                        let w = Array.isArray(c.items) ? c.items : [];
                        w.length !== 0 && ((a = (a + w.length - 1) % w.length), f(), m());
                    },
                    y = () => {
                        if (!c) return;
                        let w = c.items || [];
                ...
                return {
                    ...
                    onUpdate: (w) => {
                        ((c = w), (a = 0), f(), m(), w.clientRect && jh(w.editor, l));
                    },
                    onKeyDown: (w) =>
                        w.event.key === 'Escape'
...
var cx = function ({ editor: t, overrideSuggestionOptions: e, extensionName: n }) {
        let r = new H(),
            o = e?.char ?? '@',
            i = e?.extraAttributes ?? {};
        return {
                    ...
                    c = {
                        ...Uh({
                            items: async ({ query: h }) => {
                                ...
                                return m.filter((y) => {
                                    let b = typeof y == 'string' ? y : (y?.label ?? y?.name ?? '');
...
function gx(t) {
    ...
    for (let c = 0, d = 0; c < n; c++) {
        ...
        for (let p = 0; ; p++) {
            ...
            for (let w = 0; w < y; w++) {
                if (w + c >= n) {
                    (i || (i = [])).push({ type: 'overlong_rowspan', pos: d, n: y - w });
                    break;
                }
                let C = o + w * e;
                for (let x = 0; x < g; x++) {
...
function bx(t, e, n) {
    ...
    for (let o = 0; o < t.map.length; o++) {
        ...
        for (let c = 0; c < a.colspan; c++) {
            ...
            d != null && (!a.colwidth || a.colwidth[c] != d) && ((l || (l = wx(a)))[c] = d);
        }
...
function Ex(t, e, n) {
    ...
    if (r instanceof I && (s = r.node.type.spec.tableRole)) {
        ...
        r instanceof D && Tx(r)
            ? (i = D.create(o, r.from))
            : r instanceof D && Ax(r) && (i = D.create(o, r.$from.start(), r.$from.end()));
...
function $a(t, e) {
    ...
    return (e ? e.doc != t.doc && up(e.doc, t.doc, 0, r) : t.doc.descendants(r), n);
}
function Ox(t, e, n, r) {
    let o = se.get(e);
...
function fp(t, { map: e, tableStart: n, table: r }, o) {
    ...
    for (let s = 0; s < e.height; s++) {
        ...
        if (o > 0 && o < e.width && e.map[l - 1] == e.map[l]) {
            let a = e.map[l],
                c = r.nodeAt(a);
            (t.setNodeMarkup(t.mapping.map(n + a), null, cp(c.attrs, o - e.colCount(a))),
                (s += c.attrs.rowspan - 1));
        } else {
            let a = i == null ? ke(r.type.schema).cell : r.nodeAt(e.map[l + i]).type,
...
function Rx(t, { map: e, table: n, tableStart: r }, o) {
    ...
    for (let s = 0; s < e.height; ) {
        ...
        if ((o > 0 && e.map[l - 1] == a) || (o < e.width - 1 && e.map[l + 1] == a))
            t.setNodeMarkup(t.mapping.slice(i).map(r + a), null, pn(d, o - e.colCount(a)));
        else {
    ...
    if (e) {
        ...
        if (
            (i.setNodeMarkup(a + r.tableStart, null, {
                ...cp(c.attrs, c.attrs.colspan, r.right - r.left - c.attrs.colspan),
...
function Hx(t) {
    ...
    if (i == 'row')
        for (let a = 0; a < e.childCount; a++) {
            ...
            ((d || u) && (c = Ba(ke(s).row, new N(c, d, u)).content), l.push(c));
        }
...
function np(t, e, n, r, o, i, s, l) {
    ...
    for (let c = o; c < i; c++) {
        ...
        if (e.map[d - 1] == u) {
            ...
            (t.setNodeMarkup(p, null, pn(f.attrs, s - h, f.attrs.colspan - (s - h))),
                t.insert(p + f.nodeSize, f.type.createAndFill(pn(f.attrs, 0, s - h))),
                (c += f.attrs.rowspan - 1));
        }
    }
    return a;
...
function jx(t, e, n) {
    ...
    let r = Hx(n),
        o = t.state.selection;
    if (o instanceof Y) {
        r || (r = { width: 1, height: 1, rows: [v.from(Ba(ke(t.state.schema).cell, n))] });
        ...
        let i = Gi(t.state),
            s = i.start(-1);
        return (rp(t.state, t.dispatch, s, se.get(i.node(-1)).findCell(i.pos - s), r), !0);
    } else return !1;
}
function Ux(t, e) {
    var n;
...
var Kx = class {
    ...
    update(t) {
        return t.type != this.node.type
            ? !1
            : ((this.node = t), za(t, this.colgroup, this.table, this.defaultCellMinWidth), !0);
    }
    ignoreMutation(t) {
        return (
    ...
    let i = new P({
        ...
        state: {
            init(s, l) {
                ...
                return (r && c && (c[d] = (u, f) => new r(u, n, f)), new qx(-1, !1));
            },
            apply(s, l) {
                return l.apply(s);
            },
...
var qx = class Ji {
    ...
    apply(e) {
        ...
        if (r && r.setDragging !== void 0) return new Ji(n.activeHandle, r.setDragging);
...
var ik = class {
    ...
    update(t) {
        return t.type !== this.node.type
            ? !1
            : ((this.node = t), Ap(t, this.colgroup, this.table, this.cellMinWidth), !0);
    }
    ignoreMutation(t) {
        let e = t.target,
...
var hk = fk,
    pk = $.create({
        ...
        renderHTML({ node: t, HTMLAttributes: e }) {
            let { colgroup: n, tableWidth: r, tableMinWidth: o } = sk(t, this.options.cellMinWidth),
                i = e.style;
            function s() {
                return i || (r ? `width: ${r}` : `min-width: ${o}`);
            }
            let l = ['table', O(this.options.HTMLAttributes, e, { style: s() }), n, ['tbody', 0]];
        ...
        addProseMirrorPlugins() {
            return [
                ...(this.options.resizable && this.editor.isEditable
                    ...
                    : []),
                Tp({ allowTableNodeSelection: this.options.allowTableNodeSelection }),
            ];
        },
        extendNodeSchema(t) {
    ...
    Np = K.create({
        ...
        addExtensions() {
            let t = [];
            return (
                this.options.table !== !1 && t.push(pk.configure(this.options.table)),
                this.options.tableCell !== !1 && t.push(nk.configure(this.options.tableCell)),
                this.options.tableHeader !== !1 && t.push(rk.configure(this.options.tableHeader)),
                this.options.tableRow !== !1 && t.push(ok.configure(this.options.tableRow)),
                t
            );
        },
    });
    ...
    Pp = ({ mergeTags: t, noMergeTagSearchResultsMessage: e }) => ({
        ...
        render: () => {
            ...
            return {
                ...
                onUpdate: (f) => {
                    ((o = f), (r = 0), s(), a(), f.clientRect && Ip(f.editor, n));
                },
                onKeyDown: (f) =>
                    f.event.key === 'Escape'
...
var Lp = async ({
    ...
    let k = [
            ...
            ...(Object.keys(y).length
                ? [
                      ih.configure({
                          deleteTriggerWithBackspace: !0,
                          suggestion: Pp({ mergeTags: y, noMergeTagSearchResultsMessage: b }),
                          mergeTags: y,
                      }),
                  ]
                : []),
    ...
    for (let M of E) {
        ...
        (M.name === 'placeholder' && M.parent === null && (M = Ra.configure(M.options)),
            A !== -1 ? (k[A] = M) : k.push(M));
    }
    return k;
};
...
var wk = class {
        ...
        get middlewares() {
            ...
            return (
                ...
                this.floatingUIOptions.arrow && t.push(_h(this.floatingUIOptions.arrow)),
            ...
            if (e instanceof Y) {
                ...
                let u =
                    c === d
                        ...
                        : bk(c.getBoundingClientRect(), d.getBoundingClientRect());
...
window.FilamentRichEditor.tiptap = { core: qo, pmState: ao, pmView: fl, pmModel: Is };
function Sk({
    acceptedFileTypes: t,
    ...
    return {
                ...
                V.registerPlugin(
                    ja({
                        ...
                        shouldShow: ({ editor: Te }) =>
                            q === 'paragraph'
                                ? Te.isFocused && Te.isActive(q) && !Te.state.selection.empty
                                : F && !Te.state.selection.empty && Te.isActive('paragraph')
                                  ? !1
        ...
        setEditorSelection(F) {
            F &&
                ...
                V.chain()
                    .command(
                        ({ tr: W }) => (
                            W.setSelection(kk.fromJSON(V.state.doc, this.editorSelection)),
                            !0
                        ),
                    )
                    .run());
        ...
        runEditorCommands({ commands: F, editorSelection: W }) {
            ...
            let X = V.chain();
            (F.forEach((oe) => (X = X[oe.name](...(oe.arguments ?? [])))), X.run());
        },
        togglePanel(F = null) {
