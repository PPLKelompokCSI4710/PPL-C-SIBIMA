...
function xa(t, e, n) {
    for (let r = 0; ; r++) {
        ...
        if (o.content.size || i.content.size) {
            let s = xa(o.content, i.content, n + 1);
            if (s != null) return s;
        }
        n += o.nodeSize;
    }
...
function ka(t, e, n, r) {
    for (let o = t.childCount, i = e.childCount; ; ) {
        ...
        if (s.content.size || l.content.size) {
            let c = ka(s.content, l.content, n - 1, r - 1);
            if (c) return c;
        }
        ((n -= a), (r -= a));
    }
...
var v = class t {
    ...
    findIndex(e) {
        ...
        for (let n = 0, r = 0; ; n++) {
            let o = this.child(n),
                i = r + o.nodeSize;
            if (i >= e) return i == e ? Er(n + 1, i) : Er(n, r);
            r = i;
        }
    }
    toString() {
...
function Or(t, e) {
    ...
    if (n) {
        ...
        for (let r = 0; r < t.length; r++) if (!Or(t[r], e[r])) return !1;
    } else {
        for (let r in t) if (!(r in e) || !Or(t[r], e[r])) return !1;
...
var _t = class extends Error {},
    N = class t {
        ...
        removeBetween(e, n) {
            return new t(
                Sa(this.content, e + this.openStart, n + this.openStart),
                this.openStart,
                this.openEnd,
            );
        }
...
function Sa(t, e, n) {
    ...
    return t.replaceChild(r, i.copy(Sa(i.content, e - o - 1, n - o - 1)));
}
function Ca(t, e, n, r) {
    ...
    let l = Ca(s.content, e - i - 1, n, s);
    return l && t.replaceChild(o, s.copy(l));
}
function lp(t, e, n) {
    if (n.openStart > t.depth) throw new _t('Inserted content deeper than insertion position');
    if (t.depth - n.openStart != e.depth - n.openEnd) throw new _t('Inconsistent open depths');
    return va(t, e, n, 0);
}
function va(t, e, n, r) {
    let o = t.index(r),
    ...
    if (o == e.index(r) && r < t.depth - n.openStart) {
        ...
        if (!n.openStart && !n.openEnd && t.depth == r && e.depth == r) {
            let s = t.parent,
                l = s.content;
            return Ft(s, l.cut(0, t.parentOffset).append(n.content).append(l.cut(e.parentOffset)));
        } else {
            let { start: s, end: l } = ap(n, t);
            return Ft(i, Ta(t, s, l, e, r));
        }
    else return Ft(i, Rr(t, e, r));
}
function Ma(t, e) {
    if (!e.type.compatibleContent(t.type))
        throw new _t('Cannot join ' + e.type.name + ' onto ' + t.type.name);
}
function Ai(t, e, n) {
    let r = t.node(n);
    return (Ma(r, e.node(n)), r);
}
function $t(t, e) {
    let n = e.length - 1;
...
function Hn(t, e, n, r) {
    ...
    t && ((i = t.index(n)), t.depth > n ? i++ : t.textOffset && ($t(t.nodeAfter, r), i++));
    for (let l = i; l < s; l++) $t(o.child(l), r);
...
function Ta(t, e, n, r, o) {
    ...
    return (
        ...
        i && s && e.index(o) == n.index(o)
            ? (Ma(i, s), $t(Ft(i, Ta(t, e, n, r, o + 1)), l))
            : (i && $t(Ft(i, Rr(t, e, o + 1)), l),
              Hn(e, n, o, l),
              s && $t(Ft(s, Rr(n, r, o + 1)), l)),
        Hn(r, null, o, l),
        new v(l)
    );
}
function Rr(t, e, n) {
    let r = [];
    if ((Hn(null, t, n, r), t.depth > n)) {
        let o = Ai(t, e, n + 1);
        $t(Ft(o, Rr(t, e, n + 1)), r);
    }
    return (Hn(e, null, n, r), new v(r));
}
function ap(t, e) {
...
var Dr = class t {
        ...
        static resolveCached(e, n) {
            ...
            else ua.set(e, (r = new Ei()));
            let o = (r.elts[r.i] = t.resolve(e, n));
            return ((r.i = (r.i + 1) % cp), o);
        }
    },
    Ei = class {
        constructor() {
    ...
    se = class t {
        ...
        hasMarkup(e, n, r) {
            return (
                this.type == e &&
                Or(this.attrs, n || e.defaultAttrs || dp) &&
...
var Ni = class t extends se {
    ...
    toString() {
        return this.type.spec.toDebugString
            ...
            : Aa(this.marks, JSON.stringify(this.text));
    }
    get textContent() {
        return this.text;
    }
...
function yp(t) {
    ...
    function n(r) {
        ...
        let i = (e[r.join(',')] = new Wt(r.indexOf(t.length - 1) > -1));
...
var Ir = class t {
    constructor(e, n, r) {
        ((this.name = e),
            ...
            (this.attrs = Ia(e, r.attrs)),
            (this.defaultAttrs = Oa(this.attrs)),
    ...
    create(e = null, n, r) {
        ...
        return new se(this, this.computeAttrs(e), v.from(n), J.setFrom(r));
    }
    createChecked(e = null, n, r) {
        return (
            (n = v.from(n)),
            this.checkContent(n),
            new se(this, this.computeAttrs(e), n, J.setFrom(r))
        );
    }
    createAndFill(e = null, n, r) {
        ...
        return i ? new se(this, e, n.append(i), J.setFrom(r)) : null;
    }
    validContent(e) {
...
var Ri = class {
        constructor(e, n, r) {
            ((this.hasDefault = Object.prototype.hasOwnProperty.call(r, 'default')),
                ...
                (this.validate =
                    typeof r.validate == 'string' ? wp(e, n, r.validate) : r.validate));
        }
        get isRequired() {
    ...
    Fn = class t {
        constructor(e, n, r, o) {
            ((this.name = e),
                ...
                (this.schema = r),
                (this.spec = o),
                (this.attrs = Ia(e, o.attrs)),
                (this.excluded = null));
            let i = Oa(this.attrs);
            this.instance = i ? new J(this, i) : null;
        }
        create(e = null) {
            return !e && this.instance ? this.instance : new J(this, Ra(this.attrs, e));
        }
        static compile(e, n) {
            let r = Object.create(null),
                o = 0;
    ...
    fn = class {
        constructor(e) {
            ...
            ((n.nodes = vi.from(e.nodes)),
                ...
                (this.nodes = Ir.compile(this.spec.nodes, this)),
                (this.marks = Fn.compile(this.spec.marks, this)));
            let r = Object.create(null);
            for (let o in this.nodes) {
                ...
                let i = this.nodes[o],
                    ...
                    l = i.spec.marks;
                if (
                    ((i.contentMatch = r[s] || (r[s] = Wt.parse(s, this.nodes))),
            ...
            for (let o in this.marks) {
                let i = this.marks[o],
                    s = i.spec.excludes;
                i.excluded = s == null ? [i] : s == '' ? [] : pa(this, s.split(' '));
            }
...
var Ie = class t {
        ...
        parse(e, n = {}) {
            let r = new Pr(this, n, !1);
            return (r.addAll(e, J.none, n.from, n.to), r.finish());
        }
        parseSlice(e, n = {}) {
            let r = new Pr(this, n, !0);
            return (r.addAll(e, J.none, n.from, n.to), N.maxOpen(r.finish()));
        }
        matchTag(e, n, r) {
        ...
        static schemaRules(e) {
            ...
            for (let o in e.marks) {
                ...
                i &&
                    i.forEach((s) => {
                        (r((s = ga(s))), s.mark || s.ignore || s.clearMark || (s.mark = o));
                    });
            }
            for (let o in e.nodes) {
                ...
                i &&
                    i.forEach((s) => {
                        (r((s = ga(s))), s.node || s.ignore || s.mark || (s.node = o));
                    });
            }
            return n;
        }
    ...
    Sp = { head: !0, noscript: !0, object: !0, script: !0, style: !0, title: !0 },
    La = { ol: !0, ul: !0 },
    _n = 1,
    Di = 2,
    $n = 4;
...
var un = class {
        constructor(e, n, r, o, i, s) {
            ((this.type = e),
                ...
                (this.match = i || (s & $n ? null : e.contentMatch)));
        }
        findWrapping(e) {
            if (!this.match) {
                if (!this.type) return [];
        ...
        inlineContext(e) {
            return this.type
                ...
                : this.content.length
                  ...
                  : e.parentNode && !Pa.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
        }
    },
    Pr = class {
        constructor(e, n, r) {
            ...
            let o = n.topNode,
                i,
                s = ma(null, n.preserveWhitespace, 0) | (r ? $n : 0);
            (o
        ...
        addTextNode(e, n) {
            let r = e.nodeValue,
                o = this.top,
                i = o.options & Di ? 'full' : this.localPreserveWS || (o.options & _n) > 0,
...
`,
        ...
        addElement(e, n, r) {
            ...
            let s = e.nodeName.toLowerCase(),
                l;
            La.hasOwnProperty(s) && this.parser.normalizeLists && Cp(e);
            let a =
                (this.options.ruleFromNode && this.options.ruleFromNode(e)) ||
                (l = this.parser.matchTag(e, this, r));
            e: if (a ? a.ignore : Sp.hasOwnProperty(s))
...
`),
        ...
        insertNode(e, n, r) {
            ...
            if (o) {
                ...
                for (let l of o.concat(e.marks))
                    (i.type ? i.type.allowsMarkType(l.type) : ya(l.type, e.type)) &&
                        (s = l.addToSet(s));
        ...
        enterInner(e, n, r, o = !1, i) {
            ...
            let l = ma(e, i, s.options);
            s.options & $n && s.content.length == 0 && (l |= $n);
            let a = J.none;
            return (
                (r = r.filter((c) =>
                    (s.type ? s.type.allowsMarkType(c.type) : ya(c.type, e))
                        ? ((a = c.addToSet(a)), !1)
                        : !0,
                )),
...
var ct = class t {
    ...
    serializeNodeInner(e, n) {
        let { dom: r, contentDOM: o } = Nr(Ti(n), this.nodes[e.type.name](e), null, e.attrs);
        if (o) {
    ...
    serializeMark(e, n, r = {}) {
        ...
        return o && Nr(Ti(r), o(e, n), null, e.attrs);
    }
...
function Mp(t) {
    let e = wa.get(t);
    return (e === void 0 && wa.set(t, (e = Tp(t))), e);
}
function Tp(t) {
    let e = null;
    function n(r) {
...
function Nr(t, e, n, r) {
    ...
    for (let u = d; u < e.length; u++) {
        ...
        if (f === 0) {
            ...
            let { dom: h, contentDOM: p } = Nr(t, f, n, r);
...
var Fa = 1,
    ...
    jn = class {
        ...
        get deletedBefore() {
            return (this.delInfo & (Fa | Lr)) > 0;
        }
        get deletedAfter() {
            return (this.delInfo & (_a | Lr)) > 0;
        }
        get deletedAcross() {
            ...
            for (let l = 0; l < this.ranges.length; l += 3) {
                ...
                if (e <= u) {
                    let f = c ? (e == a ? -1 : e == u ? 1 : n) : n,
                        h = a + o + (f < 0 ? 0 : d);
                    if (r) return h;
                    let p = e == (n < 0 ? a : u) ? null : Ap(l / 3, e - a),
                        m = e == a ? _a : e == u ? Fa : Lr;
                    return ((n < 0 ? e != a : e != u) && (m |= Va), new jn(h, m, p));
                }
                o += d - c;
            }
            return r ? e + o : new jn(e + o, 0, null);
        }
        touches(e, n) {
            let r = 0,
                o = Ba(n),
    ...
    fe = class t {
        ...
        static fromReplace(e, n, r, o) {
            try {
                ...
                if (i instanceof _t) return t.fail(i.message);
                throw i;
            }
        }
    };
...
var qn = class t extends de {
    ...
    apply(e) {
        ...
        return fe.fromReplace(e, this.pos, this.pos + 1, new N(v.from(r), 0, n.isLeaf ? 0 : 1));
    }
    invert(e) {
        let n = e.nodeAt(this.pos);
        if (n) {
...
de.jsonID('addNodeMark', qn);
var hn = class t extends de {
    constructor(e, n) {
        (super(), (this.pos = e), (this.mark = n));
    }
    apply(e) {
    ...
    invert(e) {
        let n = e.nodeAt(this.pos);
        return !n || !this.mark.isInSet(n.marks) ? this : new qn(this.pos, this.mark);
    }
    map(e) {
        let n = e.mapResult(this.pos, 1);
        return n.deletedAfter ? null : new t(n.pos, this.mark);
...
function Np(t, e, n, r) {
    ...
    (t.doc.nodesBetween(e, n, (a, c, d) => {
        ...
        if (!r.isInSet(u) && d.type.allowsMarkType(r.type)) {
            ...
            l && l.to == f ? (l.to = h) : i.push((l = new Kn(f, h, r)));
        }
    }),
        ...
        if (!u) s.push(new ye(l, d, N.empty));
            ...
            if (o && c.isText && n.whitespace != 'pre') {
                let f,
                    ...
                    p;
                for (; (f = h.exec(c.text)); )
                    (p || (p = new N(v.from(n.schema.text(' ', n.allowedMarks(c.marks))), 0, 0)),
...
function ft(t) {
    ...
    for (let r = t.depth, o = 0, i = 0; ; --r) {
        ...
        if (r == 0 || s.type.spec.isolating || !Rp(s, l, a)) break;
...
function mn(t, e, n = null, r = t) {
    let o = Ip(t, e),
        i = o && Pp(r, e);
    return i ? o.map(za).concat({ type: e, attrs: n }).concat(i.map(za)) : null;
}
function za(t) {
...
function Bp(t, e, n, r, o) {
    ...
    t.doc.nodesBetween(e, n, (s, l) => {
        ...
        if (s.isTextblock && !s.hasMarkup(r, a) && zp(t.doc, t.mapping.slice(i).map(l), r)) {
            let c = null;
...
function Hp(t, e, n, r, o) {
    ...
    t.step(new le(e, e + i.nodeSize, e + 1, e + i.nodeSize - 1, new N(v.from(s), 0, 0), 1, !0));
}
...
function Pe(t, e) {
    let n = t.resolve(e),
        r = n.index();
    return Ua(n.nodeBefore, n.nodeAfter) && n.parent.canReplace(r, r + 1);
}
function Fp(t, e) {
...
function jt(t, e, n = -1) {
    ...
    for (let o = r.depth; ; o--) {
        ...
        if (
            ...
            i && !i.isTextblock && Ua(i, s) && r.node(o).canReplace(l, l + 1))
        )
            return e;
        if (o == 0) break;
...
function _p(t, e, n) {
    ...
    if ((t.step(new ye(c, a.map(e + n, -1), N.empty, !0)), r === !0)) {
        ...
        Wa(t, d.node(), d.before(), t.steps.length);
    }
    return t;
}
function Vp(t, e, n) {
...
function Jn(t, e, n = e, r = N.empty) {
    if (e == n && !r.size) return null;
    let o = t.resolve(e),
        i = t.resolve(n);
    return Ka(o, i, r) ? new ye(e, n, r) : new zi(o, i, r).fit();
}
function Ka(t, e, n) {
    return (
        !n.openStart &&
...
var zi = class {
    ...
    openMore() {
        ...
        return !o.childCount || o.firstChild.isLeaf
            ? !1
            : ((this.unplaced = new N(e, n + 1, Math.max(r, o.size + n >= e.size - r ? n + 1 : 0))),
              !0);
    }
    dropNode() {
        let { content: e, openStart: n, openEnd: r } = this.unplaced,
        ...
        if (o.childCount <= 1 && n > 0) {
            ...
            this.unplaced = new N(Vn(e, n - 1, 1), n - 1, i ? n - 1 : r);
        } else this.unplaced = new N(Vn(e, n, 1), n, r);
    }
    placeNodes({ sliceDepth: e, frontierDepth: n, parent: r, inject: o, wrap: i }) {
        ...
        (p || (h = -1),
            (this.placed = Wn(this.placed, n, v.from(d))),
        ...
        this.unplaced = p
            ? e == 0
                ? N.empty
                : new N(Vn(s.content, e - 1, 1), e - 1, h < 0 ? s.openEnd : e - 1)
            : new N(Vn(s.content, e, c), s.openStart, s.openEnd);
    }
    mustMoveInline() {
    ...
    openFrontierNode(e, n = null, r) {
        ...
        ((o.match = o.match.matchType(e)),
            (this.placed = Wn(this.placed, this.depth, v.from(e.create(n, r)))),
...
function Wn(t, e, n) {
    return e == 0
        ? t.append(n)
        : t.replaceChild(t.childCount - 1, t.lastChild.copy(Wn(t.lastChild.content, e - 1, n)));
}
function Pi(t, e) {
...
function qa(t, e, n) {
    ...
    let r = t.content;
    return (
        e > 1 && (r = r.replaceChild(0, qa(r.firstChild, e - 1, r.childCount == 1 ? n - 1 : 0))),
        e > 0 &&
...
function Up(t, e, n, r) {
    ...
    let o = t.doc.resolve(e),
        i = t.doc.resolve(n);
    if (Ka(o, i, r)) return t.step(new ye(e, n, r));
    let s = Ga(o, i);
            ...
            for (let m = 0; m < s.length; m++) {
                ...
                if (w.canReplaceWith(b, b, p.type, p.marks))
                    return t.replace(
                        o.before(g),
                        y ? i.after(g) : n,
                        new N(Ja(r.content, 0, r.openStart, h), h, r.openEnd),
                    );
            }
    }
...
function Ja(t, e, n, r, o) {
    if (e < n) {
        let i = t.firstChild;
        t = t.replaceChild(0, i.copy(Ja(i.content, e + 1, n, r, i)));
    }
    if (e > r) {
...
var Br = class t extends de {
    ...
    apply(e) {
        ...
        return fe.fromReplace(e, this.pos, this.pos + 1, new N(v.from(o), 0, n.isLeaf ? 0 : 1));
    }
    getMap() {
        return dt.empty;
    }
...
var At = class {
    ...
    wrap(e, n) {
        return (Lp(this, e, n), this);
    }
    setBlockType(e, n = e, r, o = null) {
        return (Bp(this, e, n, r, o), this);
    }
    ...
    setDocAttribute(e, n) {
        return (this.step(new zr(e, n)), this);
    }
    addNodeMark(e, n) {
        return (this.step(new qn(e, n)), this);
    }
    removeNodeMark(e, n) {
...
var Fi = Object.create(null),
    I = class {
        ...
        replace(e, n = N.empty) {
            ...
            for (let l = 0; l < s.length; l++) {
                ...
                (e.replaceRange(d.map(a.pos), d.map(c.pos), l ? N.empty : n),
                    l == 0 && Qa(e, i, (r ? r.isInline : o && o.isTextblock) ? -1 : 1));
            }
        }
        replaceWith(e, n) {
            ...
            for (let i = 0; i < o.length; i++) {
                ...
                i
                    ? e.deleteRange(c, d)
                    : (e.replaceRangeWith(c, d, n), Qa(e, r, n.isInline ? -1 : 1));
            }
        }
        ...
        static atStart(e) {
            return gn(e, e, 0, 0, 1) || new Se(e);
        }
        static atEnd(e) {
            return gn(e, e, e.content.size, e.childCount, -1) || new Se(e);
        }
        static fromJSON(e, n) {
    ...
    Wi = class extends At {
        ...
        setSelection(e) {
            ...
            return (
                (this.curSelection = e),
                (this.curSelectionFor = this.steps.length),
                (this.updated = (this.updated | Za) & ~$r),
        ...
        addStep(e, n) {
            (super.addStep(e, n), (this.updated = this.updated & ~$r), (this.storedMarks = null));
        }
        setTime(e) {
...
var Ut = class {
        constructor(e, n, r) {
            ((this.name = e), (this.init = tc(n.init, r)), (this.apply = tc(n.apply, r)));
        }
    },
    Gp = [
        new Ut('doc', {
                ...
                n &&
                    n.forEach((r) => {
                        ...
                        (this.plugins.push(r),
                            ...
                            r.spec.state && this.fields.push(new Ut(r.key, r.spec.state, r)));
                    }));
        }
    },
    _r = class t {
        ...
        static create(e) {
            let n = new Gn(e.doc ? e.doc.type.schema : e.schema, e.plugins),
                r = new t(n);
            for (let o = 0; o < n.fields.length; o++) r[n.fields[o].name] = n.fields[o].init(e, r);
            return r;
        }
        reconfigure(e) {
            let n = new Gn(this.schema, e.plugins),
                r = n.fields,
                o = new t(n);
        ...
        static fromJSON(e, n, r) {
            ...
            let o = new Gn(e.schema, e.plugins),
                i = new t(o);
            return (
                o.fields.forEach((s) => {
...
function nc(t, e, n) {
    for (let r in t) {
        let o = t[r];
        (o instanceof Function ? (o = o.bind(e)) : r == 'handleDOMEvents' && (o = nc(o, e, {})),
            (n[r] = o));
    }
    return n;
}
var P = class {
        constructor(e) {
            ((this.spec = e),
                (this.props = {}),
                e.props && nc(e.props, this, this.props),
                (this.key = e.key ? e.key.key : rc('plugin')));
        }
        getState(e) {
            return e[this.key];
        }
...
function rc(t) {
    return t in _i ? t + '$' + ++_i[t] : ((_i[t] = 0), t + '$');
}
var H = class {
    constructor(e = 'key') {
        this.key = rc(e);
...
var Ui = (t, e, n) => {
        ...
        let i = o.nodeBefore;
        if (pc(t, o, e, -1)) return !0;
        if (r.parent.content.size == 0 && (bn(i, 'end') || L.isSelectable(i)))
            for (let s = r.depth; ; s--) {
                let l = Jn(t.doc, r.before(s), r.after(s), N.empty);
...
var Ji = (t, e, n) => {
        ...
        if (r.parent.content.size == 0 && (bn(i, 'start') || L.isSelectable(i))) {
            let s = Jn(t.doc, r.before(), r.after(), N.empty);
...
var dc = (t, e) => {
        let n = t.selection,
            ...
            o;
        if (r) {
            if (n.node.isTextblock || !Pe(t.doc, n.from)) return !1;
            o = n.from;
        } else if (((o = jt(t.doc, n.from, -1)), o == null)) return !1;
        if (e) {
            let i = t.tr.join(o);
    ...
    uc = (t, e) => {
        let n = t.selection,
            r;
        if (n instanceof L) {
            if (n.node.isTextblock || !Pe(t.doc, n.to)) return !1;
            r = n.to;
        } else if (((r = jt(t.doc, n.to, 1)), r == null)) return !1;
...
var Zi = (t, e) => {
    ...
    es = (t, e) => {
        let n = t.selection,
            { $from: r, $to: o } = n;
        if (n instanceof Se || r.parent.inlineContent || o.parent.inlineContent) return !1;
...
function Xp(t) {
    return (e, n) => {
        ...
        let d = e.tr;
        (e.selection instanceof D || e.selection instanceof Se) && d.deleteSelection();
        let u = d.mapping.map(r.pos),
            f = Oe(d.doc, u, i.length, i);
        if ((f || ((i[0] = l ? { type: l } : null), (f = Oe(d.doc, u, i.length, i))), !f))
            return !1;
...
var hc = (t, e) => {
    ...
    Qp = (t, e) => (e && e(t.tr.setSelection(new Se(t.doc))), !0);
function Zp(t, e, n) {
    let r = e.nodeBefore,
        o = e.nodeAfter,
        i = e.index();
    return !r || !o || !r.type.compatibleContent(o.type)
        ...
        : !r.content.size && e.parent.canReplace(i - 1, i)
          ...
          : !e.parent.canReplace(i, i + 1) || !(o.isTextblock || Pe(t.doc, e.pos))
            ? !1
...
function pc(t, e, n, r) {
    ...
    if (
        ...
        if (n) {
            ...
            p = v.from(o.copy(p));
            let m = t.tr.step(new le(e.pos - 1, h, e.pos, h, new N(p, 1, 0), s.length, !0)),
                g = m.doc.resolve(h + 2 * s.length);
            (g.nodeAfter && g.nodeAfter.type == o.type && Pe(m.doc, g.pos) && m.join(g.pos),
                n(m.scrollIntoView()));
        }
        return !0;
    }
...
var ji = ss(Vr, Ui, Ki),
    ...
    em = {
        'Ctrl-h': Et.Backspace,
        'Alt-Backspace': Et['Mod-Backspace'],
        'Ctrl-d': Et.Delete,
        'Ctrl-Alt-Backspace': Et['Mod-Delete'],
        'Alt-Delete': Et['Mod-Delete'],
        'Alt-d': Et['Mod-Delete'],
        'Ctrl-a': ns,
        'Ctrl-e': rs,
    };
for (let t in Et) em[t] = Et[t];
var dk =
    typeof navigator < 'u'
...
function yc(t, e = null) {
    return function (n, r) {
        ...
        if (!s) return !1;
        let l = r ? n.tr : null;
        return tm(l, s, t, e) ? (r && r(l.scrollIntoView()), !0) : !1;
    };
}
function tm(t, e, n, r = null) {
    ...
    let l = mn(i, n, r, e);
    return l ? (t && nm(t, e, l, o, n), !0) : !1;
}
function nm(t, e, n, r, o) {
    let i = v.empty;
    for (let d = n.length - 1; d >= 0; d--) i = v.from(n[d].type.create(n[d].attrs, i));
    t.step(new le(e.start - (r ? 2 : 0), e.end, e.start, e.end, new N(i, 0, 0), n.length, !0));
    let s = 0;
    ...
    for (let d = e.startIndex, u = e.endIndex, f = !0; d < u; d++, f = !1)
        (!f && Oe(t.doc, a, l) && (t.split(a, l), (a += 2 * l)), (a += c.child(d).nodeSize));
    return t;
}
function bc(t) {
    return function (e, n) {
        ...
        return i ? (n ? (r.node(i.depth - 1).type == t ? rm(e, n, t, i) : om(e, n, i)) : !0) : !1;
    };
}
function rm(t, e, n, r) {
    let o = t.tr,
    ...
    i < s &&
        (o.step(
            new le(i - 1, s, i, s, new N(v.from(n.create(null, r.parent.copy())), 1, 0), 1, !0),
        ),
    ...
    return (
        Pe(o.doc, a.pos) && a.nodeBefore.type == a.nodeAfter.type && o.join(a.pos),
        e(o.scrollIntoView()),
        !0
    );
}
    ...
    return function (e, n) {
        ...
        if (n) {
            let c = a.lastChild && a.lastChild.type == l.type,
                ...
                u = new N(v.from(t.create(null, v.from(l.type.create(null, d)))), c ? 3 : 1, 0),
                f = i.start,
                h = i.end;
...
var he = function (t) {
    ...
    Qt = function (t, e, n, r) {
        return n && (xc(t, e, n, r, -1) || xc(t, e, n, r, 1));
    },
    sm = /^(img|br|input|textarea|hr)$/i;
...
function lm(t, e) {
    for (;;) {
        ...
        } else if (t.parentNode && !rr(t)) ((e = he(t)), (t = t.parentNode));
        else return null;
    }
}
function am(t, e) {
    for (;;) {
        ...
        } else if (t.parentNode && !rr(t)) ((e = he(t) + 1), (t = t.parentNode));
        else return null;
    }
}
function cm(t, e, n) {
...
var Zr = function (t) {
    return t.focusNode && Qt(t.focusNode, t.focusOffset, t.anchorNode, t.anchorOffset);
};
function Kt(t, e) {
...
var Ye = typeof navigator < 'u' ? navigator : null,
    ...
    hs = /Edge\/(\d+)/.exec(Pt),
    Zc = /MSIE \d/.exec(Pt),
    ps = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Pt),
    Te = !!(Zc || ps || hs),
    Dt = Zc ? document.documentMode : ps ? +ps[1] : hs ? +hs[1] : 0,
    ze = !Te && /gecko\/(\d+)/i.test(Pt);
ze && +(/Firefox\/(\d+)/.exec(Pt) || [0, 0])[1];
var ms = !Te && /Chrome\/(\d+)/.exec(Pt),
    ue = !!ms,
    ed = ms ? +ms[1] : 0,
    we = !Te && !!Ye && /Apple Computer/.test(Ye.vendor),
    vn = we && (/Mobile\/\w+/.test(Pt) || (!!Ye && Ye.maxTouchPoints > 2)),
    Le = vn || (Ye ? /Mac/.test(Ye.platform) : !1),
    td = Ye ? /Win/.test(Ye.platform) : !1,
    mt = /Android \d/.test(Pt),
    or = !!kc && 'webkitFontSmoothing' in kc.documentElement.style,
    fm = or ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function hm(t) {
...
function mm(t) {
    ...
    return { refDOM: r, refTop: o, stack: nd(t.dom) };
}
function nd(t) {
    let e = [],
        n = t.ownerDocument;
...
function gm({ refDOM: t, refTop: e, stack: n }) {
...
function Sm(t, e) {
    ...
    if (!s || !t.dom.contains(s.nodeType != 1 ? s.parentNode : s)) {
        ...
        if (!Os(e, c) || ((s = id(t.dom, e, c)), !s)) return null;
    }
...
function Nt(t, e) {
    ...
    return Array.prototype.find.call(n, Cc) || t.getBoundingClientRect();
}
var Cm = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function sd(t, e, n) {
    let { node: r, offset: o, atom: i } = t.docView.domFromPos(e, n < 0 ? -1 : 1),
        s = or || ze;
    if (r.nodeType == 3)
        if (s && (Cm.test(r.nodeValue) || (n < 0 ? !o : o == r.nodeValue.length))) {
            let a = Nt(pt(r, o, o), n);
            if (ze && o && /\s/.test(r.nodeValue[o - 1]) && o < r.nodeValue.length) {
                let c = Nt(pt(r, o - 1, o - 1), -1);
                if (c.top == a.top) {
                    let d = Nt(pt(r, o, o + 1), -1);
                    if (d.top != a.top) return Xn(d, d.left < c.left);
                }
            }
            return a;
        } else {
...
function Am(t, e, n) {
    return vc == e && Mc == n
        ? Tc
        : ((vc = e), (Mc = n), (Tc = n == 'up' || n == 'down' ? vm(t, e, n) : Tm(t, e, n)));
}
var He = 0,
    Ac = 1,
    qt = 2,
    ...
    Zt = class {
        ...
        domFromPos(e, n) {
            ...
            for (
                let i;
                r && !(i = this.children[r - 1]).size && i instanceof Wr && i.side >= 0;
                r--
            );
            if (n <= 0) {
                let i,
                ...
                return i && s && !i.border && !i.domAtom
                    ...
                    : {
                          ...
                          offset: i ? he(i.dom) : this.contentDOM.childNodes.length,
                      };
            }
        }
        parseRange(e, n, r = 0) {
...
`
                        ...
                        for (let m = h, g; m; m = m.parentNode) {
                            if ((g = m.nextSibling)) {
                                g.nodeName == 'BR' &&
                                    (l = a = { node: g.parentNode, offset: he(g) + 1 });
                                break;
                            }
                            let y = m.pmViewDesc;
            ...
            if (ze && d.focusNode && d.focusNode != a.node && d.focusNode.nodeType == 1) {
    ...
    It = class t extends Zt {
        ...
        matchesNode(e, n, r) {
            return (
                this.dirty == He && e.eq(this.node) && Kr(n, this.outerDeco) && r.eq(this.innerDeco)
            );
        }
        get size() {
        ...
        updateChildren(e, n) {
            ...
            (Rm(
                ...
                a.destroyRest(),
                (a.changed || this.dirty == qt) &&
                    (s && this.protectLocalComposition(e, s),
                    ad(this.contentDOM, this.children, e),
                    vn && Dm(this.dom)));
        }
        localCompositionInfo(e, n) {
            ...
            if (this.node.inlineContent) {
                let s = i.nodeValue,
                    l = Im(this.node.content, s, r - n, o - n);
...
function Ec(t, e, n, r, o) {
    dd(r, e, t);
    let i = new It(void 0, t, e, n, r, r, r, o, 0);
    return (i.contentDOM && i.updateChildren(o, 0), i);
}
var jr = class t extends It {
...
function ad(t, e, n) {
    ...
    for (let i = 0; i < e.length; i++) {
        ...
        if (s instanceof Mn) {
            ...
            (ad(s.contentDOM, s.children, n), (r = a ? a.nextSibling : t.firstChild));
        }
    }
    for (; r; ) ((r = Nc(r)), (o = !0));
...
Yn.prototype = Object.create(null);
var Jt = [new Yn()];
function bs(t, e, n) {
    ...
    for (let i = 0; i < t.length; i++) {
        ...
        if (s) {
            s.nodeName && o.push((r = new Yn(s.nodeName)));
            for (let l in s) {
                let a = s[l];
                a != null &&
                    (n && o.length == 1 && o.push((r = new Yn(e.isInline ? 'span' : 'div'))),
                    l == 'class'
...
function dd(t, e, n) {
    return cd(t, t, Jt, bs(e, n, t.nodeType != 1));
}
function Kr(t, e) {
    if (t.length != e.length) return !1;
...
var ws = class {
    ...
    updateNodeAt(e, n, r, o, i) {
        ...
        return (
            s.dirty == Qe && s.dom == s.contentDOM && (s.dirty = qt),
            ...
            if (a instanceof It) {
                ...
                if (!f && (u = this.recreateWrapper(a, e, n, r, o, s)))
                    return (
                        ...
                        u.contentDOM &&
                            ((u.dirty = qt), u.updateChildren(o, s + 1), (u.dirty = He)),
                        (this.changed = !0),
                        this.index++,
                        !0
                    );
    ...
    recreateWrapper(e, n, r, o, i, s) {
        if (
            ...
            return null;
        let l = It.create(this.top, n, r, o, i, s);
        if (l.contentDOM) {
    ...
    addNode(e, n, r, o, i) {
        let s = It.create(this.top, e, n, r, o, i);
    ...
    addTextblockHacks() {
        ...
        (!e ||
            ...
            ((we || ue) && e && e.dom.contentEditable == 'false' && this.addHackNode('IMG', n),
...
function Rs(t, e = null) {
    ...
    if (Zr(n)) {
        ...
        if (
            ...
            L.isSelectable(u) &&
            o.parent &&
            !(u.isInline && cm(n.focusNode, n.focusOffset, o.dom))
        ) {
            let f = o.posBefore;
...
function ud(t) {
    return t.editable
        ? t.hasFocus()
        : hd(t) && document.activeElement && document.activeElement.contains(t.dom);
}
function gt(t, e = !1) {
    ...
    if ((fd(t, n), !!ud(t))) {
        ...
        if ((t.domObserver.disconnectSelection(), t.cursorWrapper)) Lm(t);
        else {
    ...
    e.addEventListener(
        ...
        (t.input.hideSelectionGuard = () => {
            (n.anchorNode != r || n.anchorOffset != o) &&
                (e.removeEventListener('selectionchange', t.input.hideSelectionGuard),
                setTimeout(() => {
                    (!ud(t) || t.state.selection.visible) &&
                        t.dom.classList.remove('ProseMirror-hideselection');
                }, 20));
        }),
    );
...
function fd(t, e) {
    if (e instanceof L) {
        ...
        n != t.lastSelectedViewDesc && (Ic(t), n && n.selectNode(), (t.lastSelectedViewDesc = n));
    } else Ic(t);
}
function Ic(t) {
...
function Pc(t) {
    return t.editable && !t.hasFocus() ? !1 : hd(t);
}
function hd(t) {
...
function Lc(t, e, n) {
    ...
    if (r instanceof D)
        if (n.indexOf('s') > -1) {
            ...
            return Ot(t, new D(r.$anchor, s));
        } else if (r.empty) {
            if (t.endOfTextblock(e > 0 ? 'forward' : 'backward')) {
                let o = ks(t.state, e);
                return o && o instanceof L ? Ot(t, o) : !1;
                ...
                return i.isAtom || ((s = t.docView.descAt(l)) && !s.contentDOM)
                    ? L.isSelectable(i)
                        ? Ot(t, new L(e < 0 ? t.state.doc.resolve(o.pos - i.nodeSize) : o))
                        : or
                          ? Ot(t, new D(t.state.doc.resolve(e < 0 ? l : l + i.nodeSize)))
                          : !1
                    : !1;
            }
        } else return !1;
    else {
        if (r instanceof L && r.node.isInline) return Ot(t, new D(e > 0 ? r.$to : r.$from));
        {
            let o = ks(t.state, e);
            return o ? Ot(t, o) : !1;
        }
...
function zm(t) {
    ...
    let o,
        i,
        s = !1;
    for (ze && n.nodeType == 1 && r < qr(n) && Qn(n.childNodes[r], -1) && (s = !0); ; )
        if (r > 0) {
            ...
            if (pd(n)) break;
            {
                ...
                for (; l && Qn(l, -1); ) ((o = n.parentNode), (i = he(l)), (l = l.previousSibling));
                if (l) ((n = l), (r = qr(n)));
                else {
...
function Hm(t) {
    ...
    for (;;)
        if (r < o) {
            ...
            {
                let l = n.nextSibling;
                for (; l && Qn(l, 1); ) ((i = l.parentNode), (s = he(l) + 1), (l = l.nextSibling));
                if (l) ((n = l), (r = 0), (o = qr(n)));
                else {
                    if (((n = n.parentNode), n == t.dom)) break;
                    r = o = 0;
...
function $m(t, e) {
    for (; t && e == t.childNodes.length && !rr(t); ) ((e = he(t) + 1), (t = t.parentNode));
...
function Fm(t, e) {
    for (; t && !e && !rr(t); ) ((e = he(t)), (t = t.parentNode));
    for (; t && e; ) {
...
function Ss(t, e, n) {
    if (e.nodeType != 3) {
        let i, s;
        (s = $m(e, n)) ? ((e = s), (n = 0)) : (i = Fm(e, n)) && ((e = i), (n = i.nodeValue.length));
    }
...
function Bc(t, e) {
    ...
    if (!(ue || td) && n.parent.inlineContent) {
...
function zc(t, e, n) {
    let r = t.state.selection;
    if ((r instanceof D && !r.empty) || n.indexOf('s') > -1 || (Le && n.indexOf('m') > -1))
        return !1;
    let { $from: o, $to: i } = r;
    if (!o.parent.inlineContent || t.endOfTextblock(e < 0 ? 'up' : 'down')) {
        let s = ks(t.state, e);
        if (s && s instanceof L) return Ot(t, s);
    }
    if (!o.parent.inlineContent) {
        let s = e < 0 ? o : i,
            l = r instanceof Se ? I.near(s, e) : I.findFrom(s, e);
        return l ? Ot(t, l) : !1;
    }
    return !1;
}
...
function _m(t) {
    ...
    if (e && e.nodeType == 1 && n == 0 && e.firstChild && e.firstChild.contentEditable == 'false') {
        let r = e.firstChild;
        ($c(t, r, 'true'), setTimeout(() => $c(t, r, 'false'), 20));
    }
    return !1;
}
function Vm(t) {
...
function Wm(t, e) {
    let n = e.keyCode,
        r = Vm(e);
    if (n == 8 || (Le && n == 72 && r == 'c')) return Hc(t, -1) || xn(t, -1);
    if ((n == 46 && !e.shiftKey) || (Le && n == 68 && r == 'c')) return Hc(t, 1) || xn(t, 1);
    if (n == 13 || n == 27) return !0;
    if (n == 37 || (Le && n == 66 && r == 'c')) {
        let o = n == 37 ? (Bc(t, t.state.selection.from) == 'ltr' ? -1 : 1) : -1;
        return Lc(t, o, r) || xn(t, o);
    } else if (n == 39 || (Le && n == 70 && r == 'c')) {
        let o = n == 39 ? (Bc(t, t.state.selection.from) == 'ltr' ? 1 : -1) : 1;
        return Lc(t, o, r) || xn(t, o);
    } else {
        if (n == 38 || (Le && n == 80 && r == 'c')) return zc(t, -1, r) || xn(t, -1);
        if (n == 40 || (Le && n == 78 && r == 'c')) return _m(t) || zc(t, 1, r) || xn(t, 1);
        if (r == (Le ? 'm' : 'c') && (n == 66 || n == 73 || n == 89 || n == 90)) return !0;
    }
    return !1;
}
function Is(t, e) {
    ...
    let c = a.firstChild,
        d,
        u = 0;
    for (; c && c.nodeType == 1 && (d = wd[c.nodeName.toLowerCase()]); ) {
...
`,
    ...
    if (
        ...
        l = Gm(Fc(l, +d[1], +d[2]), d[4]);
    else if (((l = N.maxOpen(Um(l.content, o), !0)), l.openStart || l.openEnd)) {
        let u = 0,
            f = 0;
        for (
        ...
        if (
            (t.forEach((l) => {
                ...
                let a = o.findWrapping(l.type),
                    c;
                if (!a) return (s = null);
                if ((c = s.length && i.length && yd(a, i, l, s[s.length - 1], 0)))
                    s[s.length - 1] = c;
                else {
                    s.length && (s[s.length - 1] = bd(s[s.length - 1], i.length));
                    let d = gd(l, a);
...
function yd(t, e, n, r, o) {
    if (o < t.length && o < e.length && t[o] == e[o]) {
        ...
        if (r.contentMatchAt(r.childCount).matchType(o == t.length - 1 ? n.type : t[o + 1]))
            return r.copy(r.content.append(v.from(gd(n, t, o + 1))));
    }
}
function bd(t, e) {
    if (e == 0) return t;
    let n = t.content.replaceChild(t.childCount - 1, bd(t.lastChild, e - 1)),
...
function Fc(t, e, n) {
    return (
        e < t.openStart &&
            (t = new N(Cs(t.content, -1, e, t.openStart, 0, t.openEnd), e, t.openEnd)),
        n < t.openEnd && (t = new N(Cs(t.content, 1, n, t.openEnd, 0, 0), t.openStart, n)),
        t
    );
}
var wd = {
    ...
    _c = null;
function xd() {
    return _c || (_c = document.implementation.createHTMLDocument('title'));
}
var cs = null;
function Km(t) {
...
function qm(t) {
    ...
    let n = xd().createElement('div'),
        r = /<([a-z][^>\s]+)/i.exec(t),
        o;
    if (
        ((o = r && wd[r[1].toLowerCase()]) &&
            (t =
                o.map((i) => '<' + i + '>').join('') +
                t +
                o
    ...
    for (let e in Ce) {
        ...
        t.dom.addEventListener(
            ...
            (t.input.eventHandlers[e] = (r) => {
                Zm(t, r) && !Ps(t, r) && (t.editable || !(r.type in ve)) && n(t, r);
            }),
...
function eg(t, e) {
    !Ps(t, e) && Ce[e.type] && (t.editable || !(e.type in ve)) && Ce[e.type](t, e);
}
ve.keydown = (t, e) => {
    let n = e;
    if (
        ...
        if (
            ...
            ((t.input.lastIOSEnter = r),
                (t.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
                    t.input.lastIOSEnter == r &&
                        (t.someProp('handleKeyDown', (o) => o(t, Kt(13, 'Enter'))),
                        (t.input.lastIOSEnter = 0));
                }, 200)));
        } else
            t.someProp('handleKeyDown', (r) => r(t, n)) || Wm(t, n)
                ? n.preventDefault()
                : Rt(t, 'key');
};
ve.keyup = (t, e) => {
...
ve.keypress = (t, e) => {
    let n = e;
    if (Sd(t, n) || !n.charCode || (n.ctrlKey && !n.altKey) || (Le && n.metaKey)) return;
...
var Ts = class {
    ...
    up(e) {
        ...
        let n = this.pos;
        (this.view.state.doc != this.startDoc && (n = this.view.posAtCoords(eo(e))),
            this.updateAllowDefault(e),
            this.allowDefault || !n
                ? Rt(this.view, 'pointer')
                : og(this.view, n.pos, n.inside, e, this.selectNode)
                  ? e.preventDefault()
                  : e.button == 0 &&
                      (this.flushed ||
...
Ce.touchstart = (t) => {
    ((t.input.lastTouch = Date.now()), Bs(t), Rt(t, 'pointer'));
};
Ce.touchmove = (t) => {
    ((t.input.lastTouch = Date.now()), Rt(t, 'pointer'));
};
Ce.contextmenu = (t) => Bs(t);
function Sd(t, e) {
    return t.composing
        ? !0
...
ve.compositionstart = ve.compositionupdate = (t) => {
    if (!t.composing) {
        ...
        if (
            ...
            ((t.markCursor = t.state.storedMarks || n.marks()), Jr(t, !0), (t.markCursor = null));
        else if (
            (Jr(t, !e.selection.empty),
            ze && e.selection.empty && n.parentOffset && !n.textOffset && n.nodeBefore.marks.length)
        ) {
            let r = t.domSelectionRange();
...
function Cd(t, e) {
    (clearTimeout(t.input.composingTimeout),
        e > -1 && (t.input.composingTimeout = setTimeout(() => Jr(t), e)));
}
function vd(t) {
    for (
        t.composing && ((t.input.composing = !1), (t.input.compositionEndedAt = ug()));
...
function dg(t) {
    ...
    let n = lm(e.focusNode, e.focusOffset),
        r = am(e.focusNode, e.focusOffset);
    if (n && r && n != r) {
        let o = r.pmViewDesc,
...
var Zn = (Te && Dt < 15) || (vn && fm < 604);
Ce.copy = ve.cut = (t, e) => {
    let n = e,
        r = t.state.selection,
        o = n.type == 'cut';
    if (r.empty) return;
    let i = Zn ? null : n.clipboardData,
        s = r.content(),
        { dom: l, text: a } = Is(t, s);
    (i
        ? (n.preventDefault(),
...
function pg(t, e) {
    ...
    setTimeout(() => {
        (t.focus(),
            ...
            n ? er(t, r.value, null, o, e) : er(t, r.textContent, r.innerHTML, o, e));
    }, 50);
}
function er(t, e, n, r, o) {
    let i = md(t, e, n, r, t.state.selection.$from);
...
ve.paste = (t, e) => {
    ...
    let r = Zn ? null : n.clipboardData,
        o = t.input.shiftKey && t.input.lastKeyCode != 45;
    r && er(t, Md(r), r.getData('text/html'), o, n) ? n.preventDefault() : pg(t, n);
};
var Gr = class {
        constructor(e, n, r) {
...
Ce.dragstart = (t, e) => {
    ...
    let o = t.state.selection,
        i = o.empty ? null : t.posAtCoords(eo(n)),
        s;
    ...
    ((!n.dataTransfer.files.length || !ue || ed > 120) && n.dataTransfer.clearData(),
        n.dataTransfer.setData(Zn ? 'Text' : 'text/html', a.innerHTML),
        (n.dataTransfer.effectAllowed = 'copyMove'),
        Zn || n.dataTransfer.setData('text/plain', c),
        (t.dragging = new Gr(d, Td(t, n), s)));
};
Ce.dragend = (t) => {
    let e = t.dragging;
    window.setTimeout(() => {
...
function gg(t, e, n) {
    ...
    i
        ...
        : (i = md(t, Md(e.dataTransfer), Zn ? null : e.dataTransfer.getData('text/html'), !1, o));
    let s = !!(n && Td(t, e));
    ...
    if (!i) return;
    e.preventDefault();
    let l = i ? Hr(t.state.doc, o.pos, i) : o.pos;
    l == null && (l = o.pos);
    let a = t.state.tr;
    if (s) {
        let { node: h } = n;
...
Ce.beforeinput = (t, e) => {
    if (ue && mt && e.inputType == 'deleteContentBackward') {
        ...
        setTimeout(() => {
            if (
                ...
                (t.dom.blur(),
                t.focus(),
                t.someProp('handleKeyDown', (i) => i(t, Kt(8, 'Backspace'))))
            )
                return;
...
var Xr = class t {
        constructor(e, n) {
            ((this.toDOM = e), (this.spec = n || Xt), (this.side = this.spec.side || 0));
        }
        map(e, n, r, o) {
            ...
            return (
                ...
                (e instanceof t &&
                    ((this.spec.key && this.spec.key == e.spec.key) ||
                        (this.toDOM == e.toDOM && tr(this.spec, e.spec))))
            );
        }
        destroy(e) {
    ...
    Gt = class t {
        ...
        eq(e) {
            return (
                this == e || (e instanceof t && tr(this.attrs, e.attrs) && tr(this.spec, e.spec))
            );
        }
        static is(e) {
    ...
    ne = class t {
        ...
        static widget(e, n, r) {
            return new t(e, e, new Xr(n, r));
        }
        static inline(e, n, r, o) {
            return new t(e, n, new Gt(r, o));
        }
        static node(e, n, r, o) {
    ...
    Q = class t {
        ...
        static create(e, n) {
            return n.length ? Qr(n, e, 0, Xt) : be;
        }
        find(e, n, r) {
            let o = [];
        ...
        map(e, n, r) {
            return this == be || e.maps.length == 0 ? this : this.mapInner(e, n, 0, 0, r || Xt);
        }
        mapInner(e, n, r, o, i) {
            let s;
            ...
            e.forEach((l, a) => {
                ...
                if ((d = Ed(n, l, c))) {
                    ...
                    (o[i] == a
                        ...
                        : o.splice(i, 0, a, a + l.nodeSize, Qr(d, l, c + 1, Xt)),
                        (i += 3));
                }
            });
            let s = Ad(i ? Nd(n) : n, -r);
            for (let l = 0; l < s.length; l++) s[l].type.valid(e, s[l]) || s.splice(l--, 1);
            return new t(s.length ? this.local.concat(s).sort(Yt) : this.local, o || this.children);
        }
        remove(e) {
        ...
        forChild(e, n) {
            ...
            if (o) {
                let l = new t(o.sort(Yt), kn);
                return r ? new Yr([l, r]) : l;
            }
            return r || be;
        }
        eq(e) {
        ...
        localsInner(e) {
            ...
            if (e.inlineContent || !this.local.some(Gt.is)) return this.local;
            let n = [];
...
var be = Q.empty,
    Yr = class t {
        ...
        map(e, n) {
            let r = this.members.map((o) => o.map(e, n, Xt));
            return t.from(r);
        }
        forChild(e, n) {
                ...
                default:
                    return new t(
                        e.every((n) => n instanceof Q)
                            ? e
                            : e.reduce((n, r) => n.concat(r instanceof Q ? r : r.members), []),
                    );
            }
        }
        forEachSet(e) {
...
function Qr(t, e, n, r) {
    ...
    let s = Ad(i ? Nd(t) : t, -n).sort(Yt);
    for (let l = 0; l < s.length; l++)
        s[l].type.valid(e, s[l]) || (r.onRemove && r.onRemove(s[l].spec), s.splice(l--, 1));
    return s.length || o.length ? new Q(s, o) : be;
}
function Yt(t, e) {
            ...
            for (let o = n + 1; o < e.length; o++) {
                ...
                if (i.from == r.from) {
                    i.to != r.to &&
                        ...
                        Vc(e, o + 1, i.copy(r.to, i.to)));
                    continue;
                } else {
                    i.from < r.to &&
                        (e == t && (e = t.slice()),
                        (e[n] = r.copy(r.from, i.from)),
                        Vc(e, o, r.copy(i.from, r.to)));
                    break;
                }
            }
    }
...
function ds(t) {
    ...
    return (
        ...
        t.cursorWrapper && e.push(Q.create(t.state.doc, [t.cursorWrapper.deco])),
        Yr.from(e)
    );
}
var wg = {
    ...
    Ns = class {
        ...
        start() {
            (this.observer &&
                (this.observer.takeRecords(), this.observer.observe(this.view.dom, wg)),
                this.onCharData &&
        ...
        flush() {
            ...
            if (ze && a.length) {
                ...
                if (d.length == 2) {
                    ...
                    for (let f of d) {
                        let h = f.parentNode;
                        h && h.nodeName == 'LI' && (!u || Cg(e, u) != h) && f.remove();
                    }
                }
            } else if (
                (ue || we) &&
            ...
            c.eq(I.near(e.state.doc.resolve(0), 1))
                ? ((e.input.lastFocus = 0),
                  ...
                  e.scrollToSelection())
                : (i > -1 || o) &&
                  (i > -1 && (e.docView.markDirty(i, s), kg(e)),
        ...
        registerMutation(e, n) {
            ...
            if (e.type == 'childList') {
                ...
                let s = o && o.parentNode == e.target ? he(o) + 1 : 0,
                    ...
                    a = i && i.parentNode == e.target ? he(i) : e.target.childNodes.length,
...
function kg(t) {
    if (
        ...
        if (((t.requiresGeckoHackNode = ze), jc)) return;
        (console.warn(
...
function vg(t, e, n) {
    ...
    if (
        (d &&
            ...
            Zr(a) || c.push({ node: a.focusNode, offset: a.focusOffset })),
    ...
    let u = t.state.doc,
        f = t.someProp('domParser') || Ie.fromSchema(t.state.schema),
        h = u.resolve(s),
        p = null,
        m = f.parse(r, {
            topNode: h.parent,
...
function Ag(t, e, n, r, o) {
    ...
    if (((t.input.compositionPendingChanges = 0), e < 0)) {
        ...
        if (E && !t.state.selection.eq(E)) {
            if (
                ...
                t.someProp('handleKeyDown', (A) => A(t, Kt(13, 'Enter')))
            )
                return;
            let M = t.state.tr.setSelection(E);
            (k == 'pointer' ? M.setMeta('pointer', !0) : k == 'key' && M.scrollIntoView(),
    ...
    let p = Og(u.content, c.doc.content, c.from, f, h);
    if (
        (p && t.input.domChangeCount++,
        ((vn && t.input.lastIOSEnter > Date.now() - 225) || mt) &&
            o.some((k) => k.nodeType == 1 && !Tg.test(k.nodeName)) &&
            (!p || p.endA >= p.endB) &&
            t.someProp('handleKeyDown', (k) => k(t, Kt(13, 'Enter'))))
    ) {
        t.input.lastIOSEnter = 0;
        return;
    }
    ...
    if (
        ...
        Ng(d, p.start, p.endA, m, g) &&
        t.someProp('handleKeyDown', (k) => k(t, Kt(8, 'Backspace')))
    ) {
        mt && ue && t.domObserver.suppressSelectionUpdates();
        return;
    }
        ...
        mt &&
            ...
            setTimeout(() => {
                t.someProp('handleKeyDown', function (k) {
                    return k(t, Kt(13, 'Enter'));
                });
            }, 20)));
    let b = p.start,
        C = p.endA,
        x = (k) => {
            let E = k || t.state.tr.replace(b, C, c.doc.slice(p.start - c.from, p.endB - c.from));
            if (c.sel) {
                let M = Kc(t, E.doc, c.sel);
                M &&
                    !(
                        (ue &&
                            t.composing &&
                            ...
                            (M.head == b || M.head == E.mapping.map(C) - 1)) ||
                        (Te && M.empty && M.head == b)
                    ) &&
                    E.setSelection(M);
            }
    ...
    if (w)
        if (m.pos == g.pos) {
            ...
            let k = m.parent.textBetween(m.parentOffset, g.parentOffset),
                E = () => x(t.state.tr.insertText(k, b, C));
            t.someProp('handleTextInput', (M) => M(t, b, C, k, E)) || t.dispatch(E());
        } else t.dispatch(x());
    else t.dispatch(x());
}
function Kc(t, e, n) {
...
function Og(t, e, n, r, o) {
    ...
    if (s < i && t.size < e.size) {
        let a = r <= i && r >= s ? i - r : 0;
        ((i -= a),
            i && i < e.size && qc(e.textBetween(i - 1, i + 1)) && (i += a ? 1 : -1),
            (l = i + (l - s)),
            (s = i));
    } else if (l < i) {
        let a = r <= i && r >= l ? i - r : 0;
        ((i -= a),
            i && i < t.size && qc(t.textBetween(i - 1, i + 1)) && (i += a ? 1 : -1),
            (s = i + (s - l)),
            (l = i));
    }
...
var nr = class {
    constructor(e, n) {
        ((this._root = null),
            ...
            (this.editable = Xc(this)),
            Gc(this),
            (this.nodeViews = Yc(this)),
            (this.docView = Ec(this.state.doc, Jc(this), ds(this), this.dom, this)),
            (this.domObserver = new Ns(this, (r, o, i, s) => Ag(this, r, o, i, s))),
    ...
    update(e) {
        ...
        let n = this._props;
        ((this._props = e),
            e.plugins && (e.plugins.forEach(Qc), (this.directPlugins = e.plugins)),
    ...
    updateStateInner(e, n) {
        ...
        let o = this.state,
            i = !1,
            s = !1;
        (e.storedMarks && this.composing && (vd(this), (s = !0)), (this.state = e));
        ...
        if (l || this._props.plugins != n.plugins || this._props.nodeViews != n.nodeViews) {
            let h = Yc(this);
            Dg(h, this.nodeViews) && ((this.nodeViews = h), (i = !0));
        }
        ...
        let f = d == 'preserve' && s && this.dom.style.overflowAnchor == null && mm(this);
        if (s) {
            ...
            let h =
                ...
                !o.selection.empty &&
                !e.selection.empty &&
                Rg(o.selection, e.selection);
            if (u) {
                let p = ue ? (this.trackWrites = this.domSelectionRange().focusNode) : null;
                (this.composing && (this.input.compositionNode = dg(this)),
            ...
            !(
                ...
                ? gt(this, h)
                : (fd(this, e.selection), this.domObserver.setCurSelection()),
                this.domObserver.start());
        }
        ...
        if (!(!e || !this.dom.contains(e.nodeType == 1 ? e : e.parentNode))) {
            if (!this.someProp('handleScrollToSelection', (n) => n(this)))
                if (this.state.selection instanceof L) {
                    ...
                    n.nodeType == 1 && Sc(this, n.getBoundingClientRect(), e);
                } else Sc(this, this.coordsAtPos(this.state.selection.head, 1), e);
        }
    }
    destroyPluginViews() {
        let e;
    ...
    updateDraggedNode(e, n) {
        ...
        this.dragging = new Gr(e.slice, e.move, o < 0 ? void 0 : L.create(this.state.doc, o));
    }
    someProp(e, n) {
    ...
    endOfTextblock(e, n) {
        return Am(this, n || this.state, e);
    }
    pasteHTML(e, n) {
        return er(this, '', e, !1, n || new ClipboardEvent('paste'));
    }
    pasteText(e, n) {
        return er(this, e, null, !0, n || new ClipboardEvent('paste'));
    }
    ...
    domSelectionRange() {
        ...
        return e
            ? (we &&
                  ...
                  dm(this.dom.ownerDocument) == this.dom &&
                  Sg(this, e)) ||
                  e
...
nr.prototype.dispatch = function (t) {
...
var yt = {
    ...
    Ig = typeof navigator < 'u' && /Mac/.test(navigator.platform),
    Pg =
        typeof navigator < 'u' &&
...
var ae;
for (ae = 65; ae <= 90; ae++)
    ((yt[ae] = String.fromCharCode(ae + 32)), (no[ae] = String.fromCharCode(ae)));
var ae;
for (to in yt) no.hasOwnProperty(to) || (no[to] = yt[to]);
var to;
function Od(t) {
    var e =
            (Ig && t.metaKey && t.shiftKey && !t.ctrlKey && !t.altKey) ||
            (Pg && t.shiftKey && t.key && t.key.length == 1) ||
            t.key == 'Unidentified',
        n = (!e && t.key) || (t.shiftKey ? no : yt)[t.keyCode] || t.key || 'Unidentified';
    return (
        n == 'Esc' && (n = 'Escape'),
        n == 'Del' && (n = 'Delete'),
        n == 'Left' && (n = 'ArrowLeft'),
...
var Lg = typeof navigator < 'u' && /Mac|iP(hone|[oa]d)/.test(navigator.platform),
    Bg = typeof navigator < 'u' && /Win/.test(navigator.platform);
function zg(t) {
    let e = t.split(/-(?!$)/),
        n = e[e.length - 1];
    n == 'Space' && (n = ' ');
    ...
    for (let l = 0; l < e.length - 1; l++) {
        ...
        else if (/^mod$/i.test(a)) Lg ? (s = !0) : (o = !0);
...
function Rd(t) {
    return new P({ props: { handleKeyDown: ir(t) } });
}
function ir(t) {
    let e = Hg(t);
    return function (n, r) {
        ...
        buildProps(t, e = !0) {
            let { rawCommands: n, editor: r, state: o } = this,
                ...
                s = {
                    ...
                    editor: r,
                    view: i,
                    state: uo({ state: o, transaction: t }),
                    dispatch: e ? () => {} : void 0,
...
function _d(t, e, n = {}) {
    return t.find(
        (r) =>
            r.type === e && ao(Object.fromEntries(Object.keys(n).map((o) => [o, r.attrs[o]])), n),
    );
}
function Dd(t, e, n = {}) {
    return !!_d(t, e, n);
...
function Ks(t, e, n) {
    ...
    let s = o.index,
        ...
        a = s + 1,
        c = l + o.node.nodeSize;
    for (; s > 0 && Dd([...t.parent.child(s - 1).marks], e, n); )
        ((s -= 1), (l -= t.parent.child(s).nodeSize));
    for (; a < t.parent.childCount && Dd([...t.parent.child(a).marks], e, n); )
...
var ty =
        ...
        ({ editor: n, view: r, tr: o, dispatch: i }) => {
            ...
            if (i && t === null && !ho(n.state.selection)) return (s(), !0);
            let l = Vd(o.doc, t) || n.state.selection,
    ...
    ny = (t, e) => (n) => t.every((r, o) => e(r, { ...n, index: o })),
    ry =
        (t, e) =>
        ({ tr: n, commands: r }) =>
...
function sr(t, e, n) {
    if (t instanceof se || t instanceof v) return t;
    ...
    if (o) {
        if (n.errorOnInvalidContent) {
            ...
            if (
                (n.slice
                    ? Ie.fromSchema(a).parseSlice(ro(t), n.parseOptions)
                    : Ie.fromSchema(a).parse(ro(t), n.parseOptions),
        ...
        let i = Ie.fromSchema(e);
        return n.slice
            ? i.parseSlice(ro(t), n.parseOptions).content
            : i.parse(ro(t), n.parseOptions);
    }
    return sr('', e, n);
}
function oy(t, e, n) {
...
var iy = (t) => !('type' in t),
        ...
        ({ tr: r, dispatch: o, editor: i }) => {
            ...
            if (o) {
                ...
                if (
                    ...
                    try {
                        sr(e, i.schema, { parseOptions: c, errorOnInvalidContent: !0 });
                    } catch (g) {
                        a(g);
                    }
                try {
                ...
                (n.updateSelection && oy(r, r.steps.length - 1, -1),
    ...
    uy =
        ...
        ({ state: t, dispatch: e, tr: n }) => {
            try {
                let r = jt(t.doc, t.selection.$from.pos, -1);
...
function my(t) {
    ...
    for (let l = 0; l < e.length - 1; l += 1) {
        ...
        else if (/^mod$/i.test(a)) qs() || jd() ? (s = !0) : (o = !0);
        else throw new Error(`Unrecognized modifier name: ${a}`);
    }
    return (
        r && (n = `Alt-${n}`),
...
function Ze(t, e, n = {}) {
    ...
    let a = o - r,
        c = l
            ...
            .filter((u) => ao(u.node.attrs, n, { strict: !1 }));
...
var ky =
        ...
        ({ tr: n, state: r, dispatch: o }) => {
            let i = null,
                s = null,
                l = po(typeof t == 'string' ? t : t.name, r.schema);
            if (!l) return !1;
            (l === 'node' && (i = re(t, r.schema)), l === 'mark' && (s = wt(t, r.schema)));
            let a = !1;
            return (
                n.selection.ranges.forEach((c) => {
                    r.doc.nodesBetween(c.$from.pos, c.$to.pos, (d, u) => {
                        (i &&
                            i === d.type &&
                            ((a = !0), o && n.setNodeMarkup(u, void 0, Id(d.attrs, e))),
                            s &&
                                d.marks.length &&
                                d.marks.forEach((f) => {
                                    s === f.type &&
                                        ((a = !0),
                                        o &&
                                            n.addMark(u, u + d.nodeSize, s.create(Id(f.attrs, e))));
                                }));
                    });
                }),
                a
    ...
    Ey =
        ...
        ({ state: t, dispatch: e }) =>
            ns(t, e);
function Vs(t, e, n = {}, r = {}) {
    return sr(t, e, { slice: !1, parseOptions: n, errorOnInvalidContent: r.errorOnInvalidContent });
}
var Ny =
...
function G(t, e = void 0, ...n) {
    return qd(t) ? (e ? t.bind(e)(...n) : t(...n)) : t;
}
function Oy(t = {}) {
...
function Ld(t) {
    return Object.fromEntries(
        Object.entries(t).filter(([e, n]) => (e === 'attrs' && Oy(n) ? !1 : n != null)),
    );
}
function Bd(t) {
    var e, n;
            ...
            o.map((c) => {
                let d = r.filter((y) => y.type === c.name),
                    ...
                    h = Ld({
                        ...
                        attrs: Object.fromEntries(d.map(Bd)),
                    }),
                    p = G(B(c, 'parseHTML', u));
                p && (h.parseDOM = p.map((y) => Pd(y, d)));
                let m = B(c, 'renderHTML', u);
                m && (h.toDOM = (y) => m({ node: y, HTMLAttributes: co(y, d) }));
        ...
        a = Object.fromEntries(
            i.map((c) => {
                let d = r.filter((g) => g.type === c.name),
                    ...
                    p = G(B(c, 'parseHTML', u));
                p && (h.parseDOM = p.map((g) => Pd(g, d)));
                let m = B(c, 'renderHTML', u);
                return (
                    m && (h.toDOM = (g) => m({ mark: g, HTMLAttributes: co(g, d) })),
                    [c.name, h]
                );
            }),
        );
...
function Zs(t, e) {
    let n = po(typeof e == 'string' ? e : e.name, t.schema);
    return n === 'node' ? Ly(t, e) : n === 'mark' ? Ud(t, e) : {};
}
...
function Ws(t, e, n = {}) {
    ...
    let a = l
            ...
            .filter((u) => ao(u.mark.attrs, n, { strict: !1 }))
...
function ar(t, { checkChildren: e = !0, ignoreWhitespace: n = !1 } = {}) {
    var r;
    if (n) {
    ...
    if (e) {
        ...
        return (
            t.content.forEach((i) => {
                o !== !1 && (ar(i, { ignoreWhitespace: n, checkChildren: e }) || (o = !1));
            }),
            o
        );
    }
...
function $y(t, e) {
    ...
    return { position: new tu(n.pos), mapResult: n };
}
function Fy(t) {
    return new tu(t);
}
...
var Gy =
        ...
        ({ tr: e, state: n, dispatch: r, editor: o }) => {
            ...
            if (
                ...
                (t && $d(n, o.extensionManager.splittableMarks), e.scrollIntoView());
            }
            return p;
        },
    Xy =
        ...
        ({ tr: n, state: r, dispatch: o, editor: i }) => {
            ...
            if (a.parent.content.size === 0 && a.node(-1).childCount === a.indexAfter(-1)) {
                ...
                if (o) {
                    ...
                    let b =
                            a.indexAfter(-1) < a.node(-2).childCount
                                ...
                                : a.indexAfter(-2) < a.node(-3).childCount
                                  ? 2
                                  : 3,
                        C = { ...lo(f, a.node().type.name, a.node().attrs), ...e },
                        x =
                    ...
                    n.replace(S, a.after(-b), new N(y, 4 - w, 0));
                    let k = -1;
            ...
            let h = c.pos === a.end() ? u.contentMatchAt(0).defaultType : null,
                p = { ...lo(f, u.type.name, u.attrs), ...e },
                m = { ...lo(f, a.node().type.name, a.node().attrs), ...e };
    ...
    Fs = (t, e) => {
        ...
        return (n.node.type === o?.type && Pe(t.doc, n.pos) && t.join(n.pos), !0);
    },
    _s = (t, e) => {
        let n = et((s) => s.type === e)(t.selection);
        if (!n) return !0;
        ...
        if (r === void 0) return !0;
        let o = t.doc.nodeAt(r);
        return (n.node.type === o?.type && Pe(t.doc, r) && t.join(r), !0);
    },
    Yy =
        (t, e, n, r = {}) =>
        ({ editor: o, tr: i, state: s, dispatch: l, chain: a, commands: c, can: d }) => {
            ...
            if (!b) return !1;
            let x = et((S) => Hd(S.type.name, u))(m);
            if (b.depth >= 1 && x && b.depth - x.depth <= 1) {
                if (x.node.type === h) return c.liftListItem(p);
                if (Hd(x.node.type.name, u) && h.validContent(x.node.content) && l)
                    return a()
...
function oo(t) {
    ...
    return (
        s.forEach((f) => {
            ...
            if (!h) return;
            let p = a.state.tr,
                m = uo({ state: a.state, transaction: p }),
                g = { from: r - (h[0].length - i.length), to: o },
                { commands: y, chain: w, can: b } = new fo({ editor: n, state: m });
    ...
    return (
        io(t) &&
            ...
            Object.keys(e).forEach((r) => {
                io(e[r]) && io(t[r]) ? (n[r] = ou(t[r], e[r])) : (n[r] = e[r]);
            }),
        n
    );
}
var nl = class {
        ...
        configure(t = {}) {
            let e = this.extend({ ...this.config, addOptions: () => ou(this.options, t) });
...
function mb(t) {
    let { editor: e, state: n, from: r, to: o, rule: i, pasteEvent: s, dropEvent: l } = t,
        { commands: a, chain: c, can: d } = new fo({ editor: e, state: n }),
        u = [];
    return (
                ...
                appendTransaction: (u, f, h) => {
                    ...
                    if (w) {
                        ...
                        let { from: S } = y,
                            k = S + x.length,
                            E = gb(x);
                        return a({ rule: d, state: h, from: S, to: { b: k }, pasteEvt: E });
                    }
...
var bo = class {
    constructor(t, e) {
        ((this.splittableMarks = []),
            ...
            (this.extensions = Gd(t)),
            (this.schema = Dy(this.extensions, e)),
    ...
    get plugins() {
        ...
        return Qs([...this.extensions].reverse()).flatMap((r) => {
            ...
            if (zd(r, t.options.enableInputRules) && c) {
                let f = c();
                if (f && f.length) {
                    let h = db({ editor: t, rules: f }),
                        p = Array.isArray(h) ? h : [h];
                    i.push(...p);
                }
            }
            let d = B(r, 'addPasteRules', o);
            if (zd(r, t.options.enablePasteRules) && d) {
                let f = d();
                if (f && f.length) {
                    let h = yb({ editor: t, rules: f });
                    i.push(...h);
                }
            }
...
js(bb, {
    ...
    Tabindex: () => gu,
    TextDirection: () => yu,
    focusEventsPluginKey: () => fu,
});
var K = class su extends nl {
        constructor() {
                ...
                new P({
                    ...
                    appendTransaction: (t, e, n) => {
                        ...
                        let { empty: i, from: s, to: l } = e.selection,
                            ...
                            c = I.atEnd(e.doc).to;
                        if (i || !(s === a && l === c) || !ar(n.doc)) return;
                        let f = n.tr,
                            h = uo({ state: n, transaction: f }),
                            { commands: p } = new fo({ editor: this.editor, state: h });
...
var bu = class extends ab {
    constructor(t = {}) {
        (super(),
            ...
            (this.utils = { getUpdatedPosition: $y, createMappablePosition: Fy }),
            this.setOptions(t),
        ...
        let e = this.createDoc(),
            n = Vd(e, this.options.autofocus);
        ((this.editorState = _r.create({ doc: e, schema: this.schema, selection: n || void 0 })),
    ...
    injectCSS() {
        this.options.injectCSS &&
            typeof document < 'u' &&
            (this.css = kb(xb, this.options.injectNonce));
    }
    setOptions(t = {}) {
    ...
    registerPlugin(t, e) {
        let n = qd(e) ? e(t, [...this.state.plugins]) : [...this.state.plugins, t],
        ...
        let r = [
            ...(this.options.enableCoreExtensions
                ? [
                      ...
                      mu,
                      cu,
                      yu.configure({ direction: this.options.textDirection }),
                  ].filter((o) =>
    ...
    createCommandManager() {
        this.commandManager = new fo({ editor: this });
    }
    createSchema() {
...
`,
        ...
        return Py(this.state.doc, {
            blockSeparator: e,
            textSerializers: { ...Yd(this.schema), ...n },
        });
    }
    get isEmpty() {
...
var Cb = {};
js(Cb, {
    createAtomBlockMarkdownSpec: () => vb,
    createBlockMarkdownSpec: () => en,
    createInlineMarkdownSpec: () => Ab,
    parseAttributes: () => rl,
    parseIndentedBlocks: () => xo,
                ...
                for (k.lastIndex = 0; ; ) {
                    ...
                    if (!((p = M[2]) != null && p.endsWith(':::'))) {
                        if (z) C += 1;
                            ...
                            let j = E.slice(0, A);
                            S = j.trim();
                            let _ = u.slice(0, x + A + M[0].length),
                                V = [];
                            if (S)
                                if (l === 'block')
                                    for (
                                        V = h.blockTokens(j),
                                            V.forEach((O) => {
                                                O.text &&
                                                    ...
                                                    (O.tokens = h.inlineTokens(O.text));
                                            });
                                        V.length > 0;
                                    ) {
                                        let O = V[V.length - 1];
                            ...
                            return { type: e, raw: _, attributes: b, content: S, tokens: V };
                        }
                    }
                }
            },
...
function Ab(t) {
    let {
            ...
            name: n,
            getContent: r,
            parseAttributes: o = Mb,
            serializeAttributes: i = Tb,
            defaultAttributes: s = {},
            selfClosing: l = !1,
            allowedAttributes: a,
        } = t,
    ...
    dragover(e) {
        ...
        if (n && !i) {
            ...
            if (this.editorView.dragging && this.editorView.dragging.slice) {
                let l = Hr(this.editorView.state.doc, s, this.editorView.dragging.slice);
                l != null && (s = l);
            }
...
var ce = class t extends I {
    ...
    static valid(e) {
        let n = e.parent;
        if (n.isTextblock || !Nb(e) || !Ob(e)) return !1;
...
function Nb(t) {
    for (let e = t.depth; e >= 0; e--) {
        ...
        for (let o = r.child(n - 1); ; o = o.lastChild) {
            if ((o.childCount == 0 && !o.inlineContent) || vu(o.type)) return !0;
...
var Rb = ir({
    ArrowLeft: ko('horiz', -1),
    ArrowRight: ko('horiz', 1),
    ArrowUp: ko('vert', -1),
    ArrowDown: ko('vert', 1),
});
function ko(t, e) {
...
pe.prototype.append = function (e) {
    return e.length
        ? ((e = pe.from(e)),
          (!this.length && e) ||
              (e.length < So && this.leafAppend(e)) ||
              (this.length < So && e.leafPrepend(this)) ||
              this.appendInner(e))
        : this;
};
...
pe.prototype.slice = function (e, n) {
    return (
        ...
        e >= n ? pe.empty : this.sliceInner(Math.max(0, e), Math.min(this.length, n))
    );
};
...
pe.from = function (e) {
    return e instanceof pe ? e : e && e.length ? new Tu(e) : pe.empty;
};
var Tu = (function (t) {
    function e(r) {
    ...
    return (
        ...
        (e.prototype.leafAppend = function (o) {
            if (this.length + o.length <= So) return new e(this.values.concat(o.flatten()));
        }),
        (e.prototype.leafPrepend = function (o) {
            if (this.length + o.length <= So) return new e(o.flatten().concat(this.values));
        }),
...
var Bb = 500,
    nn = class t {
        ...
        addTransform(e, n, r, o) {
            ...
            let c = s - r.depth;
            return (c > Hb && ((l = zb(l, c)), (s -= c)), new t(l.append(i), s));
        }
        remapping(e, n) {
            let r = new Un();
            return (
        ...
        rebased(e, n) {
            ...
            let d = this.items.slice(0, o).append(c).append(r),
                u = new t(d, l);
            return (u.emptyItemCount() > Bb && (u = u.compress(this.items.length - r.length)), u);
        }
        emptyItemCount() {
            let e = 0;
            return (
...
function $b(t, e, n, r) {
    ...
    if (s && s.getMeta(tn))
        return s.getMeta(tn).redo
            ? new rt(
                  t.done.addTransform(n, void 0, r, Co(e)),
                  t.undone,
                  Au(n.mapping.maps),
                  t.prevTime,
                  t.prevComposition,
            ...
            : new rt(
                  t.done,
                  t.undone.addTransform(n, void 0, r, Co(e)),
                  null,
                  t.prevTime,
                  t.prevComposition,
              );
    if (n.getMeta('addToHistory') !== !1 && !(s && s.getMeta('addToHistory') === !1)) {
        let l = n.getMeta('composition'),
            a =
                ...
                (!s &&
                    t.prevComposition != l &&
                    (t.prevTime < (n.time || 0) - r.newGroupDelay || !Fb(n, t.prevRanges))),
            c = s ? al(t.prevRanges, n.mapping) : Au(n.mapping.maps);
        return new rt(
            t.done.addTransform(n, a ? e.selection.getBookmark() : void 0, r, Co(e)),
            nn.empty,
            c,
            n.time,
            l ?? t.prevComposition,
...
function Nu(t = {}) {
    return (
        ...
        new P({
            ...
            state: {
                init() {
                    return new rt(nn.empty, nn.empty, null, 0, -1);
                },
                apply(e, n, r) {
                    return $b(n, r, e, t);
                },
...
`)
        ...
        addInputRules() {
            return [tt({ find: Wb, type: this.type })];
        },
    }),
    Pu = jb;
var Ub = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/,
    Kb = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g,
    qb = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/,
    Jb = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g,
    Gb = ee.create({
        name: 'bold',
        addOptions() {
            return { HTMLAttributes: {} };
        ...
        addInputRules() {
            return [$e({ find: Ub, type: this.type }), $e({ find: qb, type: this.type })];
        },
        addPasteRules() {
            return [Ae({ find: Kb, type: this.type }), Ae({ find: Jb, type: this.type })];
        },
    }),
    Lu = Gb;
var Xb = /(^|[^`])`([^`]+)`(?!`)$/,
    ...
    Qb = ee.create({
        ...
        addInputRules() {
            return [$e({ find: Xb, type: this.type })];
        },
        addPasteRules() {
            return [Ae({ find: Yb, type: this.type })];
        },
    }),
    Bu = Qb;
var hl = 4,
...
`);
        ...
        addInputRules() {
            return [
                cr({ find: Zb, type: this.type, getAttributes: (t) => ({ language: t[1] }) }),
                cr({ find: e0, type: this.type, getAttributes: (t) => ({ language: t[1] }) }),
            ];
        },
        addProseMirrorPlugins() {
            return [
...
var Mo = (t, e) => e.view.domAtPos(t).node.offsetParent !== null,
    n0 = (t, e, n) => {
    ...
    $u = (t, e) => {
        ...
        if (!u.length || Mo(d.start + u[0].pos + 1, t)) return !1;
    ...
    Fu = $.create({
        ...
        ...en({ nodeName: 'details', content: 'block' }),
        addNodeView() {
        ...
        addKeyboardShortcuts() {
            return {
                ...
                ArrowRight: ({ editor: t }) => $u(t, 'right'),
                ArrowDown: ({ editor: t }) => $u(t, 'down'),
            };
        },
        addProseMirrorPlugins() {
            return [
                new P({
                    ...
                    appendTransaction: (t, e, n) => {
                        ...
                        if (Mo(a.pos, r)) return;
                        let d = n0(a, (y) => y.type === o, r);
                        if (!d) return;
        ...
        addKeyboardShortcuts() {
            return {
                Enter: ({ editor: t }) => {
                    ...
                    let M = m,
                        A = m + p.nodeSize;
                    return (x.delete(M, A), x.scrollIntoView(), n.dispatch(x), !0);
                },
            };
        },
        ...en({ nodeName: 'detailsContent' }),
    }),
    Vu = $.create({
        name: 'detailsSummary',
        content: 'text*',
        ...
        ...en({ nodeName: 'detailsSummary', content: 'inline' }),
    });
var r0 = $.create({
        name: 'doc',
        topNode: !0,
...
var s0 = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))$/,
    ...
    a0 = ee.create({
        ...
        addInputRules() {
            return [$e({ find: s0, type: this.type })];
        },
        addPasteRules() {
            return [Ae({ find: l0, type: this.type })];
        },
    }),
    Ju = a0;
var c0 = $.create({
        ...
        addCommands() {
            return {
                setHorizontalRule:
                    () =>
                    ({ chain: t, state: e }) => {
                        if (!xu(e, e.schema.nodes[this.name])) return !1;
                        let { selection: n } = e,
                            { $to: r } = n,
                            o = t();
                        return (
        ...
        addInputRules() {
            return [wo({ find: /^(?:---|—-|___\s|\*\*\*\s)$/, type: this.type })];
        },
    }),
    Gu = c0;
var d0 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/,
    ...
    p0 = ee.create({
        ...
        addInputRules() {
            return [$e({ find: d0, type: this.type }), $e({ find: f0, type: this.type })];
        },
        addPasteRules() {
            return [Ae({ find: u0, type: this.type }), Ae({ find: h0, type: this.type })];
        },
    }),
    Xu = p0;
var m0 = /(?:^|\s)(!\[(.+|:?)]\((\S+)(?:(?:\s+)["'](\S+)["'])?\))$/,
...
Ee.prototype = {
    ...
    tr(t, e, n, r) {
        ...
        let o;
        return (
            e && e.j ? (o = e) : ((o = new Ee(e)), n && r && rn(e, n, r)),
            this.jr.push([t, o]),
            o
        );
    },
        ...
        if (
            ...
            if (r)
                if (s.t && typeof s.t == 'string') {
                    let a = Object.assign(S0(s.t, r), n);
                    rn(i, a, r);
                } else n && rn(i, n, r);
            s.t = i;
        }
...
var U = (t, e, n, r, o) => t.ta(e, n, r, o),
    ...
    Io = 'CLOSEPAREN',
    Po = 'OPENANGLEBRACKET',
    Lo = 'CLOSEANGLEBRACKET',
    Bo = 'FULLWIDTHLEFTPAREN',
    zo = 'FULLWIDTHRIGHTPAREN',
    Ho = 'LEFTCORNERBRACKET',
    $o = 'RIGHTCORNERBRACKET',
    Fo = 'LEFTWHITECORNERBRACKET',
    _o = 'RIGHTWHITECORNERBRACKET',
    ...
    ff = Object.freeze({
        ...
        FULLWIDTHMIDDLEDOT: df,
        FULLWIDTHRIGHTPAREN: zo,
        HYPHEN: _e,
        LEFTCORNERBRACKET: Ho,
        LEFTWHITECORNERBRACKET: Fo,
        LOCALHOST: wr,
        NL: Nl,
        NUM: El,
        OPENANGLEBRACKET: Po,
...
function M0(t = []) {
    ...
    (To == null && (To = nf(y0)),
        ...
        T(n, '\\', qo),
        T(n, '\u30FB', df));
    let r = oe(n, kt, El, { [xl]: !0 });
    oe(r, kt, r);
    let o = oe(r, xt, af, { [hr]: !0 }),
        i = oe(r, ur, cf, { [fr]: !0 }),
        s = oe(n, xt, St, { [kl]: !0 });
    (oe(s, kt, o), oe(s, xt, s), oe(o, kt, o), oe(o, xt, o));
    let l = oe(n, ur, vl, { [Sl]: !0 });
    (oe(l, xt), oe(l, kt, i), oe(l, ur, l), oe(i, kt, i), oe(i, xt), oe(i, ur, i));
    let a = T(n, yl, Nl, { [pl]: !0 }),
        c = T(n, tf, Al, { [pl]: !0 }),
        d = oe(n, gl, Al, { [pl]: !0 });
    (T(n, bl, d),
        T(c, yl, a),
        ...
        oe(d, gl, d),
        T(d, bl, d));
    let u = oe(n, ml, uf, { [lf]: !0 });
    (T(u, '#'), oe(u, ml, u), T(u, C0, u));
    let f = T(u, v0);
    (T(f, '#'), oe(f, ml, u));
    let h = [
            [xt, s],
    ...
    for (let m = 0; m < To.length; m++) Lt(n, To[m], Ml, St, h);
    for (let m = 0; m < Ao.length; m++) Lt(n, Ao[m], Tl, vl, p);
    (rn(Ml, { tld: !0, ascii: !0 }, e),
        rn(Tl, { utld: !0, alpha: !0 }, e),
        Lt(n, 'file', No, St, h),
        Lt(n, 'mailto', No, St, h),
        Lt(n, 'http', On, St, h),
        Lt(n, 'https', On, St, h),
        Lt(n, 'ftp', On, St, h),
        Lt(n, 'ftps', On, St, h),
        rn(No, { scheme: !0, ascii: !0 }, e),
        rn(On, { slashscheme: !0, ascii: !0 }, e),
    ...
    return (
        ef(n, 'localhost', wr, { ascii: !0 }),
        (n.jd = new Ee(ni)),
        { start: n, tokens: Object.assign({ groups: e }, ff) }
    );
}
function hf(t, e) {
    let n = T0(e.replace(/[A-Z]/g, (l) => l.toLowerCase())),
        r = n.length,
        o = [],
        i = 0,
        s = 0;
...
function Lt(t, e, n, r, o) {
    ...
    for (let l = 0; l < s - 1; l++) {
        let a = e[l];
        (t.j[a] ? (i = t.j[a]) : ((i = new Ee(r)), (i.jr = o.slice()), (t.j[a] = i)), (t = i));
    }
...
Pl.prototype = {
    ...
    get(t, e, n) {
        ...
        return (
            o &&
            (typeof o == 'object'
                ? ((o = n.t in o ? o[n.t] : xr[t]), typeof o == 'function' && r && (o = o(e, n)))
...
var of = ri('email', {
    ...
    Eo = ri('url', {
        ...
        hasProtocol() {
            let t = this.tk;
            return t.length >= 2 && t[0].t !== wr && t[1].t === zt;
        },
    });
var Fe = (t) => new Ee(t);
function E0({ groups: t }) {
    let e = t.domain.concat([
        ...
        r = [jo, Uo, Ko, qo, Jo, Go, Xo, Yo, _e, pr, mr, gr, Qo, Zo, ei, yr, it, ni, br, ti],
        o = Fe(),
        i = T(o, br);
    ...
    let s = Fe(),
        l = Fe(),
        a = Fe();
    (U(o, t.domain, s), U(o, t.scheme, l), U(o, t.slashscheme, a), U(s, r, i), U(s, t.domain, s));
    let c = T(s, Bt);
    ...
    U(f, t.domain, u);
    let h = Fe(of);
    (U(f, t.tld, h), U(f, t.utld, h), T(c, wr, h));
    let p = T(u, _e);
    (T(p, _e, p), U(p, t.domain, u), U(h, t.domain, u), T(h, ot, f), T(h, _e, p));
    let m = T(h, zt);
    U(m, t.numeric, of);
    let g = T(s, _e),
        y = T(s, ot);
    (T(g, _e, g), U(g, t.domain, s), U(y, r, i), U(y, t.domain, s));
    let w = Fe(Eo);
    (U(y, t.tld, w),
        U(y, t.utld, w),
        U(w, t.domain, s),
    ...
    let x = Fe(Eo),
        S = Fe();
    (U(x, e, x), U(x, n, S), U(S, e, x), U(S, n, S), T(w, it, x), T(C, it, x));
    let k = T(l, zt),
        E = T(a, zt),
        M = T(E, it),
        A = T(M, it);
    ...
    for (let j = 0; j < z.length; j++) {
        ...
        U(O, e, F);
        let W = Fe();
        (U(O, n), U(F, e, F), U(F, n, W), U(W, e, F), U(W, n, W), T(F, V, x), T(W, V, x));
    }
    return (T(o, wr, w), T(o, Nl, A0), { start: o, tokens: ff });
}
function N0(t, e, n) {
    let r = n.length,
        o = 0,
    ...
    for (; o < r; ) {
        ...
        if (f < 0) ((o -= d), o < r && (s.push(n[o]), o++));
            ...
            (s.length > 0 && (i.push(wl(sf, e, s)), (s = [])), (o -= f), (d -= f));
            let h = u.t,
                p = n.slice(o - d, o);
            i.push(wl(h, e, p));
        }
    }
    return (s.length > 0 && i.push(wl(sf, e, s)), i);
}
function wl(t, e, n) {
    let r = n[0].s,
        o = n[n.length - 1].e,
...
var O0 = (typeof console < 'u' && console && console.warn) || (() => {}),
    R0 =
...
function Ll(t, e = !1) {
    if (
        (Z.initialized &&
            O0(`linkifyjs: already initialized - will not register custom scheme "${t}" ${R0}`),
        ...
        appendTransaction: (e, n, r) => {
            ...
            if (
                (el(l).forEach(({ newRange: c }) => {
                    let d = Kd(r.doc, c, (h) => h.isTextblock),
                        u,
                        f;
                    if (d.length > 1)
                        ((u = d[0]),
                    ...
                    if (u && f) {
                        let h = f.split(I0).filter(Boolean);
                        if (h.length <= 0) return !1;
                        let p = h[h.length - 1],
                            m = u.pos + f.lastIndexOf(p);
                        if (!p) return !1;
                        let g = oi(p).map((y) => y.toObject(t.defaultProtocol));
                        if (!B0(g)) return !1;
                        g.filter((y) => y.isLink)
                            ...
                            .forEach((y) => {
                                mo(y.from, y.to, r.doc).some((w) => w.mark.type === t.type) ||
    ...
    return new P({
        ...
        props: {
            handlePaste: (e, n, r) => {
                ...
                let c = ii(a, { defaultProtocol: t.defaultProtocol }).find(
...
var F0 = ee.create({
        ...
        addOptions() {
            return {
                ...
                isAllowedUri: (t, e) => !!on(t, e.protocols),
                validate: (t) => !!t,
                shouldAutoLink: (t) => !!t,
            };
        },
                    ...
                    getAttrs: (t) => {
                        ...
                        return !e ||
                            !this.options.isAllowedUri(e, {
                                defaultValidate: (n) => !!on(n, this.options.protocols),
...
var _0 = Object.defineProperty,
    V0 = (t, e) => {
        for (var n in e) _0(t, n, { get: e[n], enumerable: !0 });
    },
    W0 = 'listItem',
    yf = 'textStyle',
    bf = /^\s*([-+*])\s$/,
...
`,
                    ...
                    ({ commands: t, chain: e }) =>
                        this.options.keepAttributes
                            ? e()
                                  ...
                                  .updateAttributes(W0, this.editor.getAttributes(yf))
                                  .run()
                            : t.toggleList(
                                  this.name,
                                  this.options.itemTypeName,
        ...
        addInputRules() {
            let t = tt({ find: bf, type: this.type });
            return (
                (this.options.keepMarks || this.options.keepAttributes) &&
                    (t = tt({
                        ...
                        getAttributes: () => this.editor.getAttributes(yf),
                        editor: this.editor,
                    })),
                [t]
            );
...
V0(j0, {
    ...
    hasListBefore: () => Sf,
    hasListItemAfter: () => U0,
    hasListItemBefore: () => Cf,
    listItemHasSubList: () => vf,
    nextListIsDeeper: () => Mf,
    nextListIsHigher: () => Tf,
});
var kr = (t, e) => {
    ...
    zl = (t, e, n) => {
        ...
        if (!Ze(t.state, e) && Sf(t.state, e, n)) {
        ...
        if (!Ze(t.state, e) || !eu(t.state)) return !1;
        let r = kr(e, t.state);
        if (!r) return !1;
        let i = t.state.doc.resolve(r.$pos.pos - 2).node(r.depth),
            s = vf(e, t.state, i);
        return Cf(e, t.state) && !s
    ...
    Hl = (t, e) => {
        if (!Ze(t.state, e) || !Zd(t.state, e)) return !1;
                    ...
                    ({ commands: t, chain: e }) =>
                        this.options.keepAttributes
                            ? e()
                                  ...
                                  .updateAttributes(X0, this.editor.getAttributes(xf))
                                  .run()
                            : t.toggleList(
                                  this.name,
                                  this.options.itemTypeName,
            ...
            return (
                (this.options.keepMarks || this.options.keepAttributes) &&
                    (t = tt({
                        ...
                        keepMarks: this.options.keepMarks,
                        keepAttributes: this.options.keepAttributes,
                        getAttributes: (e) => ({ start: +e[1], ...this.editor.getAttributes(xf) }),
                        joinPredicate: (e, n) => n.childCount + n.attrs.start === +e[1],
                        editor: this.editor,
                    })),
                [t]
    ...
    uv = K.create({
        ...
        addExtensions() {
            ...
            return (
                ...
                this.options.listKeymap !== !1 && t.push(K0.configure(this.options.listKeymap)),
                this.options.orderedList !== !1 && t.push(Vl.configure(this.options.orderedList)),
                this.options.taskItem !== !1 && t.push(Q0.configure(this.options.taskItem)),
                this.options.taskList !== !1 && t.push(Z0.configure(this.options.taskList)),
                t
            );
        },
    });
var Rn = (t, e, n = {}) => {
        ...
        return new P({
            ...
            props: {
                handleDrop(d, u) {
                    ...
                    (Rn(d, 'form-processing-started', { message: a }),
                        u.preventDefault(),
                        u.stopPropagation());
                            ...
                            r().upload(`componentFileAttachments.${l}.${y}`, m, () => {
                                c(y).then((w) => {
                                    w &&
                                        ...
                                        g === f.length - 1 && Rn(d, 'form-processing-finished'));
                                });
                            });
                        }),
                        !0
                                    ...
                                    for (let k of y) {
                                        ...
                                        try {
                                            let [O, F] = E.split(','),
                                                W = O.match(/:(.*?);/)[1],
                                                X = atob(F),
                                                te = new Uint8Array(X.length);
                                            for (let ke = 0; ke < X.length; ke++)
                                                te[ke] = X.charCodeAt(ke);
                                            M = new Blob([te], { type: W });
                                        } catch {
                                            continue;
                                        }
                                        let A = M.type.split('/')[1]?.split('+')[0] || 'png',
                                            z = new File([M], `image.${A}`, { type: M.type });
                                        if (
                                            Wl({
                                                files: [z],
                                                acceptedTypes: e,
                                            ...
                                            continue;
                                        let _ = jl(),
                                            V = await new Promise((O) => {
                                                r().upload(
                                                    `componentFileAttachments.${l}.${_}`,
                                                    z,
                                                    () => {
                                                        c(_).then((F) => O(F ?? null));
                                                    },
                                        ...
                                        V &&
                                            ...
                                            k.setAttribute('data-id', _));
                                    }
                                    for (let k of Array.from(g.querySelectorAll('img[src]'))) {
                                        let E = g.createElement('p');
                                        (k.replaceWith(E), E.appendChild(k));
                                    }
                                    let C = g.body.innerHTML;
                                    t.view.someProp('transformPastedHTML', (k) => {
                                        C = k(C);
                                    });
                                    let x = document.createElement('div');
                                    x.innerHTML = C;
                                    let S = Ie.fromSchema(t.state.schema).parseSlice(x, {
                                        preserveWhitespace: !1,
                                    });
                                    (t.view.dispatch(t.state.tr.replaceRange(w, b, S)),
                                        t.setEditable(!0),
                                        d.dom.dispatchEvent(
                                            new CustomEvent('rich-editor-uploaded-file', {
                                                bubbles: !0,
    ...
    Ef = K.create({
        ...
        addProseMirrorPlugins() {
            return [ew({ editor: this.editor, ...this.options })];
        },
    });
function tw(t) {
    var e;
            ...
            k
                ? () => {
                      let E = t.getState(e.state),
                          M = E?.decorationId,
                          A = S.dom.querySelector(`[data-decoration-id="${M}"]`);
        ...
        try {
            let A = t.getState(S.state),
                ...
                j = {
                    ...
                    items: [],
                    command: (_) =>
                        u({ editor: e, range: A?.range || { from: 0, to: 0 }, props: _ }),
                    decorationNode: z,
                    clientRect: b(S, z),
                };
    ...
    let x = new P({
        ...
        view() {
            return {
                update: async (S, k) => {
                    var E, M, A, z, j, _, V;
                    let O = (E = this.key) == null ? void 0 : E.getState(k),
                        F = (M = this.key) == null ? void 0 : M.getState(S.state),
                        W = O.active && F.active && O.range.from !== F.range.from,
                        X = !O.active && F.active,
                        te = O.active && !F.active,
                        ke = !X && !te && O.query !== F.query,
                        Tt = X || (W && ke),
                        q = ke || W,
                        Xe = te || (W && ke);
                    if (!Tt && !q && !Xe) return;
                    let Me = Xe && !Tt ? O : F,
                        da = S.dom.querySelector(`[data-decoration-id="${Me.decorationId}"]`);
                    ((g = {
                        editor: e,
                        range: Me.range,
                        query: Me.query,
                        text: Me.text,
                        items: [],
                        command: (sp) => u({ editor: e, range: Me.range, props: sp }),
                        decorationNode: da,
                        clientRect: b(S, da),
                    }),
                        Tt && ((A = y?.onBeforeStart) == null || A.call(y, g)),
                        q && ((z = y?.onBeforeUpdate) == null || z.call(y, g)),
                        (q || Tt) && (g.items = await f({ editor: e, query: Me.query })),
                        Xe && ((j = y?.onExit) == null || j.call(y, g)),
                        q && ((_ = y?.onUpdate) == null || _.call(y, g)),
                        Tt && ((V = y?.onStart) == null || V.call(y, g)));
                },
                destroy: () => {
                    var S;
        ...
        state: {
            ...
            apply(S, k, E, M) {
                ...
                if (((O.composing = z), A && (_ || e.view.composing))) {
                    (V < k.range.from || V > k.range.to) && !z && !k.composing && (O.active = !1);
                    let W = m({
                            char: n,
                            allowSpaces: r,
                            allowToIncludeChar: o,
                    ...
                    W && p({ editor: e, state: M, range: W.range, isActive: k.active })
                        ? ((O.active = !0),
                          (O.decorationId = k.decorationId ? k.decorationId : X),
                          (O.range = W.range),
                          (O.query = W.query),
                          (O.text = W.text))
                        : (O.active = !1);
        ...
        props: {
            handleKeyDown(S, k) {
                var E, M, A, z;
                let { active: j, range: _ } = x.getState(S.state);
                if (!j) return !1;
                if (k.key === 'Escape' || k.key === 'Esc') {
                    let O = x.getState(S.state),
                        F = (E = g?.decorationNode) != null ? E : null,
                        W =
                            F ??
                            (O?.decorationId
                                ? S.dom.querySelector(`[data-decoration-id="${O.decorationId}"]`)
                                : null);
                    if (
                        ((M = y?.onKeyDown) == null
                            ? void 0
                            : M.call(y, { view: S, event: k, range: O.range })) ||
                        !1
                    )
                        return !0;
                    let te = {
                        ...
                        text: O.text,
                        items: [],
                        command: (ke) => u({ editor: e, range: O.range, props: ke }),
                        decorationNode: W,
                        clientRect: W ? () => W.getBoundingClientRect() || null : null,
                    };
                    return ((A = y?.onExit) == null || A.call(y, te), C(S, t), !0);
                }
                return (
                    ((z = y?.onKeyDown) == null
                        ? void 0
                        : z.call(y, { view: S, event: k, range: _ })) || !1
                );
            },
            decorations(S) {
                let { active: k, range: E, decorationId: M, query: A } = x.getState(S);
                if (!k) return null;
                let z = !A?.length,
                    j = [a];
                return (
...
var si = rw;
var ow = function ({ editor: t, overrideSuggestionOptions: e, extensionName: n }) {
        let r = new H();
        return {
            editor: t,
            char: '{{',
    ...
    Nf = $.create({
        ...
        onBeforeCreate() {
            ((this.storage.suggestions = (
                ...
                ow({ editor: this.editor, overrideSuggestionOptions: t, extensionName: this.name }),
            )),
...
var Ul = ['top', 'right', 'bottom', 'left'],
    Of = ['start', 'end'],
    Kl = Ul.reduce((t, e) => t.concat(e, e + '-' + Of[0], e + '-' + Of[1]), []),
    Ve = Math.min,
    me = Math.max,
    vr = Math.round;
var Ke = (t) => ({ x: t, y: t }),
...
var lw = new Set(['top', 'bottom']);
function qe(t) {
    return lw.has(Re(t)) ? 'y' : 'x';
}
function ci(t) {
    return ql(qe(t));
}
        ...
        s =
            o === 'x'
                ...
                : r === 'start'
                  ? 'bottom'
                  : 'top';
    return (e.reference[i] > e.floating[i] && (s = Cr(s)), [s, Cr(s)]);
}
function If(t) {
    let e = Cr(t);
    return [Sr(t), e, Sr(e)];
...
function Sr(t) {
    return t.replace(/start|end/g, (e) => sw[e]);
}
var Rf = ['left', 'right'],
    Df = ['right', 'left'],
    aw = ['top', 'bottom'],
...
function Pf(t, e, n, r) {
    let o = We(t),
        i = dw(Re(t), n === 'start', r);
    return (o && ((i = i.map((s) => s + '-' + o)), e && (i = i.concat(i.map(Sr)))), i);
}
function Cr(t) {
    return t.replace(/left|right|bottom|top/g, (e) => iw[e]);
}
function uw(t) {
    return { top: 0, right: 0, bottom: 0, left: 0, ...t };
}
function di(t) {
    return typeof t != 'number' ? uw(t) : { top: t, right: t, bottom: t, left: t };
}
function Ct(t) {
    ...
    async fn(e) {
        ...
        let E = C / 2 - x / 2,
            ...
            F =
                ...
                We(o) != null &&
                V !== O &&
                i.reference[p] / 2 - (V < j ? A : z) - m[p] / 2 < 0,
            W = F ? (V < j ? V - j : V - _) : 0;
        return {
            [h]: f[h] + W,
            data: { [h]: O, centerOffset: V - O - W, ...(F && { alignmentOffset: W }) },
            reset: F,
        };
    },
});
function fw(t, e, n) {
    return (
        t
            ...
            : n.filter((o) => Re(o) === o)
    ).filter((o) => (t ? We(o) === t || (e ? Sr(o) !== o : !1) : !0));
}
var Ff = function (t) {
        return (
            t === void 0 && (t = {}),
            {
                ...
                async fn(e) {
                    ...
                    let { rects: i, middlewareData: s, placement: l, platform: a, elements: c } = e,
                        ...
                        m = u !== void 0 || f === Kl ? fw(u || null, h, f) : f,
                        g = await sn(e, p),
                        y = ((n = s.autoPlacement) == null ? void 0 : n.index) || 0,
                        w = m[y];
                    if (w == null) return {};
                    let b = Jl(w, i, await (a.isRTL == null ? void 0 : a.isRTL(c.floating)));
                    if (l !== w) return { reset: { placement: m[0] } };
                    let C = [g[Re(w)], g[b[0]], g[b[1]]],
                        x = [
                    ...
                    let k = x
                            .map((A) => {
                                ...
                                return [
                                    A.placement,
                                    z && d
                                        ? A.overflows.slice(0, 2).reduce((j, _) => j + _, 0)
                                        : A.overflows[0],
                                    A.overflows,
                                ];
                            })
                        ...
                        M =
                            ((o = k.filter((A) =>
                                A[2].slice(0, We(A[0]) ? 2 : 3).every((z) => z <= 0),
                            )[0]) == null
                                ? void 0
                                : o[0]) || k[0][0];
                    return M !== l
                        ? { data: { index: y + 1, overflows: x }, reset: { placement: M } }
                        : {};
                },
            }
        );
        ...
        return (
            t === void 0 && (t = {}),
            {
                ...
                async fn(e) {
                    ...
                    if (((A = [...A, { placement: o, overflows: M }]), !M.every((V) => V <= 0))) {
                        var z, j;
                        let V = (((z = i.flip) == null ? void 0 : z.index) || 0) + 1,
                            O = k[V];
                        if (
                            O &&
                            (!(u === 'alignment' ? w !== qe(O) : !1) ||
                                A.every((X) => (qe(X.placement) === w ? X.overflows[0] > 0 : !0)))
                        )
                            return { data: { index: V, overflows: A }, reset: { placement: O } };
                        let F =
                                    ...
                                    let W =
                                        (_ = A.filter((X) => {
                                            ...
                                            .map((X) => [
                                                ...
                                                X.overflows
                                                    .filter((te) => te > 0)
                                                    .reduce((te, ke) => te + ke, 0),
                                            ])
                                            .sort((X, te) => X[1] - te[1])[0]) == null
                                            ? void 0
                                            : _[0];
                                    W && (F = W);
                                    break;
            ...
            async fn(e) {
                ...
                switch (r) {
                    case 'referenceHidden': {
                        let i = await sn(e, { ...o, elementContext: 'reference' }),
                            s = Bf(i, n.reference);
                        return { data: { referenceHiddenOffsets: s, referenceHidden: zf(s) } };
                    }
                    case 'escaped': {
                        let i = await sn(e, { ...o, altBoundary: !0 }),
                            s = Bf(i, n.floating);
                        return { data: { escapedOffsets: s, escaped: zf(s) } };
                    }
                    default:
                        return {};
                }
            ...
            async fn(e) {
                ...
                if (
                    ...
                    let A = me(d.left, 0),
                        ...
                        _ = me(d.bottom, 0);
                    h
                        ? (E = p - 2 * (A !== 0 || z !== 0 ? A + z : me(d.left, d.right)))
                        : (k = m - 2 * (j !== 0 || _ !== 0 ? j + _ : me(d.top, d.bottom)));
                }
                await a({ ...e, availableWidth: E, availableHeight: k });
                let M = await s.getDimensions(l.floating);
                return p !== M.width || m !== M.height ? { reset: { rects: !0 } } : {};
            },
        }
    );
};
...
function lt(t) {
    var e;
    return (e = (Gf(t) ? t.ownerDocument : t.document) || window.document) == null
        ? void 0
        : e.documentElement;
}
function Gf(t) {
    return fi() ? t instanceof Node || t instanceof Ne(t).Node : !1;
}
function je(t) {
    return fi() ? t instanceof Element || t instanceof Ne(t).Element : !1;
}
function Je(t) {
    return fi() ? t instanceof HTMLElement || t instanceof Ne(t).HTMLElement : !1;
}
function Jf(t) {
...
var gw = new Set(['inline', 'contents']);
function Dn(t) {
    let { overflow: e, overflowX: n, overflowY: r, display: o } = Ue(t);
    return /auto|scroll|overlay|hidden|clip/.test(e + r + n) && !gw.has(o);
}
var yw = new Set(['table', 'td', 'th']);
function Xf(t) {
    return yw.has(ln(t));
}
var bw = [':popover-open', ':modal'];
function Mr(t) {
    return bw.some((e) => {
        try {
            return t.matches(e);
...
var ww = ['transform', 'translate', 'scale', 'rotate', 'perspective'],
...
var Sw = new Set(['html', 'body', '#document']);
function an(t) {
    return Sw.has(ln(t));
}
function Ue(t) {
...
function vt(t) {
    if (ln(t) === 'html') return t;
    let e = t.assignedSlot || t.parentNode || (Jf(t) && t.host) || lt(t);
    return Jf(e) ? e.host : e;
}
function Qf(t) {
    let e = vt(t);
    return an(e) ? (t.ownerDocument ? t.ownerDocument.body : t.body) : Je(e) && Dn(e) ? e : Qf(e);
}
function ui(t, e, n) {
    var r;
    ...
    if (i) {
        let l = mi(s);
        return e.concat(s, s.visualViewport || [], Dn(o) ? o : [], l && n ? ui(l) : []);
    }
...
function In(t) {
    ...
    let n = e.getBoundingClientRect(),
        { width: r, height: o, $: i } = nh(e),
        s = (i ? vr(n.width) : n.width) / r,
        l = (i ? vr(n.height) : n.height) / o;
    return (
...
function Ar(t, e, n, r) {
    ...
    let o = t.getBoundingClientRect(),
        i = rh(t),
        s = Ke(1);
    e && (r ? je(r) && (s = In(r)) : (s = In(t)));
    let l = vw(i, n, r) ? oh(i) : Ke(0),
        a = (o.left + l.x) / s.x,
        c = (o.top + l.y) / s.y,
        d = o.width / s.x,
        u = o.height / s.y;
...
function gi(t, e) {
    let n = Tr(t).scrollLeft;
    return e ? e.left + n : Ar(lt(t)).left + n;
}
function ih(t, e) {
...
function Mw(t) {
    ...
    let a = { scrollLeft: 0, scrollTop: 0 },
        ...
        d = Ke(0),
        u = Je(r);
    if ((u || (!u && !i)) && ((ln(r) !== 'body' || Dn(s)) && (a = Tr(r)), Je(r))) {
        let h = Ar(r);
        ((c = In(r)), (d.x = h.x + r.clientLeft), (d.y = h.y + r.clientTop));
    }
    let f = s && !u && !i ? ih(s, a) : Ke(0);
    return {
        width: n.width * c.x,
        height: n.height * c.y,
...
function Aw(t) {
    let e = lt(t),
        ...
        l = -n.scrollTop;
    return (
        Ue(r).direction === 'rtl' && (s += me(e.clientWidth, r.clientWidth) - o),
...
var Nw = new Set(['absolute', 'fixed']);
function Ow(t, e) {
    let n = Ar(t, !0, e === 'fixed'),
        r = n.top + t.clientTop,
...
function eh(t, e, n) {
    let r;
    if (e === 'viewport') r = Ew(t, n);
    else if (e === 'document') r = Aw(lt(t));
    else if (je(e)) r = Ow(e, n);
    else {
        let o = oh(t);
...
function sh(t, e) {
    let n = vt(t);
    return n === e || !je(n) || an(n) ? !1 : Ue(n).position === 'fixed' || sh(n, e);
}
function Rw(t, e) {
    let n = e.get(t);
    if (n) return n;
    let r = ui(t, [], !1).filter((l) => je(l) && ln(l) !== 'body'),
        o = null,
    ...
    for (; je(s) && !an(s); ) {
        ...
        (!a && l.position === 'fixed' && (o = null),
            (
                i
                    ? !a && !o
                    : (!a && l.position === 'static' && !!o && Nw.has(o.position)) ||
                      (Dn(s) && !a && sh(t, s))
            )
                ? (r = r.filter((d) => d !== s))
                : (o = l),
...
function Dw(t) {
    let { element: e, boundary: n, rootBoundary: r, strategy: o } = t,
        s = [...(n === 'clippingAncestors' ? (Mr(e) ? [] : Rw(e, this._c)) : [].concat(n)), r],
        l = s[0],
        a = s.reduce(
            (c, d) => {
                let u = eh(e, d, o);
                return (
                    ...
                    (c.right = Ve(u.right, c.right)),
                    (c.bottom = Ve(u.bottom, c.bottom)),
...
function Pw(t, e, n) {
    ...
    if (r || (!r && !i))
        if (((ln(e) !== 'body' || Dn(o)) && (l = Tr(e)), r)) {
            let h = Ar(e, !0, i, e);
            ((a.x = h.x + e.clientLeft), (a.y = h.y + e.clientTop));
        } else o && c();
    i && !r && o && c();
    let d = o && !r && !i ? ih(o, l) : Ke(0),
...
function th(t, e) {
    if (!Je(t) || Ue(t).position === 'fixed') return null;
    if (e) return e(t);
...
function lh(t, e) {
    ...
    if (!Je(t)) {
        let o = vt(t);
        for (; o && !an(o); ) {
            if (je(o) && !Gl(o)) return o;
            o = vt(o);
        }
        return n;
    }
    let r = th(t, e);
    for (; r && Xf(r) && Gl(r); ) r = th(r, e);
    return r && an(r) && Gl(r) && !hi(r) ? n : r || Yf(t) || n;
}
var Lw = async function (t) {
    let e = this.getOffsetParent || lh,
        n = this.getDimensions,
        r = await n(t.floating);
    return {
        reference: Pw(t.reference, await e(t.floating), t.strategy),
...
var ph = (t, e) => {
        Bn(
            ...
            e,
            { placement: 'bottom-start', strategy: 'absolute', middleware: [Pn(), Ln()] },
                ...
                return {
                    onStart: (b) => {
                        ((c = b),
                            ...
                            b.clientRect && ph(b.editor, l));
                    },
                    onUpdate: (b) => {
                        ((c = b), (a = 0), f(), m(), b.clientRect && ph(b.editor, l));
                    },
                    onKeyDown: (b) =>
                        b.event.key === 'Escape'
...
var Hw = function ({ editor: t, overrideSuggestionOptions: e, extensionName: n }) {
        let r = new H(),
            o = e?.char ?? '@',
            i = e?.extraAttributes ?? {};
        return {
...
var Fw = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/,
    ...
    Vw = ee.create({
        ...
        addInputRules() {
            return [$e({ find: Fw, type: this.type })];
        },
        addPasteRules() {
            return [Ae({ find: _w, type: this.type })];
        },
    }),
    xh = Vw;
var Ww = ee.create({
...
if (typeof WeakMap < 'u') {
    let t = new WeakMap();
    ((Ql = (e) => t.get(e)), (Zl = (e, n) => (t.set(e, n), n)));
} else {
    let t = [],
        n = 0;
    ((Ql = (r) => {
...
function qw(t, e, n) {
    ...
    for (let o = 0; o < t.map.length; o++) {
        ...
        for (let c = 0; c < a.colspan; c++) {
            ...
            d != null && (!a.colwidth || a.colwidth[c] != d) && ((l || (l = Jw(a)))[c] = d);
        }
...
var Y = class Mt extends I {
    ...
    getBookmark() {
        return new Zw(this.$anchorCell.pos, this.$headCell.pos);
    }
};
...
function rx(t, e, n) {
    ...
    if (r instanceof L && (s = r.node.type.spec.tableRole)) {
        ...
        r instanceof D && tx(r)
            ? (i = D.create(o, r.from))
            : r instanceof D && nx(r) && (i = D.create(o, r.$from.start(), r.$from.end()));
    return (i && (e || (e = t.tr)).setSelection(i), e);
}
var ox = new H('fix-tables');
function Lh(t, e, n, r) {
    let o = t.childCount,
        i = e.childCount;
...
function oa(t, e) {
    let n,
        r = (o, i) => {
            o.type.spec.tableRole == 'table' && (n = ix(t, o, i, n));
        };
    return (e ? e.doc != t.doc && Lh(e.doc, t.doc, 0, r) : t.doc.descendants(r), n);
}
function ix(t, e, n, r) {
    let o = ie.get(e);
    ...
    for (let a = 0; a < o.problems.length; a++) {
        ...
        if (c.type == 'collision') {
            ...
            r.setNodeMarkup(r.mapping.map(n + 1 + c.pos), null, dn(u, u.colspan - c.n, c.n));
...
function Bh(t, { map: e, tableStart: n, table: r }, o) {
    let i = o > 0 ? -1 : 0;
    Qw(e, r, o + i) && (i = o == 0 || o == e.width ? null : 0);
    for (let s = 0; s < e.height; s++) {
        let l = s * e.width + o;
        if (o > 0 && o < e.width && e.map[l - 1] == e.map[l]) {
            let a = e.map[l],
                c = r.nodeAt(a);
            (t.setNodeMarkup(t.mapping.map(n + a), null, Ih(c.attrs, o - e.colCount(a))),
                (s += c.attrs.rowspan - 1));
        } else {
...
function sx(t, { map: e, table: n, tableStart: r }, o) {
    ...
    for (let s = 0; s < e.height; ) {
        ...
        if ((o > 0 && e.map[l - 1] == a) || (o < e.width - 1 && e.map[l + 1] == a))
            t.setNodeMarkup(t.mapping.slice(i).map(r + a), null, dn(d, o - e.colCount(a)));
        else {
...
function $h(t, e) {
    ...
    if (e) {
        ...
        for (let o = n.right - 1; sx(r, n, o), o != n.left; o--) {
...
function Fh(t, { map: e, tableStart: n, table: r }, o) {
    let i = n;
    for (let c = 0; c < o; c++) i += r.child(c).nodeSize;
    let s = [],
        l = o > 0 ? -1 : 0;
    lx(e, r, o + l) && (l = o == 0 || o == e.height ? null : 0);
...
function Vh(t, e) {
    ...
    if (e) {
        let n = at(t);
        e(Fh(t.tr, n, n.bottom));
    }
    return !0;
}
function ax(t, { map: e, table: n, tableStart: r }, o) {
    let i = 0;
...
function Wh(t, e) {
    ...
    if (e) {
        ...
        for (let o = n.bottom - 1; ax(r, n, o), o != n.top; o--) {
            let i = n.tableStart ? r.doc.nodeAt(n.tableStart - 1) : r.doc;
            if (!i) throw new RangeError('No table found');
    ...
    if (e) {
        ...
        if (
            (i.setNodeMarkup(a + r.tableStart, null, {
                ...Ih(c.attrs, c.attrs.colspan, r.right - r.left - c.attrs.colspan),
...
function dx(t) {
    return (e, n) => {
        ...
        if (r instanceof Y) {
            ...
            var s;
            if (((o = Gw(r.$from)), !o)) return !1;
            i = (s = cn(r.$from)) === null || s === void 0 ? void 0 : s.pos;
        }
        ...
        if (n) {
            ...
            (u.setNodeMarkup(i, t({ node: o, row: d.top, col: d.left }), a[0]),
                r instanceof Y &&
                    u.setSelection(
                        new Y(u.doc.resolve(r.$anchorCell.pos), f ? u.doc.resolve(f) : void 0),
                    ),
                n(u));
        }
        return !0;
...
var uM = zn('row', { useDeprecatedLogic: !0 }),
    fM = zn('column', { useDeprecatedLogic: !0 }),
    Uh = zn('cell', { useDeprecatedLogic: !0 });
function fx(t, e) {
    if (e < 0) {
        let n = t.nodeBefore;
...
function la(t) {
    return function (e, n) {
        ...
        if (n) {
            ...
            n(e.tr.setSelection(D.between(o, Yw(o))).scrollIntoView());
        }
        return !0;
    };
}
...
function yi(t, e) {
    ...
    if (e) {
        ...
        (n.forEachCell((i, s) => {
            i.content.eq(o) ||
                r.replace(r.mapping.map(s + 1), r.mapping.map(s + i.nodeSize - 1), new N(o, 0, 0));
        }),
            r.docChanged && e(r));
    }
    return !0;
...
function hx(t) {
    ...
    if (i == 'row')
        for (let a = 0; a < e.childCount; a++) {
            ...
            ((d || u) && (c = ta(xe(s).row, new N(c, d, u)).content), l.push(c));
        }
    else if (i == 'cell' || i == 'header_cell')
        l.push(n || r ? ta(xe(s).row, new N(e, n, r)).content : e);
    else return null;
    return px(s, l);
}
function px(t, e) {
...
function ta(t, e) {
    ...
    return new At(n).replace(0, n.content.size, e).doc;
}
function mx({ width: t, height: e, rows: n }, r, o) {
    if (t != r) {
        let i = [],
            s = [];
            ...
            for (let d = i[l] || 0, u = 0; d < r; u++) {
                ...
                (d + f.attrs.colspan > r &&
                    (f = f.type.createChecked(
                        dn(f.attrs, f.attrs.colspan, d + f.attrs.colspan - r),
                        f.content,
                    )),
                    c.push(f),
                    (d += f.attrs.colspan));
...
function Th(t, e, n, r, o, i, s, l) {
    ...
    for (let c = o; c < i; c++) {
        ...
        if (e.map[d - 1] == u) {
            ...
            (t.setNodeMarkup(p, null, dn(f.attrs, s - h, f.attrs.colspan - (s - h))),
                t.insert(p + f.nodeSize, f.type.createAndFill(dn(f.attrs, 0, s - h))),
                (c += f.attrs.rowspan - 1));
        }
    }
    return a;
...
function Ah(t, e, n, r, o) {
    ...
    (gx(u, s, i, n, c, d, f) && h(),
        Mh(u, s, i, n, a, c, l, f) && h(),
        Mh(u, s, i, n, a, c, d, f) && h(),
        Th(u, s, i, n, l, d, a, f) && h(),
        Th(u, s, i, n, l, d, c, f) && h());
    for (let p = l; p < d; p++) {
...
function bi(t, e) {
    return (n, r, o) => {
        if (!o) return !1;
        let i = n.selection;
        if (i instanceof Y) return xi(n, r, I.near(i.$headCell, e));
...
function wi(t, e) {
    return (n, r, o) => {
        ...
        let l = Dh(s.$headCell, t, e);
        return l ? xi(n, r, new Y(s.$anchorCell, l)) : !1;
    };
}
function bx(t, e) {
    let n = t.state.doc,
...
function wx(t, e, n) {
    ...
    let r = hx(n),
        o = t.state.selection;
    if (o instanceof Y) {
        r || (r = { width: 1, height: 1, rows: [v.from(ta(xe(t.state.schema).cell, n))] });
        let i = o.$anchorCell.node(-1),
            s = o.$anchorCell.start(-1),
            l = ie.get(i).rectBetween(o.$anchorCell.pos - s, o.$headCell.pos - s);
        return (
            (r = mx(r, l.right - l.left, l.bottom - l.top)),
            Ah(t.state, t.dispatch, s, l, r),
            !0
        );
    } else if (r) {
        let i = Si(t.state),
            s = i.start(-1);
        return (Ah(t.state, t.dispatch, s, ie.get(i.node(-1)).findCell(i.pos - s), r), !0);
    } else return !1;
}
function xx(t, e) {
    var n;
    ...
    if (e.shiftKey && t.state.selection instanceof Y)
        ...
        e.shiftKey &&
        r &&
        (o = cn(t.state.selection.$anchor)) != null &&
        ((n = Yl(t, e)) === null || n === void 0 ? void 0 : n.pos) != o.pos
    )
        (i(o, e), e.preventDefault());
    else if (!r) return;
    function i(a, c) {
        let d = Yl(t, c),
            u = Ht.getState(t.state) == null;
        if (!d || !ra(a, d))
            if (u) d = a;
            else return;
        let f = new Y(a, d);
        if (u || !t.state.selection.eq(f)) {
            ...
            (u && h.setMeta(Ht, a.pos), t.dispatch(h));
        }
    }
    function s() {
        (t.root.removeEventListener('mouseup', s),
            ...
            Ht.getState(t.state) != null && t.dispatch(t.state.tr.setMeta(Ht, -1)));
    }
    function l(a) {
        let c = a,
            d = Ht.getState(t.state),
            u;
        if (d != null) u = t.state.doc.resolve(d);
        else if (Eh(t, c.target) != r && ((u = Yl(t, e)), !u)) return s();
        u && i(u, c);
    }
...
function Yl(t, e) {
    ...
    return (r >= 0 && cn(t.state.doc.resolve(r))) || cn(t.state.doc.resolve(o));
}
var kx = class {
    constructor(t, e) {
        ((this.node = t),
            ...
            na(t, this.colgroup, this.table, e),
            (this.contentDOM = this.table.appendChild(document.createElement('tbody'))));
    }
    update(t) {
        return t.type != this.node.type
            ? !1
            : ((this.node = t), na(t, this.colgroup, this.table, this.defaultCellMinWidth), !0);
    }
    ignoreMutation(t) {
        return (
...
var De = new H('tableColumnResizing');
function Jh({
    handleWidth: t = 5,
    cellMinWidth: e = 25,
    ...
    let i = new P({
        ...
        state: {
            init(s, l) {
                ...
                return (r && c && (c[d] = (u, f) => new r(u, n, f)), new Sx(-1, !1));
            },
            apply(s, l) {
                return l.apply(s);
            },
        ...
        props: {
            ...
            decorations: (s) => {
                let l = De.getState(s);
                if (l && l.activeHandle > -1) return Ox(s, l.activeHandle);
            },
            nodeViews: {},
        },
    });
...
var Sx = class ki {
    ...
    apply(e) {
        ...
        if (n.activeHandle > -1 && e.docChanged) {
            ...
            return (ea(e.doc.resolve(o)) || (o = -1), new ki(o, n.dragging));
        }
        return n;
    }
};
function Cx(t, e, n, r) {
    ...
    if (o && !o.dragging) {
        ...
        if (i) {
            ...
            e.clientX - l <= n
                ? (s = Nh(t, e, 'left', n))
                : a - e.clientX <= n && (s = Nh(t, e, 'right', n));
        }
        if (s != o.activeHandle) {
            if (!r && s !== -1) {
...
function vx(t) {
    if (!t.editable) return;
    let e = De.getState(t.state);
    e && e.activeHandle > -1 && !e.dragging && Gh(t, -1);
}
function Mx(t, e, n, r) {
    var o;
    if (!t.editable) return !1;
    let i = (o = t.dom.ownerDocument.defaultView) !== null && o !== void 0 ? o : window,
        s = De.getState(t.state);
    if (!s || s.activeHandle == -1 || s.dragging) return !1;
    let l = t.state.doc.nodeAt(s.activeHandle),
        a = Tx(t, s.activeHandle, l.attrs);
    t.dispatch(t.state.tr.setMeta(De, { setDragging: { startX: e.clientX, startWidth: a } }));
    function c(u) {
        (i.removeEventListener('mouseup', c), i.removeEventListener('mousemove', d));
        let f = De.getState(t.state);
        f?.dragging &&
            (Ex(t, f.activeHandle, Oh(f.dragging, u, n)),
            t.dispatch(t.state.tr.setMeta(De, { setDragging: null })));
    }
    function d(u) {
        if (!u.which) return c(u);
        let f = De.getState(t.state);
        if (f && f.dragging) {
            let h = Oh(f.dragging, u, n);
            Rh(t, f.activeHandle, h, r);
        }
    }
    return (
        Rh(t, s.activeHandle, a, r),
...
function Tx(t, e, { colspan: n, colwidth: r }) {
...
function Ex(t, e, n) {
    ...
    for (let c = 0; c < i.height; c++) {
        ...
        let p = f.colwidth ? f.colwidth.slice() : Nx(f.colspan);
...
function Xh({ allowTableNodeSelection: t = !1 } = {}) {
    return new P({
        key: Ht,
        state: {
            init() {
...
var Px = class {
    constructor(t, e) {
        ((this.node = t),
            ...
            (this.colgroup = this.table.appendChild(document.createElement('colgroup'))),
            Yh(t, this.colgroup, this.table, e),
            (this.contentDOM = this.table.appendChild(document.createElement('tbody'))));
    }
    update(t) {
        return t.type !== this.node.type
            ? !1
            : ((this.node = t), Yh(t, this.colgroup, this.table, this.cellMinWidth), !0);
    }
    ignoreMutation(t) {
        let e = t.target,
...
function _x(t, e, n = {}) {
    var r;
    let o = (r = n.cellLineSeparator) != null ? r : $x;
...
var Vx = _x,
    Wx = $.create({
        ...
        renderHTML({ node: t, HTMLAttributes: e }) {
            let { colgroup: n, tableWidth: r, tableMinWidth: o } = Lx(t, this.options.cellMinWidth),
                i = e.style;
            function s() {
        ...
        addProseMirrorPlugins() {
            return [
                ...(this.options.resizable && this.editor.isEditable
                    ...
                    : []),
                Xh({ allowTableNodeSelection: this.options.allowTableNodeSelection }),
            ];
        },
        extendNodeSchema(t) {
    ...
    Zh = K.create({
        ...
        addExtensions() {
            let t = [];
            return (
                this.options.table !== !1 && t.push(Wx.configure(this.options.table)),
                this.options.tableCell !== !1 && t.push(Rx.configure(this.options.tableCell)),
                this.options.tableHeader !== !1 && t.push(Dx.configure(this.options.tableHeader)),
                this.options.tableRow !== !1 && t.push(Ix.configure(this.options.tableRow)),
                t
            );
        },
    });
...
var rp = (t, e) => {
    ...
    op = ({ mergeTags: t, noMergeTagSearchResultsMessage: e }) => ({
        items: ({ query: n }) =>
            Object.entries(t)
                .filter(
                    ([r, o]) =>
            ...
            return {
                onStart: (f) => {
                    ((o = f),
                        ...
                        f.clientRect && rp(f.editor, n));
                },
                onUpdate: (f) => {
                    ((o = f), (r = 0), s(), a(), f.clientRect && rp(f.editor, n));
                },
                onKeyDown: (f) =>
                    f.event.key === 'Escape'
...
var ip = async ({
    ...
    let k = [
            ...
            _u,
            Wu,
            Ru.configure({ class: 'fi-not-prose' }),
            Du,
            ju,
            Uu,
            Ku,
            ...
            ...(Object.keys(y).length
                ? [
                      Nf.configure({
                          deleteTriggerWithBackspace: !0,
                          suggestion: op({ mergeTags: y, noMergeTagSearchResultsMessage: w }),
                          mergeTags: y,
                      }),
                  ]
                : []),
            ...
            Vl,
            yh,
            Xl.configure({ placeholder: b }),
            wh.configure({ textColors: x }),
            bh,
            xh,
            kh,
            Sh,
            Zh.configure({ table: { resizable: !0 } }),
            ep,
            tp.configure({
    ...
    for (let M of E) {
        ...
        (M.name === 'placeholder' && M.parent === null && (M = Xl.configure(M.options)),
            A !== -1 ? (k[A] = M) : k.push(M));
    }
    return k;
};
...
var Jx = class {
            ...
            ((this.preventHide = !1),
                ...
                (this.shouldShow = ({ view: d, state: u, from: f, to: h }) => {
                    let { doc: p, selection: m } = u,
                        { empty: g } = m,
                        y = !p.textBetween(f, h).length && ho(u.selection),
        ...
        get middlewares() {
            ...
            return (
                ...
                this.floatingUIOptions.arrow && t.push(fh(this.floatingUIOptions.arrow)),
        ...
        get virtualElement() {
            ...
            if (n) return n;
            let r = ru(this.view, e.from, e.to),
            ...
            if (e instanceof Y) {
                ...
                let u =
                    c === d
                        ...
                        : qx(c.getBoundingClientRect(), d.getBoundingClientRect());
...
function Gx({
    ...
    return {
        ...
        async init() {
            _ = new bu({
                ...
                extensions: await ip({
                    ...
                    floatingToolbars: l,
                    hasResizableImages: a,
                    insertCustomBlockUsing: (q, Xe = null) =>
                        this.$wire.mountAction(
                            'customBlock',
                            { id: q, dragPosition: Xe, mode: 'insert' },
                            { schemaComponent: f },
                        ),
                    key: f,
                    linkProtocols: p,
            ...
            (Object.keys(l).forEach((q) => {
                let Xe = this.$refs[`floatingToolbar::${q}`];
                if (!Xe) {
                ...
                _.registerPlugin(
                    ca({
                        ...
                        shouldShow: ({ editor: Me }) =>
                            q === 'paragraph'
                                ? Me.isFocused && Me.isActive(q) && !Me.state.selection.empty
                                : F && !Me.state.selection.empty && Me.isActive('paragraph')
                                  ? !1
                                  : Me.isFocused && Me.isActive(q),
            ...
            (_.on('update', ({ editor: q }) =>
                ...
                _.on('selectionUpdate', ({ transaction: q }) => {
                    O ||
                        ((this.editorUpdatedAt = Date.now()),
                        (this.editorSelection = q.selection.toJSON()));
                }),
                _.on('transaction', () => {
                    O || (this.editorUpdatedAt = Date.now());
                }),
                u &&
                    _.on('blur', () => {
                        O || this.$wire.commit();
                ...
                this.$watch('state', () => {
                    if (!O) {
                        ...
                        _.commands.setContent(this.state);
                    }
                }));
            let X = (q) => {
            ...
            (window.addEventListener('run-rich-editor-commands', X),
                V.push(['run-rich-editor-commands', X]));
            let te = (q) => {
            ...
            (window.addEventListener('rich-editor-uploading-file', te),
                V.push(['rich-editor-uploading-file', te]));
            let ke = (q) => {
                q.detail.livewireId === g &&
                    q.detail.key === f &&
                    ((this.isUploadingFile = !1), q.stopPropagation());
            };
            (window.addEventListener('rich-editor-uploaded-file', ke),
                V.push(['rich-editor-uploaded-file', ke]));
            let Tt = (q) => {
                q.detail.livewireId === g &&
                    q.detail.key === f &&
            ...
            (window.addEventListener('rich-editor-file-validation-message', Tt),
                V.push(['rich-editor-file-validation-message', Tt]),
        ...
        setEditorSelection(F) {
            F &&
                ...
                _.chain()
                    .command(
                        ({ tr: W }) => (
                            W.setSelection(I.fromJSON(_.state.doc, this.editorSelection)),
                            !0
                        ),
                    )
                    .run());
        ...
        runEditorCommands({ commands: F, editorSelection: W }) {
            ...
            let X = _.chain();
            (F.forEach((te) => (X = X[te.name](...(te.arguments ?? [])))), X.run());
        },
        togglePanel(F = null) {
        ...
        isPanelActive(F = null) {
            return F === null ? this.activePanel !== null : this.activePanel === F;
        },
        insertMergeTag(F) {
            _.chain()
                .focus()
