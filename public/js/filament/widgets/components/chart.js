...
var k = (s, t, e) => Mc(s, typeof t != 'symbol' ? t + '' : t, e);
function us(s) {
    return (s + 0.5) | 0;
}
var Yt = (s, t, e) => Math.max(Math.min(s, e), t);
function cs(s) {
    return Yt(us(s * 2.55), 0, 255);
}
function Zt(s) {
    return Yt(us(s * 255), 0, 255);
}
function Rt(s) {
    return Yt(us(s / 2.55) / 100, 0, 1);
}
function Rr(s) {
    return Yt(us(s * 100), 0, 100);
}
var pt = {
        0: 0,
        1: 1,
...
function Gi(s, t, e, i) {
    return (Array.isArray(t) ? s(t[0], t[1], t[2]) : s(t, e, i)).map(Zt);
}
function Xi(s, t, e) {
    return Gi(Wr, s, t, e);
}
...
function zc(s) {
    let t = Ic.exec(s),
        ...
        i;
    if (!t) return;
    t[5] !== i && (e = t[6] ? cs(+t[5]) : Zt(+t[5]));
    let n = Br(+t[2]),
        r = +t[3] / 100,
        o = +t[4] / 100;
    return (
        t[1] === 'hwb' ? (i = Rc(n, r, o)) : t[1] === 'hsv' ? (i = Nc(n, r, o)) : (i = Xi(n, r, o)),
        { r: i[0], g: i[1], b: i[2], a: e }
    );
}
function Vc(s, t) {
    var e = qi(s);
    ((e[0] = Br(e[0] + t)), (e = Xi(e)), (s.r = e[0]), (s.g = e[1]), (s.b = e[2]));
}
function Wc(s) {
    if (!s) return;
    let t = qi(s),
...
function Bc() {
    ...
    for (i = 0; i < t.length; i++) {
        for (o = a = t[i], n = 0; n < e.length; n++) ((r = e[n]), (a = a.replace(r, Nr[r])));
        ((r = parseInt(zr[o], 16)), (s[a] = [(r >> 16) & 255, (r >> 8) & 255, r & 255]));
    }
    return s;
}
var Ys;
...
function jc(s) {
    ...
    if (t) {
        if (t[7] !== i) {
            let o = +t[7];
            e = t[8] ? cs(o) : Yt(o * 255, 0, 255);
        }
        return (
            (i = +t[1]),
            (n = +t[3]),
            (r = +t[5]),
            (i = 255 & (t[2] ? cs(i) : Yt(i, 0, 255))),
            (n = 255 & (t[4] ? cs(n) : Yt(n, 0, 255))),
            (r = 255 & (t[6] ? cs(r) : Yt(r, 0, 255))),
            { r: i, g: n, b: r, a: e }
        );
    }
}
function Uc(s) {
    return (
        s &&
        (s.a < 255 ? `rgba(${s.r}, ${s.g}, ${s.b}, ${Rt(s.a)})` : `rgb(${s.r}, ${s.g}, ${s.b})`)
    );
}
var Yi = (s) => (s <= 0.0031308 ? s * 12.92 : Math.pow(s, 1 / 2.4) * 1.055 - 0.055),
    Oe = (s) => (s <= 0.04045 ? s / 12.92 : Math.pow((s + 0.055) / 1.055, 2.4));
function Yc(s, t, e) {
    let i = Oe(Rt(s.r)),
        n = Oe(Rt(s.g)),
        r = Oe(Rt(s.b));
    return {
        r: Zt(Yi(i + e * (Oe(Rt(t.r)) - i))),
        g: Zt(Yi(n + e * (Oe(Rt(t.g)) - n))),
        b: Zt(Yi(r + e * (Oe(Rt(t.b)) - r))),
        a: s.a + e * (t.a - s.a),
    };
}
function Zs(s, t, e) {
...
function Vr(s) {
    ...
    return (
        Array.isArray(s)
            ? s.length >= 3 &&
              ((t = { r: s[0], g: s[1], b: s[2], a: 255 }), s.length > 3 && (t.a = Zt(s[3])))
            : ((t = Hr(s, { r: 0, g: 0, b: 0, a: 1 })), (t.a = Zt(t.a))),
        t
    );
}
function Zc(s) {
...
var hs = class s {
    constructor(t) {
        ...
        let e = typeof t,
            i;
        (e === 'object' ? (i = Vr(t)) : e === 'string' && (i = Cc(t) || Hc(t) || Zc(t)),
            (this._rgb = i),
            (this._valid = !!i));
    }
    get valid() {
...
function Ae(s, t) {
    return Ce(s, t, { merger: Gc });
}
function Gc(s, t, e) {
    if (!eo(s)) return;
    let i = t[s],
        n = e[s];
    E(i) && E(n) ? Ae(i, n) : Object.prototype.hasOwnProperty.call(t, s) || (t[s] = Js(n));
}
var $r = { '': (s) => s, x: (s) => s.x, y: (s) => s.y };
function Xc(s) {
    let t = s.split('.'),
        e = [],
        i = '';
...
function sn(s) {
    let t = Math.round(s);
    s = Ee(s, t, s / 1e3) ? t : s;
    let e = Math.pow(10, Math.floor(zt(s))),
        i = s / e;
...
function on(s, t) {
    let e = t.x - s.x,
        ...
        n = Math.sqrt(e * e + i * i),
        r = Math.atan2(i, e);
    return (r < -0.5 * F && (r += $), { angle: r, distance: n });
}
function Qs(s, t) {
...
var lo = ['push', 'pop', 'shift', 'splice', 'unshift'];
function co(s, t) {
    if (s._chartjs) {
...
var ni = (s) => (s === 'start' ? 'left' : s === 'end' ? 'right' : 'center'),
    ...
    uo = (s, t, e, i) => (s === (i ? 'left' : 'right') ? e : s === 'center' ? (t + e) / 2 : t);
function un(s, t, e) {
    let i = t.length,
        n = 0,
        r = i;
    if (s._sorted) {
        ...
        if (f) {
            if (((n = Math.min(Dt(l, h, u).lo, e ? i : Dt(t, h, o.getPixelForValue(u)).lo)), c)) {
                let m = l
                    .slice(0, n + 1)
                    .reverse()
        ...
        if (g) {
            let m = Math.max(
                Dt(l, o.axis, d, !0).hi + 1,
                e ? 0 : Dt(t, h, o.getPixelForValue(d), !0).hi + 1,
            );
            if (c) {
...
var qs = (s) => s === 0 || s === 1,
    Ur = (s, t, e) => -(Math.pow(2, 10 * (s -= 1)) * Math.sin(((s - t) * $) / e)),
    Yr = (s, t, e) => Math.pow(2, -10 * s) * Math.sin(((s - t) * $) / e) + 1,
    De = {
        linear: (s) => s,
        easeInQuad: (s) => s * s,
        easeOutQuad: (s) => -s * (s - 2),
        ...
        easeInElastic: (s) => (qs(s) ? s : Ur(s, 0.075, 0.3)),
        easeOutElastic: (s) => (qs(s) ? s : Yr(s, 0.075, 0.3)),
        easeInOutElastic(s) {
            return qs(s)
                ? s
                : s < 0.5
                  ? 0.5 * Ur(s * 2, 0.1125, 0.45)
                  : 0.5 + 0.5 * Yr(s * 2 - 1, 0.1125, 0.45);
        },
        easeInBack(s) {
...
function oh(s, t) {
    ...
    let e = s + JSON.stringify(t),
        i = Zr.get(e);
    return (i || ((i = new Intl.NumberFormat(s, t)), Zr.set(e, i)), i);
}
function Fe(s, t, e) {
    return oh(t, e).format(s);
}
var fo = {
    values(s) {
        return H(s) ? s : '' + s;
    ...
    numeric(s, t, e) {
        ...
        if (e.length > 1) {
            ...
            ((c < 1e-4 || c > 1e15) && (n = 'scientific'), (r = ah(s, e)));
        }
        let o = zt(Math.abs(r)),
    ...
    logarithmic(s, t, e) {
        if (s === 0) return '0';
        let i = e[t].significand || s / Math.pow(10, Math.floor(zt(s)));
        return [1, 2, 3, 5, 10, 15].includes(i) || t > 0.8 * e.length
            ? fo.numeric.call(this, s, t, e)
            : '';
    },
};
function ah(s, t) {
...
function Ki(s, t, e) {
    return typeof t == 'string' ? Ce(ds(s, t), e) : Ce(ds(s, ''), t);
}
var Qi = class {
        constructor(t, e) {
...
function go(s, t, e, i) {
    ...
    let o = 0,
        ...
        d;
    for (l = 0; l < a; l++)
        if (((u = e[l]), u != null && !H(u))) o = fs(s, n, r, o, u);
        else if (H(u))
            for (c = 0, h = u.length; c < h; c++)
                ((d = u[c]), d != null && !H(d) && (o = fs(s, n, r, o, d)));
    s.restore();
    let f = r.length / 2;
    if (f > e.length) {
...
function Kt(s, t, e, i, n, r = {}) {
    let o = H(t) ? t : [t],
        a = r.strokeWidth > 0 && r.strokeColor !== '',
        l,
        c;
    for (s.save(), s.font = n.string, hh(s, r), l = 0; l < o.length; ++l)
        ((c = o[l]),
            r.backdrop && dh(s, r.backdrop),
            a &&
...
function ue(s, t, e, i) {
    let n = {
        ...
        _stack: new Set(),
        _descriptors: yn(s, i),
        setContext: (r) => ue(s, r, e, i),
        override: (r) => ue(s.override(r), t, e, i),
    };
    return new Proxy(n, {
        deleteProperty(r, o) {
...
function yh(s, t, e) {
    let { _proxy: i, _context: n, _subProxy: r, _descriptors: o } = s,
        a = i[t];
    return (
        Nt(a) && o.isScriptable(t) && (a = xh(t, a, s, e)),
        H(a) && a.length && (a = _h(t, a, s, o.isIndexable)),
        xn(t, a) && (a = ue(a, n, r && r[t], o)),
        a
    );
}
function xh(s, t, e, i) {
...
var wh = (s, t) => (s === !0 ? t : typeof s == 'string' ? Vt(t, s) : void 0);
function kh(s, t, e, i, n) {
    for (let r of t) {
        let o = wh(e, r);
        if (o) {
            s.add(o);
            let a = xo(o._fallback, e, n);
...
function _n(s, t, e, i) {
    let n = t._rootScopes,
        r = xo(t._fallback, e, i),
        o = [...s, ...n],
        a = new Set();
    a.add(i);
    let l = qr(a, o, e, r || e, i);
    return l === null || (typeof r < 'u' && r !== e && ((l = qr(a, o, r, l, i)), l === null))
        ? !1
        : li(Array.from(a), [''], n, r, () => vh(t, e, i));
}
...
function Sh(s, t, e, i) {
    let n;
    for (let r of t)
        if (((n = _o(bh(r, s), e)), typeof n < 'u')) return xn(s, n) ? _n(e, i, s, n) : n;
}
function _o(s, t) {
    for (let e of t) {
        if (!e) continue;
...
function wn(s, t, e, i) {
    let { iScale: n } = s,
        ...
        c,
        h;
    for (a = 0, l = i; a < l; ++a) ((c = a + e), (h = t[c]), (o[a] = { r: n.parse(Vt(h, r), c) }));
    return o;
}
...
function Ch(s, t, e = 'x') {
    let i = wo(e),
        ...
        l = Pe(s, 0);
    for (let c = 0; c < n; ++c) {
        if (((o = a), (a = l), (l = Pe(s, c + 1)), !a)) continue;
        let h = a[e],
            u = a[i];
...
function ko(s, t, e, i, n) {
    ...
    if ((t.spanGaps && (s = s.filter((c) => !c.skip)), t.cubicInterpolationMode === 'monotone'))
        ...
        for (r = 0, o = s.length; r < o; ++r)
            ((a = s[r]),
                (l = Oh(c, a, s[Math.min(r + 1, o - (i ? 0 : 1)) % o], t.tension)),
                (a.cp1x = l.previous.x),
                (a.cp1y = l.previous.y),
                (a.cp2x = l.next.x),
                (a.cp2y = l.next.y),
...
var Gt = (s) => Math.round(s * 10) / 10;
function vo(s, t, e, i) {
    let n = ui(s),
        r = he(n, 'margin'),
        o = ti(n.maxWidth, s, 'clientWidth') || Ks,
    ...
    return (
        ...
        (c = Gt(Math.min(c, o, l.maxWidth))),
        (h = Gt(Math.min(h, a, l.maxHeight))),
        c && !h && (h = Gt(c / 2)),
        (t !== void 0 || e !== void 0) &&
            i &&
            l.height &&
            h > l.height &&
            ((h = l.height), (c = Gt(Math.floor(h * i)))),
        { width: c, height: h }
    );
}
function kn(s, t, e) {
    let i = t || 1,
        n = Gt(s.height * i),
        r = Gt(s.width * i);
    ((s.height = Gt(s.height)), (s.width = Gt(s.width)));
    let o = s.canvas;
    return (
        o.style &&
...
function Tn(s, t, e) {
    ...
    let { property: i, start: n, end: r } = e,
        o = t.length,
        { compare: a, between: l, normalize: c } = Oo(i),
    ...
    for (let M = h, O = h; M <= u; ++M)
        ((y = t[M % o]),
            !y.skip &&
                ...
                b !== _ &&
                    ((m = l(b, n, r)),
                    p === null && v() && (p = a(b, n) === 0 ? M : O),
                    p !== null &&
                        S() &&
                        (g.push(Xr({ start: p, end: M, loop: d, count: o, style: f })), (p = null)),
                    (O = M),
                    (_ = b))));
    return (p !== null && g.push(Xr({ start: p, end: u, loop: d, count: o, style: f })), g);
}
function On(s, t) {
    let e = [],
        i = s.segments;
    for (let n = 0; n < i.length; n++) {
        let r = Tn(i[n], s.points, t);
        r.length && e.push(...r);
    }
    return e;
}
...
function Do(s, t) {
    ...
    if (!n) return [];
    let r = !!s._loop,
        { start: o, end: a } = Wh(e, n, r, i);
    if (i === !0) return Jr(s, [{ start: o, end: a, loop: r }], e, t);
    let l = a < o ? a + n : a,
        c = !!s._fullLoop && o === 0 && a === n - 1;
    return Jr(s, Bh(e, o, l, c), e, t);
}
function Jr(s, t, e, i) {
...
function $h(s, t) {
    ...
    let e = [],
        i = function (n, r) {
            return fn(r) ? (e.includes(r) || e.push(r), e.indexOf(r)) : r;
        };
...
var Wn = class {
    ...
    Bn = class {
        constructor(t, e, i, n) {
            let r = e[i];
            n = Ne([t.to, n, r, t.from]);
            let o = Ne([t.from, r, n]);
            ((this._active = !0),
                (this._fn = t.fn || Uh[t.type || typeof o]),
    ...
    _i = class {
        ...
        configure(t) {
            ...
            Object.getOwnPropertyNames(t).forEach((n) => {
                ...
                ((H(r.properties) && r.properties) || [n]).forEach((a) => {
...
function Ao(s, t, e, i = {}) {
    ...
    for (o = 0, a = n.length; o < a; ++o) {
        ...
        ((c = s.values[l]), Z(c) && (r || t === 0 || St(t) === St(c)) && (t += c));
    }
    return !h && !i.all ? 0 : t;
}
function Xh(s, t) {
...
function Eo(s, t) {
    ...
    for (let f = 0; f < u; ++f) {
        ...
        ((d = b[c] = Qh(n, h, m)),
            (d[a] = p),
            (d._top = Io(d, o, !0, i.type)),
            (d._bottom = Io(d, o, !1, i.type)));
    ...
    ut = class {
        ...
        linkScales() {
            let t = this.chart,
                ...
                r = (e.xAxisID = P(i.xAxisID, Pn(t, 'x'))),
                o = (e.yAxisID = P(i.yAxisID, Pn(t, 'y'))),
        ...
        buildOrUpdateElements(t) {
            ...
            ((e._stacked = Cn(e.vScale, e)),
                ...
                (n || r !== e._stacked) && (Eo(this, e._parsed), (e._stacked = Cn(e.vScale, e))));
        }
        configure() {
        ...
        applyStack(t, e, i) {
            ...
            return Ao(a, o, r.index, { mode: i });
        }
        updateRangeFromParsed(t, e, i, n) {
            let r = i[e.axis],
                o = r === null ? NaN : r,
                a = n && i._stacks[e.axis];
            (n && a && ((n.values = a), (o = Ao(n, r, this._cachedMeta.index))),
        ...
        getAllParsedValues(t) {
            let e = this._cachedMeta._parsed,
                ...
                r,
                o;
            for (n = 0, r = e.length; n < r; ++n) ((o = e[n][t.axis]), Z(o) && i.push(o));
            return i;
        }
        getMaxOverflow() {
            return !1;
        ...
        getContext(t, e, i) {
            ...
            if (t >= 0 && t < this._cachedMeta.data.length) {
                ...
                ((r = o.$context || (o.$context = eu(this.getContext(), t, o))),
                    (r.parsed = this.getParsed(t)),
                    (r.raw = n.data[t]),
                    (r.index = r.dataIndex = t));
            } else
                ((r = this.$context || (this.$context = tu(this.chart.getContext(), this.index))),
                    (r.dataset = n),
        ...
        _resolveElementOptions(t, e = 'default', i) {
            ...
            return (m.$shared && ((m.$shared = l), (r[o] = Object.freeze(Lo(m, l)))), m);
        }
...
(k(ut, 'defaults', {}), k(ut, 'datasetElementType', null), k(ut, 'dataElementType', null));
function iu(s, t) {
    if (!s._cache.$bar) {
        ...
        s._cache.$bar = ln(i.sort((n, r) => n - r));
    }
    return s._cache.$bar;
}
function nu(s) {
    let t = s.iScale,
        ...
        l = () => {
            o === 32767 ||
                o === -32768 ||
                (Ie(a) && (i = Math.min(i, Math.abs(o - a) || i)), (a = o));
        };
...
function Fo(s, t, e, i) {
    let n = s.iScale,
        ...
        d;
    for (c = e, h = e + i; c < h; ++c)
        ((d = t[c]), (u = {}), (u[n.axis] = a || n.parse(o[c], c)), l.push(Ca(d, u, r, c)));
    return l;
}
function In(s) {
...
function hu(s, t, e, i) {
    ...
    let { start: o, end: a, reverse: l, top: c, bottom: h } = cu(s);
    (n === 'middle' &&
        e &&
...
function Ro(s, t, e, i) {
    return (i ? ((s = uu(s, t, e)), (s = No(s, e, t))) : (s = No(s, t, e)), s);
}
function uu(s, t, e) {
...
var Ve = class extends ut {
    ...
    parseObjectData(t, e, i, n) {
        ...
        for (d = i, f = i + n; d < f; ++d)
            ((m = e[d]),
                (g = {}),
                (g[r.axis] = r.parse(Vt(m, c), d)),
                u.push(Ca(Vt(m, h), g, o, d)));
        return u;
    }
    updateRangeFromParsed(t, e, i, n) {
    ...
    getLabelAndValue(t) {
        let e = this._cachedMeta,
            ...
            r = this.getParsed(t),
            o = r._custom,
            a = In(o) ? '[' + o.start + ', ' + o.end + ']' : '' + n.getLabelForValue(r[n.axis]);
        ...
        for (let f = e; f < e + i; f++) {
            let g = this.getParsed(f),
                ...
                y = {
                    horizontal: c,
                    base: m.base,
                    enableBorderRadius: !b || In(g._custom) || o === b._top || o === b._bottom,
                    x: c ? m.head : p.center,
                    y: c ? p.center : m.head,
            ...
            (hu(y, _, b, o), du(y, _, h.ratio), this.updateElement(t[f], f, y, n));
        }
    }
    _getStacks(t, e) {
    ...
    _calculateBarIndexPixels(t, e) {
        ...
        if (e.grouped) {
            let h = r ? this._getStackCount(t) : e.stackCount,
                u = n.barThickness === 'flex' ? ou(t, e, n, h * c) : ru(t, e, n, h * c),
                d =
...
(k(We, 'id', 'bubble'),
    ...
    k(We, 'overrides', { scales: { x: { type: 'linear' }, y: { type: 'linear' } } }));
function fu(s, t, e) {
    let i = 1,
        n = 1,
        r = 0,
...
var $t = class extends ut {
    ...
    _circumference(t, e) {
        ...
        return (e && i.animation.animateRotate) ||
            ...
            n.data[t].hidden
            ? 0
            : this.calculateCircumference((n._parsed[t] * r) / $);
    }
    updateElements(t, e, i, n) {
        let r = n === 'reset',
            o = this.chart,
    ...
    getLabelAndValue(t) {
        let e = this._cachedMeta,
            i = this.chart,
            n = i.data.labels || [],
            r = Fe(e._parsed[t], i.options.locale);
    ...
    updateElements(t, e, i, n) {
        ...
        for (let x = 0; x < _; ++x) {
            ...
            let M = this.getParsed(x),
                O = I(M[f]),
                C = (S[d] = o.getPixelForValue(M[d], x)),
                A = (S[f] =
                    r || O
                        ? a.getBasePixel()
                        : a.getPixelForValue(l ? this.applyStack(a, M, l) : M[f], x));
            ((S.skip = isNaN(C) || isNaN(A) || O),
                (S.stop = x > 0 && Math.abs(M[d] - w[d]) > p),
                m && ((S.parsed = M), (S.raw = c.data[x])),
                u && (S.options = h || this.resolveDataElementOptions(x, v.active ? 'active' : n)),
...
(k(Be, 'id', 'line'),
    ...
    k(Be, 'overrides', { scales: { _index_: { type: 'category' }, _value_: { type: 'linear' } } }));
var ye = class extends ut {
    ...
    getLabelAndValue(t) {
        let e = this._cachedMeta,
            i = this.chart,
            n = i.data.labels || [],
            r = Fe(e._parsed[t].r, i.options.locale);
        return { label: n[t] || '', value: r };
    }
    parseObjectData(t, e, i, n) {
...
(k(vs, 'id', 'pie'),
    k(vs, 'defaults', { cutout: 0, rotation: 0, circumference: 360, radius: '100%' }));
...
(k(He, 'id', 'radar'),
    ...
    k(He, 'overrides', { aspectRatio: 1, scales: { r: { type: 'radialLinear' } } }));
    ...
    updateElements(t, e, i, n) {
        ...
        for (let w = e; w < e + i; ++w) {
            let x = t[w],
                ...
                S = y ? x : {},
                M = I(v[g]),
                O = (S[f] = o.getPixelForValue(v[f], w)),
                C = (S[g] =
                    r || M
                        ? a.getBasePixel()
                        : a.getPixelForValue(l ? this.applyStack(a, v, l) : v[g], w));
            ((S.skip = isNaN(O) || isNaN(C) || M),
...
(k($e, 'id', 'scatter'),
    k($e, 'defaults', { datasetElementType: !1, dataElementType: 'point', showLine: !1, fill: !1 }),
    k($e, 'overrides', {
...
function bu(s, t, e, i) {
    ...
    function r(o, a, l) {
        let { startAngle: c, endAngle: h } = o.getProps(['startAngle', 'endAngle'], i),
            { angle: u } = on(o, { x: t.x, y: t.y });
        Le(u, c, h) && n.push({ element: o, datasetIndex: a, index: l });
    }
    return (Ls(s, e, t, r), n);
}
function yu(s, t, e, i, n, r) {
    let o = [],
        a = pu(e),
...
function Ln(s, t, e, i, n, r) {
    return !r && !s.isPointInArea(t) ? [] : e === 'r' && !i ? bu(s, t, e, n) : yu(s, t, e, i, n, r);
}
        ...
        modes: {
            index(s, t, e, i) {
                let n = te(t, s),
                    ...
                    a = e.intersect ? En(s, n, r, i, o) : Ln(s, n, r, !1, i, o),
                    l = [];
                return a.length
            ...
            nearest(s, t, e, i) {
                let n = te(t, s),
                    r = e.axis || 'xy',
                    o = e.includeInvisible || !1;
                return Ln(s, n, r, e.intersect, i, o);
            },
            x(s, t, e, i) {
                let n = te(t, s);
                return zo(s, n, 'x', e.intersect, i);
            },
            y(s, t, e, i) {
                let n = te(t, s);
                return zo(s, n, 'y', e.intersect, i);
            },
        },
    },
...
function Su(s, t, e, i) {
    ...
    r.getPadding && Aa(o, r.getPadding());
    let a = Math.max(0, t.outerWidth - Wo(o, s, 'left', 'right')),
        l = Math.max(0, t.outerHeight - Wo(o, s, 'top', 'bottom')),
        c = a !== s.w,
        h = l !== s.h;
...
function Ss(s, t, e, i) {
    ...
    for (r = 0, o = s.length, c = 0; r < o; ++r) {
        ((a = s[r]), (l = a.box), l.update(a.width || t.w, a.height || t.h, Tu(a.horizontal, t)));
    ...
    for (let a of s) {
        ...
        if (a.horizontal) {
            ...
            (Ie(c.start) && (o = c.start),
                l.fullSize
                    ? di(l, n.left, o, e.outerWidth - n.right - n.left, d)
                    : di(l, t.left + c.placed, o, u, d),
                (c.start = o),
                (c.placed += u),
                (o = l.bottom));
        } else {
            let u = t.h * h,
                d = c.size || l.width;
            (Ie(c.start) && (r = c.start),
                l.fullSize
                    ? di(l, r, n.top, d, e.outerHeight - n.bottom - n.top)
                    : di(l, r, t.top + c.placed, d, u),
                (c.start = r),
                (c.placed += u),
                (r = l.right));
        }
...
var ot = {
        ...
        update(s, t, e, i) {
            ...
            (Ss(a.fullSize, f, u, g),
                ...
                Mu(f),
                Bo(a.leftAndTop, f, u, g),
                (f.x += f.w),
                (f.y += f.h),
                Bo(a.rightAndBottom, f, u, g),
                (s.chartArea = {
                    left: f.left,
                    top: f.top,
                    right: f.left + f.w,
...
function Iu(s, t, e) {
    let i = s.canvas,
        n = new MutationObserver((r) => {
            let o = !1;
            for (let a of r) ((o = o || ki(a.addedNodes, i)), (o = o && !ki(a.removedNodes, i)));
            o && e();
        });
...
function Eu(s, t, e) {
    let i = s.canvas,
        n = new MutationObserver((r) => {
            let o = !1;
            for (let a of r) ((o = o || ki(a.removedNodes, i)), (o = o && !ki(a.addedNodes, i)));
            o && e();
        });
    return (n.observe(document, { childList: !0, subtree: !0 }), n);
}
...
var jn = class extends wi {
    ...
    addEventListener(t, e, i) {
        ...
        let n = t.$proxies || (t.$proxies = {}),
            o = { attach: Iu, detach: Eu, resize: Ru }[e] || Nu;
        n[e] = o(t, e, i);
    }
...
function Vu(s, t) {
    let e = s.options.ticks,
        ...
        r = e.major.enabled ? Hu(t) : [],
        o = r.length,
        a = r[0],
        l = r[o - 1],
        c = [];
    if (o > n) return ($u(t, c, r, o / n), c);
    let h = Bu(r, t, n);
    if (o > 0) {
        let u,
            d,
            f = o > 1 ? Math.round((l - a) / (o - 1)) : null;
        for (fi(t, c, h, I(f) ? 0 : a - f, a), u = 0, d = o - 1; u < d; u++)
            fi(t, c, h, r[u], r[u + 1]);
...
var Uu = (s) => (s === 'left' ? 'right' : s === 'right' ? 'left' : s),
    jo = (s, t, e) => (t === 'top' || t === 'left' ? s[t] + e : s[t] - e),
    Uo = (s, t) => Math.min(t || s, s);
function Yo(s, t) {
    let e = [],
        i = s.length / t,
        n = s.length,
...
function Ju(s, t, e, i) {
    ...
    if (s.isHorizontal()) {
        ...
        } else e === 'center' ? (g = (c.bottom + c.top) / 2 + m - t) : (g = jo(s, e, t));
        d = a - r;
    } else {
        if (E(e)) {
            let b = Object.keys(e)[0],
        ...
        } else e === 'center' ? (f = (c.left + c.right) / 2 - p + t) : (f = jo(s, e, t));
        ((g = it(i, o, n)), (u = e === 'left' ? -q : q));
    }
...
var _e = class s extends dt {
        ...
        update(t, e, i) {
            ...
            (this.beforeUpdate(),
                ...
                this._dataLimitsCached ||
                    ...
                    (this._range = bo(this, r, n)),
                    (this._dataLimitsCached = !0)),
                this.beforeBuildTicks(),
                (this.ticks = this.buildTicks() || []),
                this.afterBuildTicks());
            let l = a < this.ticks.length;
            (this._convertTicksToLabels(l ? Yo(this.ticks, a) : this.ticks),
                this.configure(),
        ...
        calculateLabelRotation() {
            let t = this.options,
                e = t.ticks,
                i = Uo(this.ticks.length, t.ticks.maxTicksLimit),
                n = e.minRotation || 0,
                r = e.maxRotation,
                o = n,
                a,
            ...
            ((a = t.offset ? this.maxWidth / i : f / (i - 1)),
                u + 6 > a &&
                    ...
                    (l =
                        ...
                        ws(t.grid) -
                        e.padding -
                        Zo(t.title, this.chart.options.font)),
                    (c = Math.sqrt(u * u + d * d)),
                    (o = si(
                        Math.min(
        ...
        fit() {
            let t = { width: 0, height: 0 },
                ...
                a = this.isHorizontal();
            if (o) {
                let l = Zo(n, e.options.font);
                if (
                    (a
                        ? ((t.width = this.maxWidth), (t.height = ws(r) + l))
                        : ((t.height = this.maxHeight), (t.width = ws(r) + l)),
        ...
        getPixelForDecimal(t) {
            ...
            return ro(this._alignToPixels ? Jt(this.chart, e, 0) : e);
        }
        ...
        _computeGridLineItems(t) {
            ...
            if (o === 'top')
                ...
                ((A = t.top), (et = t.bottom), (S = y + p), (O = S + d));
            } else if (e === 'y') {
        ...
        _computeLabelItems(t) {
            let e = this.axis,
                ...
                L,
                et = 'middle';
            if (n === 'top') ((v = this.bottom - g), (S = this._getXAxisLabelAlignment()));
            else if (n === 'bottom') ((v = this.top + g), (S = this._getXAxisLabelAlignment()));
            else if (n === 'left') {
        ...
        drawBorder() {
            ...
            let a = n.setContext(this.getContext(0)).lineWidth,
                ...
                d;
            (this.isHorizontal()
                ? ((c = Jt(t, this.left, o) - o / 2),
                  (h = Jt(t, this.right, a) + a / 2),
                  (u = d = l))
                : ((u = Jt(t, this.top, o) - o / 2),
        ...
        drawTitle() {
            ...
            e === 'bottom' || e === 'center' || E(e)
                ? ((l += o.bottom), H(i.text) && (l += r.lineHeight * (i.text.length - 1)))
                : (l += o.top);
    ...
    Ye = class {
        ...
        register(t) {
            ...
            return (
                r in n || ((n[r] = t), Ku(t, o, i), this.override && j.override(t.id, t.overrides)),
                o
            );
        }
        get(t) {
...
function ed(s) {
    ...
    for (let r = 0; r < i.length; r++) e.push(Et.getPlugin(i[r]));
    let n = s.plugins || [];
...
function id(s, { plugins: t, localIds: e }, i, n) {
    ...
    for (let a of t) {
        let l = a.id,
            c = sd(i[l], n);
        c !== null &&
            r.push({ plugin: a, options: nd(s.config, { plugin: a, local: e[l] }, c, o) });
    }
    return r;
}
...
function qn(s, ...t) {
    if (qo(s)) return s;
    for (let e of t) {
        let i = e.axis || ad(e.position) || (s.length > 1 && qo(s[0].toLowerCase()));
        if (i) return i;
    }
    throw new Error(
...
function ld(s, t) {
    if (t.data && t.data.datasets) {
        ...
        if (e.length) return Go(s, 'x', e[0]) || Go(s, 'y', e[0]);
    }
    return {};
}
function cd(s, t) {
    ...
    return (
        Object.keys(i).forEach((o) => {
            ...
            let l = qn(o, a, ld(o, s), j.scales[a.type]),
                c = od(l, n),
                h = e.scales || {};
            r[o] = Ae(Object.create(null), [{ axis: l }, a, h[l], h[c]]);
        }),
        s.data.datasets.forEach((o) => {
            let a = o.type || s.type,
                l = o.indexAxis || Zn(a, t),
                h = (Xt[a] || {}).scales || {};
            Object.keys(h).forEach((u) => {
                let d = rd(u, l),
                    f = o[d + 'AxisID'] || d;
                ((r[f] = r[f] || Object.create(null)), Ae(r[f], [{ axis: d }, i[f], h[u]]));
            });
        }),
        Object.keys(r).forEach((o) => {
            let a = r[o];
            Ae(a, [j.scales[a.type], j.scale]);
        }),
        r
    );
}
...
function gi(s, t) {
    let e = Xo.get(s);
    return (e || ((e = t()), Xo.set(s, e), Ra.add(e)), e);
}
var ks = (s, t, e) => {
        let i = Vt(t, e);
        i !== void 0 && s.add(i);
    ...
    Gn = class {
        ...
        getOptionScopes(t, e, i) {
            ...
            e.forEach((h) => {
                (t && (l.add(t), h.forEach((u) => ks(l, t, u))),
                    ...
                    h.forEach((u) => ks(l, Xt[r] || {}, u)),
                    h.forEach((u) => ks(l, j, u)),
                    h.forEach((u) => ks(l, ri, u)));
            });
            let c = Array.from(l);
            return (c.length === 0 && c.push(Object.create(null)), Ra.has(e) && o.set(e, c), c);
        }
        chartOptionScopes() {
            let { options: t, type: e } = this;
            return [t, Xt[e] || {}, j.datasets[e] || {}, { type: e }, j, ri];
        }
        resolveNamedOptions(t, e, i, n = ['']) {
            let r = { $shared: !0 },
                { resolver: o, subPrefixes: a } = Jo(this._resolverCache, t, n),
                l = o;
            if (dd(o, e)) {
                ((r.$shared = !1), (i = Nt(i) ? i() : i));
        ...
        createResolver(t, e, i = [''], n) {
            let { resolver: r } = Jo(this._resolverCache, t, i);
            return E(e) ? ue(r, e, void 0, n) : r;
        }
    };
function Jo(s, t, e) {
    let i = s.get(t);
...
var ud = (s) => E(s) && Object.getOwnPropertyNames(s).some((t) => Nt(s[t]));
function dd(s, t) {
...
var yt = class {
        ...
        (e &&
            ...
            z(r, (o) => {
                let a = o.options,
                    ...
                    c = qn(l, a),
                    h = P(a.type, o.dtype);
                ((a.position === void 0 || Ko(a.position, c) !== Ko(o.dposition)) &&
    ...
    buildOrUpdateControllers() {
        ...
        for (this._removeUnreferencedMetasets(), i = 0, n = e.length; i < n; i++) {
            ...
            if (
                ...
                (o.type = a),
                (o.indexAxis = r.indexAxis || Zn(a, this.options)),
                (o.order = r.order || 0),
                (o.index = i),
                (o.label = '' + r.label),
    ...
    _getUniformDataChanges() {
        ...
        let e = this.data.datasets.length,
            ...
            n = i(0);
        for (let r = 1; r < e; r++) if (!en(n, i(r))) return;
        return Array.from(n)
            .map((r) => r.split(','))
    ...
    _updateDatasets(t) {
        if (this.notifyPlugins('beforeDatasetsUpdate', { mode: t, cancelable: !0 }) !== !1) {
            ...
            for (let e = 0, i = this.data.datasets.length; e < i; ++e)
                this._updateDataset(e, Nt(t) ? t({ datasetIndex: e }) : t);
...
function vi(s, t, e, i, n, r) {
    ...
    let m = Math.max(0.001, g * u - e / F) / u,
        ...
        b = l + p + f,
        y = n - p - f,
        { outerStart: _, outerEnd: w, innerStart: x, innerEnd: v } = wd(t, d, u, y - b),
        S = u - _,
        M = u - w,
        O = b + _ / S,
        C = y - w / M,
    ...
    if ((s.beginPath(), r)) {
        let V = (O + C) / 2;
        if ((s.arc(o, a, u, O, V), s.arc(o, a, u, V, C), w > 0)) {
            let rt = ze(M, C, o, a);
            s.arc(rt.x, rt.y, w, C, y + q);
        }
        let U = ze(L, y, o, a);
        if ((s.lineTo(U.x, U.y), v > 0)) {
            let rt = ze(L, ht, o, a);
            s.arc(rt.x, rt.y, v, y + q, ht + Math.PI);
        }
        let G = (y - v / d + (b + x / d)) / 2;
        if ((s.arc(o, a, d, y - v / d, G, !0), s.arc(o, a, d, G, b + x / d, !0), x > 0)) {
            let rt = ze(A, et, o, a);
            s.arc(rt.x, rt.y, x, et + Math.PI, b - q);
        }
        let vt = ze(S, b, o, a);
...
function vd(s, t, e, i, n) {
    ...
    (g && xd(s, t, m),
        l.selfJoin && m - o >= F && f === 0 && h !== 'miter' && yd(s, t, m),
        r || (vi(s, t, e, i, m, n), s.stroke()));
}
var pe = class extends dt {
    ...
    inRange(e, i, n) {
        let r = this.getProps(['x', 'y'], n),
            { angle: o, distance: a } = on(r, { x: e, y: i }),
            {
                startAngle: l,
                endAngle: c,
                innerRadius: h,
...
(k(pe, 'id', 'arc'),
    ...
    k(pe, 'descriptors', { _scriptable: !0, _indexable: (e) => e !== 'borderDash' }));
function za(s, t, e = t) {
...
function Md(s) {
    return s.stepped ? mo : s.tension || s.cubicInterpolationMode === 'monotone' ? po : Sd;
}
function Va(s, t, e = {}) {
    let i = s.length,
...
function Td(s, t, e, i) {
    let { points: n, options: r } = t,
        { count: o, start: a, loop: l, ilen: c } = Va(n, e, i),
        h = Md(r),
...
function Od(s, t, e, i) {
    let n = t.points,
        { count: r, start: o, ilen: a } = Va(n, e, i),
...
function Dd(s) {
    return s.stepped ? Mo : s.tension || s.cubicInterpolationMode === 'monotone' ? To : qt;
}
function Cd(s, t, e, i) {
    let n = t._path;
...
var Lt = class extends dt {
    ...
    updateControlPoints(t, e) {
        ...
        if (
            ...
            (ko(this._points, i, t, n, e), (this._pointsUpdated = !0));
        }
    }
    set points(t) {
    ...
    get segments() {
        return this._segments || (this._segments = Do(this, this.options.segment));
    }
    first() {
        let t = this.segments,
            e = this.points;
    ...
    interpolate(t, e) {
        let i = this.options,
            n = t[e],
            r = this.points,
            o = On(this, { property: e, start: n, end: n });
        if (!o.length) return;
        let a = [],
            l = Dd(i),
            c,
    ...
    draw(t, e, i, n) {
        let r = this.options || {};
        ((this.points || []).length && r.borderWidth && (t.save(), Id(t, this, i, n), t.restore()),
...
(k(Lt, 'id', 'line'),
    ...
    k(Lt, 'defaultRoutes', { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }),
    k(Lt, 'descriptors', {
        _scriptable: !0,
...
(k(je, 'id', 'point'),
    ...
    k(je, 'defaultRoutes', { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }));
function Wa(s, t) {
    let {
            x: e,
            y: i,
...
function Ed(s, t, e) {
    let i = s.options.borderWidth,
        ...
        r = bn(i);
    return {
        t: ee(n.top, r.top, 0, e),
        r: ee(n.right, r.right, 0, t),
        b: ee(n.bottom, r.bottom, 0, e),
        l: ee(n.left, r.left, 0, t),
    };
}
function Ld(s, t, e) {
    let { enableBorderRadius: i } = s.getProps(['enableBorderRadius']),
        ...
        l = i || E(n);
    return {
        topLeft: ee(!l || a.top || a.left, r.topLeft, 0, o),
        topRight: ee(!l || a.top || a.right, r.topRight, 0, o),
        bottomLeft: ee(!l || a.bottom || a.left, r.bottomLeft, 0, o),
        bottomRight: ee(!l || a.bottom || a.right, r.bottomRight, 0, o),
    };
}
function Fd(s) {
    let t = Wa(s),
...
(k(Ue, 'id', 'bar'),
    ...
    k(Ue, 'defaultRoutes', { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }));
...
function Hd(s) {
    ...
    return (e, i) => {
        ...
        n instanceof $t ? (t = Wd(e, t)) : n instanceof ye ? (t = Bd(e, t)) : n && (t = Vd(e, t));
    };
}
function ra(s) {
    let t;
...
function qd(s, t) {
    ...
    return (
        l && (i = K(Dt(t, r.axis, o).lo, 0, e - 1)),
        c ? (n = K(Dt(t, r.axis, a).hi + 1, i, e) - i) : (n = e - i),
        { start: i, count: n }
    );
}
var Gd = {
    ...
    beforeElementsUpdate: (s, t, e) => {
        ...
        s.data.datasets.forEach((n, r) => {
            let { _data: o, indexAxis: a } = n,
                ...
                c = o || n.data;
            if (Ne([a, s.options.indexAxis]) === 'y' || !l.controller.supportsDecimation) return;
...
function Xd(s, t, e) {
    ...
    for (let a of i) {
        ...
        let u = On(t, h);
        for (let d of u) {
            let f = Kn(e, r[d.start], r[d.end], d.loop),
                g = Tn(a, n, f);
            for (let m of g)
                o.push({
                    source: m,
...
function Kn(s, t, e, i) {
    ...
    let n = t[s],
        r = e[s];
    return (s === 'angle' && ((n = st(n)), (r = st(r))), { property: s, start: n, end: r });
}
function Jd(s, t) {
...
function rf(s) {
    ...
    for (let l = 0; l < r.length; l++) {
        let c = r[l];
        for (let h = c.start; h <= c.end; h++) af(n, o[h], a);
    }
...
function af(s, t, e) {
    ...
    for (let n = 0; n < e.length; n++) {
        let r = e[n],
            { first: o, last: a, point: l } = lf(r, t, 'x');
        if (!(!l || (o && a))) {
            if (o) i.unshift(l);
...
var Si = class {
    ...
    pathSegment(t, e, i) {
        ...
        return ((e = e || { start: 0, end: $ }), t.arc(n, r, o, e.end, e.start, !0), !i.bounds);
    }
    interpolate(t) {
...
function ff(s) {
    ...
    if (i.grid.circular) {
        ...
        return new Si({ x: l.x, y: l.y, radius: t.getDistanceFromCenterForValue(o) });
    }
...
function zn(s, t, e) {
    ...
    i &&
        o.points.length &&
        (ps(s, e),
        gf(s, { line: o, target: i, above: d, below: f, area: e, scale: a, axis: l, clip: m }),
        bs(s));
}
function gf(s, t) {
    ...
    (r !== n &&
        (c === 'x'
            ...
            : c === 'y' &&
              (ha(s, i, o.left),
              Vn(s, { line: e, target: i, color: r, scale: a, property: c, clip: l }),
              s.restore(),
              s.save(),
              ha(s, i, o.right),
              (h = n))),
...
function Vn(s, t) {
    ...
    for (let { source: c, target: h, start: u, end: d } of l) {
        let { style: { backgroundColor: f = r } = {} } = c,
            g = i !== !0;
        (s.save(), (s.fillStyle = f), mf(s, o, a, g && Kn(n, u, d)), s.beginPath());
        ...
        afterDatasetsUpdate(s, t, e) {
            ...
            for (o = 0; o < i; ++o)
                ((r = s.getDatasetMeta(o)),
                    ...
                    n.push(l));
            for (o = 0; o < i; ++o)
                ((l = n[o]), !(!l || l.fill === !1) && (l.fill = Kd(n, o, e.propagate)));
        },
        beforeDraw(s, t, e) {
            ...
            for (let o = n.length - 1; o >= 0; --o) {
                let a = n[o].$filler;
                a && (a.line.updateControlPoints(r, a.axis), i && a.fill && zn(s.ctx, a, r));
            }
        },
    ...
    Mi = class extends dt {
        ...
        fit() {
            ...
            let i = t.labels,
                ...
                { boxWidth: a, itemHeight: l } = da(i, r),
                c,
                h;
            ((e.font = n.string),
                this.isHorizontal()
        ...
        _fitCols(t, e, i, n) {
            ...
            return (
                this.legendItems.forEach((p, b) => {
                    let { itemWidth: y, itemHeight: _ } = yf(i, e, r, p, n);
                    (b > 0 &&
                        f + _ + 2 * a > h &&
                        ((u += d + a),
        ...
        _draw() {
            ...
            (this.drawTitle(),
                ...
                (n.lineWidth = 0.5),
                (n.font = c.string));
            let { boxWidth: g, boxHeight: m, itemHeight: p } = da(o, u),
                b = function (v, S, M) {
                    ...
                    if (
                        ...
                        let C = {
                            ...
                            A = l.xPlus(v, g / 2),
                            L = S + d;
                        pn(n, C, A, L, o.pointStyleWidth && g);
                    } else {
            ...
            (_
                ? (f = { x: it(r, this.left + h, this.right - i[0]), y: this.top + h + w, line: 0 })
                : (f = {
                      x: this.left + h,
                      y: it(r, this.top + w + h, this.bottom - e[0].height),
                      line: 0,
                  }),
            ...
            (this.legendItems.forEach((v, S) => {
                ...
                let M = n.measureText(v.text).width,
                    O = l.textAlign(v.textAlign || (v.textAlign = o.textAlign)),
                    C = g + d + M,
                    A = f.x,
                    L = f.y;
                (l.setWidth(this.width),
                    _
                        ? S > 0 &&
                          ...
                          ((L = f.y += x),
                          f.line++,
                          (A = f.x = it(r, this.left + h, this.right - i[f.line])))
                        : S > 0 &&
                          L + x > this.bottom &&
                          ((A = f.x = A + e[f.line].width + h),
                          f.line++,
                          (L = f.y = it(r, this.top + w + h, this.bottom - e[f.line].height))));
                let et = l.x(A);
                if (
                    (b(et, L, v),
                    (A = uo(O, A + g + d, _ ? A + C : this.right, t.rtl)),
                    y(l.x(A), L, v),
                    _)
                )
                    f.x += C + h;
        ...
        drawTitle() {
            let t = this.options,
                ...
                n = nt(e.padding);
            if (!e.display) return;
            let r = fe(t.rtl, this.left, this.width),
                o = this.ctx,
                a = e.position,
                l = i.size / 2,
                c = n.top + l,
...
var kf = {
    ...
    Is = class extends dt {
        ...
        _drawArgs(t) {
            ...
            return (
                this.isHorizontal()
                    ? ((h = it(a, i, r)), (u = e + t), (c = r - i))
                    : (o.position === 'left'
                          ? ((h = i + t), (u = it(a, n, e)), (l = F * -0.5))
                          : ((h = r - t), (u = it(a, e, n)), (l = F * 0.5)),
                      (c = n - e)),
...
var Sf = {
    ...
    Mf = {
        ...
        start(s, t, e) {
            ...
            (ot.configure(s, i, e), ot.addBox(s, i), mi.set(s, i));
        },
        stop(s) {
            (ot.removeBox(s, mi.get(s)), mi.delete(s));
        },
        beforeUpdate(s, t, e) {
            let i = mi.get(s);
            (ot.configure(s, i, e), (i.options = e));
...
function ga(s, t, e) {
    let i = e.yAlign || t.yAlign || Of(s, e);
...
function ma(s, t, e, i) {
    let { caretSize: n, caretPadding: r, cornerRadius: o } = s,
        { xAlign: a, yAlign: l } = e,
        c = n + r,
        { topLeft: h, topRight: u, bottomLeft: d, bottomRight: f } = Qt(o),
        g = Pf(t, a),
        m = Af(t, l, c);
    return (
        l === 'center'
...
var Ps = class extends dt {
    ...
    getTitle(t, e) {
        let { callbacks: i } = e,
            ...
            a = [];
        return ((a = It(a, Ht(n))), (a = It(a, Ht(r))), (a = It(a, Ht(o))), a);
    }
    getBeforeBody(t, e) {
        ...
        return (
            z(t, (r) => {
                let o = { before: [], lines: [], after: [] },
                    a = ba(i, r);
                (It(o.before, Ht(lt(a, 'beforeLabel', this, r))),
                    It(o.lines, lt(a, 'label', this, r)),
                    It(o.after, Ht(lt(a, 'afterLabel', this, r))),
                    n.push(o));
            }),
            n
        );
    ...
    drawBody(t, e, i) {
        ...
        ((f = 0), (d = u.lineHeight), z(this.afterBody, m), (t.y -= r));
    }
    drawFooter(t, e, i) {
        let n = this.footer,
            r = n.length,
    ...
    drawBackground(t, e, i, n) {
        let { xAlign: r, yAlign: o } = this,
            { x: a, y: l } = t,
            { width: c, height: h } = i,
            { topLeft: u, topRight: d, bottomLeft: f, bottomRight: g } = Qt(n.cornerRadius);
        ((e.fillStyle = n.backgroundColor),
            (e.strokeStyle = n.borderColor),
            (e.lineWidth = n.borderWidth),
            e.beginPath(),
    ...
    _updateAnimationTarget(t) {
        let e = this.chart,
            ...
            r = i && i.y;
        if (n || r) {
            let o = Ms[t.position].call(this, this._active, this._eventPosition);
            if (!o) return;
...
(k(Ts, 'id', 'category'), k(Ts, 'defaults', { ticks: { callback: ya } }));
function zf(s, t) {
    let e = [],
        {
            bounds: n,
    ...
    ((O = Math.ceil(p / x) - Math.floor(m / x)),
        ...
        n === 'ticks'
            ...
            : ((S = m), (M = p)),
        b && y && r && no((a - o) / r, x / 1e3)
            ? ((O = Math.round(Math.min((a - o) / x, h))), (x = (a - o) / O), (S = o), (M = a))
            : _
              ? ((S = b ? o : S), (M = y ? a : M), (O = c - 1), (x = (M - S) / O))
              : ((O = (M - S) / x),
                Ee(O, Math.round(O), x / 1e3) ? (O = Math.round(O)) : (O = Math.ceil(O))));
    let C = Math.max(rn(x), rn(S));
    ((v = Math.pow(10, I(l) ? C : l)), (S = Math.round(S * v) / v), (M = Math.round(M * v) / v));
    let A = 0;
    for (
        b &&
        (d && S !== o
            ? (e.push({ value: o }),
              S < o && A++,
              Ee(Math.round((S + A * x) * v) / v, o, xa(o, w, s)) && A++)
            : S < o && A++);
        A < O;
        ++A
    ) {
    ...
    return (
        y && d && M !== a
            ? e.length && Ee(e[e.length - 1].value, a, xa(a, w, s))
...
var Ze = class extends _e {
        ...
        buildTicks() {
            ...
            let n = {
                ...
                o = zf(n, r);
            return (
                t.bounds === 'ticks' && nn(o, this, 'value'),
                t.reverse
...
(k(Os, 'id', 'linear'), k(Os, 'defaults', { ticks: { callback: ms.formatters.numeric } }));
var Es = (s) => Math.floor(zt(s)),
    me = (s, t) => Math.pow(10, Es(s) + t);
function _a(s) {
...
var Ds = class extends _e {
    ...
    handleTickRangeOptions() {
        let { minDefined: t, maxDefined: e } = this.getUserBounds(),
            ...
            r = (a) => (i = t ? i : a),
            o = (a) => (n = e ? n : a);
        (i === n && (i <= 0 ? (r(1), o(10)) : (r(me(i, -1)), o(me(n, 1)))),
            i <= 0 && r(me(n, -1)),
            n <= 0 && o(me(i, 1)),
            (this.min = i),
            (this.max = n));
    ...
    getLabelForValue(t) {
        return t === void 0 ? '0' : Fe(t, this.chart.options.locale, this.options.ticks.format);
    }
    configure() {
        let t = this.min;
...
(k(Ds, 'id', 'logarithmic'),
    k(Ds, 'defaults', { ticks: { callback: ms.formatters.logarithmic, major: { enabled: !0 } } }));
function Qn(s) {
    let t = s.ticks;
...
function Bf(s, t, e) {
    return ((e = H(e) ? e : [e]), { w: go(s, t.string, e), h: e.length * t.lineHeight });
}
...
function Yf(s, t, e) {
    let i = [],
        ...
        l = { extra: Qn(r) / 2, additionalAngle: o ? F / n : 0 },
        c;
    for (let h = 0; h < n; h++) {
...
function Qf(s, t, e) {
    return Wt(s, { label: e, index: t, type: 'pointLabel' });
}
var be = class extends Ze {
    ...
    drawGrid() {
        let t = this.ctx,
            ...
            c;
        if (
            (e.pointLabels.display && Jf(this, o),
            n.display &&
...
function Sa(s, t) {
    ...
    return (
        ...
        Z(o) || (o = typeof i == 'string' ? e.parse(o, i) : e.parse(o)),
        o === null
            ? null
            : (n &&
                  (o =
...
function tg(s, t, e, i, n) {
    for (let r = ct.length - 1; r >= ct.indexOf(e); r--) {
        let o = ct[r];
        if (Oi[o].common && s._adapter.diff(n, i, o) >= t - 1) return o;
    }
    return ct[e ? ct.indexOf(e) : 0];
}
function eg(s) {
    for (let t = ct.indexOf(s) + 1, e = ct.length; t < e; ++t) if (Oi[ct[t]].common) return ct[t];
}
function Ta(s, t, e) {
    if (!e) s[t] = !0;
    else if (e.length) {
...
var xe = class extends _e {
    ...
    determineDataLimits() {
        ...
        ((!o || !a) &&
            ...
            (r = Z(r) && !isNaN(r) ? r : +e.endOf(Date.now(), i) + 1),
    ...
    _generate() {
        let t = this._adapter,
            ...
            n = this.options,
            r = n.time,
            o = r.unit || Ma(r.minUnit, e, i, this._getLabelCapacity(e)),
        ...
        for (d = u, f = 0; d < i; d = +t.add(d, a, o), f++) Ta(h, d, g);
        return (
    ...
    _getLabelCapacity(t) {
        let e = this.options.time,
            ...
            r = this._tickFormatFunction(t, 0, Oa(this, [t], this._majorUnit), n),
...
(k(Cs, 'id', 'timeseries'), k(Cs, 'defaults', xe.defaults));
...
var Ut = class extends Error {},
    ...
    Ot = 'short',
    mt = 'long',
    Ri = { year: T, month: T, day: T },
    Ml = { year: T, month: Ot, day: T },
    ng = { year: T, month: Ot, day: T, weekday: Ot },
    Tl = { year: T, month: mt, day: T },
    Ol = { year: T, month: mt, day: T, weekday: mt },
    Dl = { hour: T, minute: T },
    Cl = { hour: T, minute: T, second: T },
    Pl = { hour: T, minute: T, second: T, timeZoneName: Ot },
    Al = { hour: T, minute: T, second: T, timeZoneName: mt },
    Il = { hour: T, minute: T, hourCycle: 'h23' },
    El = { hour: T, minute: T, second: T, hourCycle: 'h23' },
    Ll = { hour: T, minute: T, second: T, hourCycle: 'h23', timeZoneName: Ot },
    Fl = { hour: T, minute: T, second: T, hourCycle: 'h23', timeZoneName: mt },
    Rl = { year: T, month: T, day: T, hour: T, minute: T },
    Nl = { year: T, month: T, day: T, hour: T, minute: T, second: T },
    zl = { year: T, month: Ot, day: T, hour: T, minute: T },
    Vl = { year: T, month: Ot, day: T, hour: T, minute: T, second: T },
    rg = { year: T, month: Ot, day: T, weekday: Ot, hour: T, minute: T },
    Wl = { year: T, month: mt, day: T, hour: T, minute: T, timeZoneName: Ot },
    Bl = { year: T, month: mt, day: T, hour: T, minute: T, second: T, timeZoneName: Ot },
    Hl = { year: T, month: mt, day: T, weekday: mt, hour: T, minute: T, timeZoneName: mt },
    $l = {
        year: T,
        month: mt,
        day: T,
...
var sr = new Map(),
    oe = class s extends Se {
        static create(t) {
            let e = sr.get(t);
            return (e === void 0 && sr.set(t, (e = new s(t))), e);
        }
        static resetCache() {
            (sr.clear(), fr.clear());
        }
        ...
        offset(t) {
            ...
            let i = og(this.name),
                [n, r, o, a, l, c, h] = i.formatToParts ? cg(i, e) : lg(i, e);
            a === 'BC' && (n = -Math.abs(n) + 1);
            let d = $i({
                    year: n,
                    month: r,
...
function mr(s, t = {}) {
    let e = JSON.stringify([s, t]),
        i = gr.get(e);
    return (i === void 0 && ((i = new Intl.DateTimeFormat(s, t)), gr.set(e, i)), i);
}
var pr = new Map();
function ug(s, t = {}) {
    let e = JSON.stringify([s, t]),
        i = pr.get(e);
    return (i === void 0 && ((i = new Intl.NumberFormat(s, t)), pr.set(e, i)), i);
}
var br = new Map();
function dg(s, t = {}) {
    let { base: e, ...i } = t,
        ...
        r = br.get(n);
    return (r === void 0 && ((r = new Intl.RelativeTimeFormat(s, t)), br.set(n, r)), r);
}
var Rs = null;
function fg() {
...
function jl(s) {
    let t = yr.get(s);
    return (t === void 0 && ((t = new Intl.DateTimeFormat(s).resolvedOptions()), yr.set(s, t)), t);
}
var xr = new Map();
function gg(s) {
    let t = xr.get(s);
...
function mg(s) {
    ...
    if (e === -1) return [s];
    {
        let i, n;
        try {
            ((i = mr(s).resolvedOptions()), (n = s));
        } catch {
            let l = s.substring(0, e);
            ((i = mr(l).resolvedOptions()), (n = l));
        }
...
var _r = class {
        ...
        format(t) {
            if (this.inf) {
                ...
                let e = this.floor ? Math.floor(t) : Ir(t, 3);
                ...
                t.zone.type === 'system'
                    ...
                    : t.zone.type === 'iana'
                      ...
                      : ((n = 'UTC'),
                        ...
                        (this.originalZone = t.zone));
            let r = { ...this.opts };
            ((r.timeZone = r.timeZone || n), (this.dtf = mr(e, r)));
        }
        format() {
    ...
    B = class s {
        ...
        static create(t, e, i, n, r = !1) {
            let o = t || Y.defaultLocale,
                a = o || (r ? 'en-US' : fg()),
                l = e || Y.defaultNumberingSystem,
                c = i || Y.defaultOutputCalendar,
                h = Mr(n) || Y.defaultWeekSettings;
            return new s(a, l, c, h, o);
        }
        static resetCache() {
            ((Rs = null), gr.clear(), pr.clear(), br.clear(), yr.clear(), xr.clear());
        }
        static fromObject({
            locale: t,
            numberingSystem: e,
        ...
        clone(t) {
            return !t || Object.getOwnPropertyNames(t).length === 0
                ...
                : s.create(
                      ...
                      Mr(t.weekSettings) || this.weekSettings,
                      t.defaultToEN || !1,
                  );
        }
        redefaultToEN(t = {}) {
            ...
            return Di(this, t, oc, () => {
                ...
                return (
                    this.weekdaysCache[n][t] ||
                        (this.weekdaysCache[n][t] = yg((r) => this.extract(r, i, 'weekday'))),
                    this.weekdaysCache[n][t]
                );
            });
        }
        ...
        numberFormatter(t = {}) {
            return new _r(this.intl, t.forceSimple || this.fastNumbers, t);
        }
        dtFormatter(t, e = {}) {
            return new wr(t, this.intl, e);
        }
        relFormatter(t = {}) {
            return new kr(this.intl, this.isEnglish(), t);
        }
        listFormatter(t = {}) {
    ...
    if (Mg(s)) {
        ...
        return e === 'default'
            ...
            : e === 'local' || e === 'system'
              ...
              : e === 'utc' || e === 'gmt'
                ? kt.utcInstance
                : kt.parseSpecifier(e) || oe.create(s);
    } else
        return re(s)
            ? kt.instance(s)
...
function wg(s) {
    ...
    if (isNaN(t)) {
        ...
        for (let e = 0; e < s.length; e++) {
            ...
            if (s[e].search(Dr.hanidec) !== -1) t += _g.indexOf(s[e]);
            else
                for (let n in Xa) {
                    let [r, o] = Xa[n];
                    i >= r && i <= o && (t += i - r);
...
function Mt({ numberingSystem: s }, t = '') {
    let e = s || 'latn',
        i = Sr.get(e);
    i === void 0 && ((i = new Map()), Sr.set(e, i));
    let n = i.get(t);
    return (n === void 0 && ((n = new RegExp(`${Dr[e]}${t}`)), i.set(t, n)), n);
}
var Ja = () => Date.now(),
    Ka = 'system',
    Qa = null,
    ...
    Y = class {
        ...
        static resetCaches() {
            (B.resetCache(), oe.resetCache(), R.resetCache(), kg());
        }
    },
    gt = class {
        constructor(t, e) {
...
function al(s, t) {
    if (!D(s.localWeekday) || !D(s.localWeekNumber) || !D(s.localWeekYear)) {
        if (!D(s.weekday) || !D(s.weekNumber) || !D(s.weekYear))
            throw new ne('Cannot mix locale-based week fields with ISO-based week fields');
        return (
                ...
                o = (f) =>
                    t.isOffsetFixed && t.offset === 0 && f.allowZ
                        ...
                        : t.isValid
                          ...
                          : '',
                a = () => (i ? Rg(t) : r({ hour: 'numeric', hourCycle: 'h12' }, 'dayperiod')),
                l = (f, g) =>
                    i ? zg(t, f) : r(g ? { month: f } : { month: f, day: 'numeric' }, 'month'),
                c = (f, g) =>
                    i
                        ? Ng(t, f)
                        : r(
...
var uc = /(?:([Zz])|([+-]\d\d)(?::?(\d\d))?)/,
    ...
    Er = /(\d\d)(?::?(\d\d)(?::?(\d\d)(?:[.,](\d{1,30}))?)?)?/,
    dc = RegExp(`${Er.source}${Hg}`),
    Lr = RegExp(`(?:[Tt]${dc.source})?`),
    $g = /([+-]\d{6}|\d{4})(?:-?(\d\d)(?:-?(\d\d))?)?/,
    jg = /(\d{4})-?W(\d\d)(?:-?(\d))?/,
    Ug = /(\d{4})-?(\d{3})/,
    ...
    Zg = hc('year', 'ordinal'),
    qg = /(\d{4})-(\d\d)-(\d\d)/,
    fc = RegExp(`${Er.source} ?(?:${uc.source}|(${cc.source}))?`),
    Gg = RegExp(`(?: ${fc.source})?`);
function ts(s, t, e) {
    let i = s[t];
    return D(i) ? e : se(i);
...
function $s(s, t) {
    let e = s[t] ? oe.create(s[t]) : null;
    return [{}, e, t + 1];
}
var Jg = RegExp(`^T?${Er.source}$`),
    Kg =
...
function Fr(s, t, e, i, n, r, o) {
    let a = {
        year: t.length === 2 ? Tr(se(t)) : se(t),
    ...
    return (
        o && (a.second = se(o)),
        s && (a.weekday = s.length > 3 ? nc.indexOf(s) + 1 : rc.indexOf(s) + 1),
        a
    );
}
var em =
...
function ul(s) {
    let [, t, e, i, n, r, o, a] = s;
    return [Fr(t, n, i, e, r, o, a), kt.utcInstance];
}
function am(s) {
    let [, t, e, i, n, r, o, a] = s;
    return [Fr(t, a, e, i, n, r, o), kt.utcInstance];
}
var lm = is($g, Lr),
    cm = is(jg, Lr),
    hm = is(Ug, Lr),
    ...
    gm = ns(os, Hs, $s);
function mm(s) {
    return rs(s, [lm, gc], [cm, dm], [hm, fm], [um, gm]);
}
function pm(s) {
    return rs(im(s), [em, sm]);
}
function bm(s) {
    return rs(s, [nm, ul], [rm, ul], [om, am]);
}
function ym(s) {
    return rs(s, [Kg, Qg]);
}
...
var tt = class s {
        ...
        static invalid(t, e = null) {
            ...
            if (Y.throwOnInvalid) throw new dr(i);
        ...
        toISO() {
            ...
            return (
                ...
                (this.seconds !== 0 || this.milliseconds !== 0) &&
                    (t += Ir(this.seconds + this.milliseconds / 1e3, 3) + 'S'),
                t === 'P' && (t += 'T0S'),
                t
            );
        }
        ...
        normalize() {
            if (!this.isValid) return this;
            let t = this.toObject();
            return (fl(this.matrix, t), jt(this, { values: t }, !0));
        }
        rescale() {
            if (!this.isValid) return this;
        ...
        shiftTo(...t) {
            ...
            return (fl(this.matrix, e), jt(this, { values: e }, !0));
        }
        shiftToAll() {
            return this.isValid
                ? this.shiftTo(
...
var es = class s {
        ...
        static invalid(t, e = null) {
            ...
            let i = t instanceof gt ? t : new gt(t, e);
            if (Y.throwOnInvalid) throw new ur(i);
            return new s({ invalid: i });
        }
    ...
    Ke = class {
        ...
        static months(
            ...
            return (n || B.create(e, i, r)).months(t);
        }
        static monthsFormat(
            t = 'long',
            {
            ...
            return (n || B.create(e, i, r)).months(t, !0);
        }
        static weekdays(
            t = 'long',
...
var rr = null;
function Bm() {
    return (rr || (rr = R.fromMillis(1555555555555)), rr);
}
function Hm(s, t) {
...
function $m(s, t, e) {
    let { result: i, zone: n, specificOffset: r, invalidReason: o } = _c(s, t, e);
    return [i, n, r, o];
}
function wc(s, t) {
    if (!s) return null;
...
function _l(s, t, e, i, n, r, o) {
    ...
    switch (o) {
        ...
        case 'year':
            break;
        default:
            if (((l += J(s.c.hour)), o === 'hour')) break;
            if (t) {
                if (((l += ':'), (l += J(s.c.minute)), o === 'minute')) break;
                a && ((l += ':'), (l += J(s.c.second)));
            } else {
                if (((l += J(s.c.minute)), o === 'minute')) break;
                a && (l += J(s.c.second));
            }
            if (o === 'second') break;
...
function qm(s) {
    ...
    let t = s.name,
        e = Or.get(t);
    return (e === void 0 && ((e = s.offset(zs)), Or.set(t, e)), e);
}
function kl(s, t) {
...
function vl(s, t, e) {
    let i = D(e.round) ? !0 : e.round,
        ...
        r = (a, l) => (
            (a = Ir(a, i || e.calendary ? 0 : 2, e.calendary ? 'round' : n)),
    ...
    R = class s {
        ...
        static utc() {
            ...
            return (
                ...
                kl({ year: i, month: n, day: r, hour: o, minute: a, second: l, millisecond: c }, t)
            );
        }
        ...
        static fromMillis(t, e = {}) {
            if (re(t))
                return t < -yl || t > yl
                    ...
                    : new s({ ts: t, zone: ie(e.zone, Y.defaultZone), loc: B.fromObject(e) });
            throw new Q(
        ...
        static fromObject(t, e = {}) {
            ...
            let n = B.fromObject(e),
                r = Wi(t, wl),
                { minDaysInFirstWeek: o, startOfWeek: a } = al(r, n),
                l = Y.now(),
            ...
            for (let C of p) {
                let A = r[C];
                D(A) ? (_ ? (r[C] = b[C]) : (r[C] = y[C])) : (_ = !0);
            }
            let w = m ? vg(r, o, a) : h ? Sg(r) : Xl(r),
                x = w || Jl(r);
            if (x) return s.invalid(x);
            let v = m ? rl(r, o, a) : h ? ol(r) : r,
                [S, M] = Ii(v, c, i),
                O = new s({ ts: S, zone: i, o: M, loc: n });
        ...
        static fromFormat(t, e, i = {}) {
            ...
            let { locale: n = null, numberingSystem: r = null } = i,
                o = B.fromOpts({ locale: n, numberingSystem: r, defaultToEN: !0 }),
                [a, l, c, h] = $m(o, t, e);
        ...
        static invalid(t, e = null) {
            ...
            let i = t instanceof gt ? t : new gt(t, e);
            if (Y.throwOnInvalid) throw new hr(i);
            return new s({ invalid: i });
        }
        static isDateTime(t) {
        ...
        get localWeekNumber() {
            return this.isValid ? lr(this).weekNumber : NaN;
        }
        get localWeekYear() {
        ...
        set(t) {
            ...
            if ((c || o) && h)
                throw new ne("Can't mix weekYear/weekNumber units with year/month/day or ordinals");
            if (l && o) throw new ne("Can't mix ordinal dates with month/day");
            let u;
            r
        ...
        toLocaleString(t = Ri, e = {}) {
            return this.isValid ? ft.create(this.loc.clone(e), t).formatDateTime(this) : or;
        }
        toLocaleParts(t = {}) {
        ...
        toISO({
            ...
            let a = t === 'extended',
                l = cr(this, a, o);
            return (Ei.indexOf(o) >= 3 && (l += 'T'), (l += _l(this, a, e, i, n, r, o)), l);
        }
        toISODate({ format: t = 'extended', precision: e = 'day' } = {}) {
            return this.isValid ? cr(this, t === 'extended', Li(e)) : null;
        }
        toISOWeekDate() {
        ...
        toISOTime({
            ...
            return this.isValid
                ? ((a = Li(a)),
                  (n && Ei.indexOf(a) >= 3 ? 'T' : '') + _l(this, o === 'extended', e, t, i, r, a))
                : null;
        }
        toRFC2822() {
        ...
        toRelative(t = {}) {
            ...
            return (
                ...
                vl(e, this.plus(i), { ...t, numeric: 'always', units: n, unit: r })
            );
        }
        ...
        static buildFormatParser(t, e = {}) {
            let { locale: i = null, numberingSystem: n = null } = e,
                r = B.fromOpts({ locale: i, numberingSystem: n, defaultToEN: !0 });
            return new Bi(r, t);
        }
...
qe.defaults.plugins.legend.labels.boxWidth = 12;
qe.defaults.plugins.legend.position = 'bottom';
function Xm({ cachedData: s, options: t, type: e }) {
    return {
        ...
        initChart() {
            var r, o, a, l, c, h, u, d, f, g, m, p, b, y, _, w, x;
            if (
                !this.$refs.canvas ||
            ...
            (t ?? (t = {}),
                ...
                e === 'polarArea' &&
                    ...
                    (x = t.scales.r.ticks).backdropColor ?? (x.backdropColor = 'transparent')),
        ...
        applyChartColors(i) {
            ...
            ((i.backgroundColor = this.userBackgroundColor ?? n),
                (i.borderColor = this.userBorderColor ?? r),
                (i.color = this.userTextColor ?? o),
                (i.pointBackgroundColor = this.userPointBackgroundColor ?? r),
