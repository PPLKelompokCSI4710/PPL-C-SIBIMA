...
class RescheduleBimbinganPbi9Test extends DuskTestCase
{
     ...
     */
    public function test_view_reschedule_history_success(): void
    {
        ...
        $reschedule = RescheduleRequest::create([
            ...
            'status' => 'pending',
            'alasan' => 'Topik: Topik Histori Baru',
        ]);
